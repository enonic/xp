...
@Command(name = "systemDump", description = "Export data from every repository.")
public final class SystemDumpCommand
    extends RepoCommand
{
    public static final String SYSTEM_DUMP_REST_PATH = "/api/system/systemDump";
