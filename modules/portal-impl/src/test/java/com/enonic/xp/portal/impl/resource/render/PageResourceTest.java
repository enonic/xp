    ...
    extends RenderBaseResourceTest
{
        ...
        throws Exception
    {
        ...
        MockHttpServletRequest request = newGetRequest( "/prod/site/somepath/content" );
        ...
        throws Exception
    {
        ...
        final MockHttpServletRequest request = newGetRequest( "/prod/site/somepath/content" );
        ...
        throws Exception
    {
        ...
        final MockHttpServletRequest request = newGetRequest( "/prod/id" );
