    ...
    extends RenderBaseResourceTest
{
        ...
        throws Exception
    {
        ...
        final MockHttpServletRequest request = newGetRequest( "/live/prod/site/somepath/content/_/component/main-region/0" );
        ...
        throws Exception
    {
        ...
        final MockHttpServletRequest request = newGetRequest( "/live/prod/site/somepath/content/_/component/main-region/666" );
        final MockHttpServletResponse response = executeRequest( request );
