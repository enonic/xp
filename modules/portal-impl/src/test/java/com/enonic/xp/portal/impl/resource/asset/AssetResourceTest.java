    ...
    extends ModuleBaseResourceTest
{
        ...
        throws Exception
    {
        ...
        final MockHttpServletRequest request = newGetRequest( "/live/prod/path/to/content/_/asset/demo/css/main.css" );
    ...
    public void methodNotAllowed()
        throws Exception
    {
        final MockHttpServletRequest request = newPostRequest( "/live/prod/path/to/content/_/asset/demo/css/main.css" );
        final MockHttpServletResponse response = executeRequest( request );
