...
public class ContentEventProducer
{
    ...
    @Activate
    public ContentEventProducer( @Reference final EventPublisher eventPublisher, @Reference final NodeService nodeService )
    {
    ...
    {
        jobScheduler.scheduleWithFixedDelay( this::run, Duration.ofMinutes( 0 ), Duration.ofSeconds( 30 ),
