    ...
    implements CmsService
{
    ...
    private static final CmsDescriptor PORTAL_CMS_DESCRIPTOR = CmsDescriptor.create()
        ...
        .mixinMappings( MixinMappings.create()
                            .add( MixinMapping.create()
                                      .mixinName( IMAGE_INFO_METADATA_NAME )
                                      .allowContentTypes( "media:image" )
                                      .optional( true )
                                      .build() )
                            .add( MixinMapping.create()
                                      .mixinName( CAMERA_INFO_METADATA_NAME )
                                      .allowContentTypes( "media:image" )
                                      .optional( true )
                                      .build() )
                            .add( MixinMapping.create()
                                      .mixinName( GPS_INFO_METADATA_NAME )
                                      .allowContentTypes( "media:image" )
                                      .optional( true )
                                      .build() )
                            .build() )
    ...
    @Activate
    public CmsServiceImpl( @Reference final ResourceService resourceService, @Reference final CmsFormFragmentService formFragmentService )
    {
    ...
    public CmsDescriptor getDescriptor( ApplicationKey applicationKey )
    {
        ...
        return CmsDescriptor.copyOf( descriptor )
            ...
            .form( formFragmentService.inlineFormItems( descriptor.getForm() ) )
            .build();
    }
