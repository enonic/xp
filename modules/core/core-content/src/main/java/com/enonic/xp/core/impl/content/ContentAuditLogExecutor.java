...
@Component(service = ContentAuditLogExecutor.class)
public class ContentAuditLogExecutor
    implements Executor
{
    private static final Logger LOG = LoggerFactory.getLogger( ContentAuditLogExecutor.class );

    private final SimpleExecutor simpleExecutor;

    @Activate
    public ContentAuditLogExecutor()
    {
