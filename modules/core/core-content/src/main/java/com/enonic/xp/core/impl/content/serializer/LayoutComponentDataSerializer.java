    ...
    extends DescriptorBasedComponentDataSerializer<LayoutComponent>
{
    ...
    public LayoutComponent fromData( final PropertySet layoutData, final List<PropertySet> componentsAsData )
    {
        ...
        if ( specialBlockSet != null && specialBlockSet.isNotNull( DESCRIPTOR ) )
        {
            ...
            final RegionDescriptors regionDescriptors = this.getRegionDescriptors( descriptorKey, layoutPath, componentsAsData );
    ...
    private RegionDescriptors getRegionDescriptors( final DescriptorKey descriptorKey, final String layoutPath,
                                                    final List<PropertySet> componentsAsData )
    {
        ...
        final boolean isAutoGeneratedDescriptor = layoutDescriptor.getModifiedTime() == null;
        ...
        return layoutDescriptor.getRegions();
    }
}
