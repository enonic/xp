    ...
    implements ExportWriter
{
    private void doCreateDirectories( final Path path )
    {
        ...
        {
            throw new ExportNodeException( "failed to create directory with path " + path + ": " + e, e );
        }
    }
    ...
    public void writeElement( final Path itemPath, final String export )
    {
        ...
        {
            throw new ExportNodeException( "failed to create file with path " + itemPath + ": " + e, e );
        }
    }
    ...
    public void close()
    {
        // FileExportWriter holds no resources; nothing to close.
    }
}
