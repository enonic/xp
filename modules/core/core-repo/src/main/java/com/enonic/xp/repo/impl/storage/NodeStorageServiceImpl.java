    ...
    implements NodeStorageService
{
    ...
    public NodeVersionData store( final StoreNodeParams params, final InternalContext context )
    {
        ...
        this.branchService.store( NodeBranchEntry.fromNodeVersionMetadata( nodeVersionMetadata ), context );
                      ...
                      final InternalContext context )
    {
        ...
        final Collection<NodeId> nodeIds = entries.stream().map( NodeBranchEntry::getNodeId ).collect( Collectors.toList() );
