...
public abstract class DslSimpleStringQueryBuilder
    extends DslBuilder
{
    ...
    public DslSimpleStringQueryBuilder( final PropertySet expression )
    {
        super( expression );
    ...
    {
        final SimpleQueryStringBuilder builder = new SimpleQueryStringBuilder( query )
