...
public class DumpMetaJsonSerializer
{
    ...
    public DumpMeta deSerialize( final String value )
    {
        try
        {
            final DumpMetaJson dumpEntryJson = MAPPER.readValue( value, DumpMetaJson.class );
            return DumpMetaJson.fromJson( dumpEntryJson );
        }
        catch ( IOException e )
        {
