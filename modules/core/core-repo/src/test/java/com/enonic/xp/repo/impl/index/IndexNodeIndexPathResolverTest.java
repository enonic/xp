...
class IndexNodeIndexPathResolverTest
{
    ...
    {
        return Stream.of( Arguments.of( "A", ValueExpr.string( "test" ), "a" ), Arguments.of( "A.b", ValueExpr.string( "test" ), "a.b" ),
    ...
    {
        final String result = SearchQueryFieldNameResolver.INSTANCE.resolve( FieldExpr.from( field ).getIndexPath(), valueExpr.getValue() );
