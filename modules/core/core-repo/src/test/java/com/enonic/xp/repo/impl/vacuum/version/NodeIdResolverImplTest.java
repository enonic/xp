...
public class NodeIdResolverImplTest
{
        ...
        throws Exception
    {
        ...
        final MemoryBlobRecord record = new MemoryBlobRecord( BlobKey.from( "a" ), ByteSource.wrap( createNodeEntry().getBytes() ) );
        ...
        throws Exception
    {
        ...
        final MemoryBlobRecord record = new MemoryBlobRecord( BlobKey.from( "a" ), ByteSource.wrap( "some text".getBytes() ) );
        ...
        throws Exception
    {
        ...
        final MemoryBlobRecord record = new MemoryBlobRecord( BlobKey.from( "a" ), ByteSource.wrap(
            "{\"attachedBinaries\":[],\"childOrder\":\"modifiedtime DESC\"}".getBytes() ) );
