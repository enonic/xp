 ...
 * runs. An execution still running when the next one falls due delays it - executions never
 * overlap - and the one that was held then starts as soon as its predecessor finishes.
 * <p>
