...
@PublicApi
public class ArchivedContainerLayer
{
    ...
    private ArchivedContainerLayer( Builder builder )
    {
        this.id = builder.id;
    ...
    public static final class Builder
    {
        ...
        public ArchivedContainerLayer build()
        {
            return new ArchivedContainerLayer( this );
        }
    }
}
