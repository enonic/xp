    ...
    extends XmlModelParser<XmlStyleDescriptorParser>
{
        ...
        throws Exception
    {
        ...
        for ( ImageStyle styleElement : parseStyleElements( root ) )
        {
            this.styleDescriptorBuilder.addStyleElement( styleElement );
        }
    }

    private List<ImageStyle> parseStyleElements( final DomElement root )
    {
    ...
    private ImageStyle toStyleElement( final DomElement styleElement )
    {
    ...
    private ImageStyle toImageStyle( final DomElement styleElement )
    {
        ...
        builder.name( styleElement.getAttribute( ELEMENT_NAME_ATTRIBUTE_NAME ).trim() );
