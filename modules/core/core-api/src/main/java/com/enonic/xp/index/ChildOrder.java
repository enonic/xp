...
public final class ChildOrder
{
    ...
    {
        return ChildOrder.create().add( PATH_ASC ).build();
    }

    public static ChildOrder reversePath()
    {
        return ChildOrder.create().add( PATH_DESC ).build();
    }

    public static ChildOrder name()
    {
        return ChildOrder.create().add( NAME_ASC ).build();
    }

    public static ChildOrder publish()
    {
        return ChildOrder.create().add( PUBLISH_ASC ).build();
    }
