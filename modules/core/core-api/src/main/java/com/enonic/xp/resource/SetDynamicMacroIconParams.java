...
public final class SetDynamicMacroIconParams
{
    ...
    private SetDynamicMacroIconParams( final Builder builder )
    {
    ...
    public static final class Builder
    {
        ...
        public SetDynamicMacroIconParams build()
        {
            validate();
            return new SetDynamicMacroIconParams( this );
        }
    }
}
