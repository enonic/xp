...
@PublicApi
public final class UpdateMetadataResult
{
    private final ContentId contentId;

    private final List<BranchResult> results;

    private UpdateMetadataResult( Builder builder )
    {
    ...
    public static final class Builder
    {
        ...
        public UpdateMetadataResult build()
        {
            return new UpdateMetadataResult( this );
        }
    }
}
