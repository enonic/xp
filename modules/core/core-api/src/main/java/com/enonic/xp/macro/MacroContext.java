...
public class MacroContext
{
    ...
    {
        return o instanceof MacroContext && equals( (MacroContext) o );
    }

    private boolean equals( final MacroContext o )
    {
        return Objects.equals( this.name, o.name ) && Objects.equals( this.body, o.body ) && this.params.equals( o.params );
    }
