    ...
    extends BaseInputTypeTest
{
    ...
    {
        final Value value = this.type.createValue( ValueFactory.newString( "2015-01-02" ), GenericValue.newObject().build() );
    ...
    void testValidate()
    {
        this.type.validate( localDateProperty(), GenericValue.newObject().build() );
    }
