    ...
    extends BaseInputTypeTest
{
    ...
    {
        super( LocalDateTimeType.INSTANCE );
    }

    @Test
    public void testName()
    {
        assertEquals( "LocalDateTime", this.type.getName().toString() );
    }

    @Test
    public void testToString()
    {
        assertEquals( "LocalDateTime", this.type.toString() );
    }
    ...
    {
        final Input input = getDefaultInputBuilder( InputTypeName.LOCAL_DATE_TIME, "2014-08-16T05:03:45" ).build();
    ...
    {
        final Input input = getDefaultInputBuilder( InputTypeName.LOCAL_DATE_TIME, "+1year -5months -36d" ).build();
    ...
    {
        final Input input = getDefaultInputBuilder( InputTypeName.LOCAL_DATE_TIME, "+1hour -5minutes -36s" ).build();
    ...
    {
        final Input input = getDefaultInputBuilder( InputTypeName.LOCAL_DATE_TIME, "+1year -5months -36d +2minutes -1haaur" ).build();
