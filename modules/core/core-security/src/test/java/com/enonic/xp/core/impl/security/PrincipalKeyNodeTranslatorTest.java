...
public class PrincipalKeyNodeTranslatorTest
{
    ...
    public void toNodeName()
        throws Exception
    {
        PrincipalKey principalKey = PrincipalKey.ofUser( IdProviderKey.from( "myuserstore" ), "rmy" );
        ...
        throws Exception
    {
        ...
        rootDataSet.setString( PrincipalPropertyNames.USER_STORE_KEY, IdProviderKey.system().toString() );
