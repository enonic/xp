...
module api_remote {
    ...
    interface RemoteCallContentTypeCreateOrUpdateResult extends RemoteCallResultBase {
        created: bool;
        updated: bool;
        failure?: string;
    }
    ...
    interface RemoteServiceInterface {
        ...
        contentType_createOrUpdate(params: RemoteCallContentTypeCreateOrUpdateParams, callback: (result: RemoteCallContentTypeCreateOrUpdateResult) => void): void;
...
module api_ui_dialog {
    ...
    class ModalDialog extends api_dom.DivEl {
        ...
        public setCancelAction(action: api_ui.Action): void;
