...
(function (API) {
    (function (notify) {
        ...
        notify.addListener = addListener;
    ...
    (function (notify) {
        var NotificationManager = (function () {
            function NotificationManager() {
                ...
                this.render();
                notify.addListener('showNotification', this.showNotification, this);
                notify.addListener('removeNotification', this.removeNotification, this);
            }
