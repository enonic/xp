module app_model {
    ...
    var applications:Application[] = [
        new Application('Content Manager', '/admin2/apps/content-manager/index.html', iconsPath + 'database.png', descr1),
        new Application('Relationships', '', iconsPath + 'share.png', descr2),
        new Application('Space Admin', '/admin2/apps/space-manager/index.html', iconsPath + 'earth.png', descr3),
        new Application('Schema Manager', '/admin2/apps/schema-manager/index.html', iconsPath + 'signup.png', descr4),

        new Application('Store Manager', '', iconsPath + 'cart.png', descr4),
        new Application('Segment Builder', '', iconsPath + 'pie.png', descr3),
        new Application('Optimizer', '', iconsPath + 'target.png', descr2),
        new Application('Analytics', '', iconsPath + 'stats.png', descr1),

        new Application('Accounts', '', iconsPath + 'users.png', descr2),
        new Application('Modules', '', iconsPath + 'puzzle.png', descr1),
        new Application('Templates', '', iconsPath + 'insert-template.png', descr4),
        new Application('Diagnostics', '', iconsPath + 'aid.png', descr3)
    ];
