module admin.ui {
    export class DetailPanel {
        ...
        constructor () {
            var panel = this.panel = new Ext.panel.Panel();
            panel.layout = 'card';
            panel.cls = 'admin-preview-panel admin-detail';
            panel.border = false;
            panel.showToolbar = true;
            panel.isVertical = false;
            panel.isFullPage = false;
            panel.keyField = this.keyField;

            if (this.panel.showToolbar) {
                this.panel.tbar = this.createToolBar();
            }

            if (this.panel.isVertical) {
                this.panel.cls = this.panel.cls + 'admin-detail-vertical';
            }
        ...
        hideActionButton() {
            var actionsButton = this.actionButton;
            if (actionsButton) {
        ...
        createSingleSelection (data) {
            var me = this;
            this.actionButton = me.createActionButton();
