...
Ext.define('Admin.NotificationManager', {
    ...
    tpl: {
        ...
        publish: new Ext.XTemplate('<span style="float: right; margin-left: 30px;"><a href="#" class="admin-notification-result">See result</a> or <a href="#" class="admin-notification-publish">Publish to other locations</a></span>',
            '<span style="line-height: 1.5em;">', '<tpl if="contentName"> "{contentName}"</tpl> published successfully!', '</span> '),
        general: new Ext.XTemplate('<span style="float: right; margin-left: 30px;"><a href="#" class="admin-notification-publish">Publish</a> or <a href="#" class="admin-notification-close">Close</a></span>',
            '<span style="line-height: 1.5em;">', '<tpl if="contentName"> "{contentName}"</tpl> saved successfully!', '</span> ')
    },
    ...
    renderNotification: function (nOpts) {
        ...
        notificationEl =
        (me.position[0] == 't') ? tpl.insertFirst(me.getWrapperEl(), nOpts, true) : tpl.append(me.getWrapperEl(), nOpts, true);
...
Ext.define('Admin.view.DeleteSpaceWindow', {
    ...
    multipleTemplate: '<div class="admin-delete-user-confirmation-message">' +
                      ...
                      '</div>',
    singleTemplate: '<div>' + '<div class="admin-content-info clearfix">' + '<div class="admin-content-photo west admin-left">' +
                    '<div class="photo-placeholder"><img src="{iconUrl}" alt="{name}"/></div>' + '</div>' + '<div class="admin-left">' +
                    '<h2>{displayName}</h2>' + '<p>{description}</p>' + '</div>' + '</div>' + '</div>',
    ...
    deleteTemplate: '<div class="delete-container">' + '<tpl for=".">' + '<div class="delete-item">' +
                    '<img class="icon" src="{data.iconUrl}"/>' + '<h4>{data.displayName}</h4>' + '<p>{data.type}</p>' + '</div>' +
                    '</tpl>' + '</div>',
