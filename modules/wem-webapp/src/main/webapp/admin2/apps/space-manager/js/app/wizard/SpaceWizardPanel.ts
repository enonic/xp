module app_wizard {
    ...
    export class SpaceWizardPanel extends api_app_wizard.WizardPanel {
        ...
        private header:api_app_wizard.WizardHeaderWithDisplayNameAndName;
        ...
        constructor(id:string) {
            ...
            this.header = new api_app_wizard.WizardHeaderWithDisplayNameAndName();
            ...
            this.header.setDisplayName("New Space");
            this.header.setName(id);
            this.header.setAutogenerateDisplayName(true);
            this.header.setAutogenerateName(true);
        ...
        setPersistedItem(space:api_remote_space.Space) {
            ...
            this.header.setDisplayName(space.displayName);
            this.header.setName(space.name);
            ...
            this.header.setAutogenerateDisplayName(!space.displayName);
            this.header.setAutogenerateName(!space.name || space.name == this.header.generateName(space.displayName));
        ...
        persistNewItem(successCallback?:() => void) {
            ...
            var createParams:api_remote_space.CreateParams = {
                spaceName: this.header.getName(),
                displayName: this.header.getDisplayName(),
        ...
        updatePersistedItem(successCallback?:() => void) {
            ...
            var updateParams:api_remote_space.UpdateParams = {
                ...
                newSpaceName: this.header.getName(),
                displayName: this.header.getDisplayName(),
                iconReference: this.getIconUrl()
            };
