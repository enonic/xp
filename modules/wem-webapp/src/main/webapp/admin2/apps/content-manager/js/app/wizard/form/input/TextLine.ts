module app_wizard_form_input {
    ...
    export class TextLine extends api_dom.DivEl implements Input {
        ...
        layout(input:api_schema_content_form.Input, properties?:api_content_data.Property[]) {
            ...
            console.log("TextLine.layout properties: ", properties);
        ...
        getValues():string[] {
            ...
            var values:string[] = [];
            this.inputs.forEach((input:api_ui.TextInput) => {
