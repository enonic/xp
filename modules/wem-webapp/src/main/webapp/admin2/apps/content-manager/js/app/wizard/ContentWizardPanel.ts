module app_wizard {
    ...
    export class ContentWizardPanel extends api_app_wizard.WizardPanel {
        ...
        constructor(id:string, contentType:api_remote_contenttype.ContentType, parentContent:api_remote_content.Content) {
            ...
            this.header.setDisplayName(ContentWizardPanel.NEW_WIZARD_HEADER);
        ...
        renderExisting(result:api_remote_content.GetResult) {
            ...
            this.header.setDisplayName(content.displayName);
            this.header.setName(content.name);
            ...
            this.header.setAutogenerateDisplayName(!content.displayName);
            this.header.setAutogenerateName(!content.name);
        ...
        persistNewItem(successCallback?:() => void) {
            ...
            var createParams:api_remote_content.CreateOrUpdateParams = {
                contentName: this.header.getName(),
