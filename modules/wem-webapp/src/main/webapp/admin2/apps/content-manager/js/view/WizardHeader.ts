Ext.define('Admin.view.WizardHeader', {
    ...
    initComponent: function () {
        ...
        this.displayNameField = <any> Ext.create('Admin.view.AutosizeTextField', Ext.apply({
            xtype: 'textfield',
            fieldHeight: 40,
        ...
        this.pathField = <any> Ext.create('Ext.form.field.Display', Ext.apply({
            xtype: 'displayfield',
            cls: 'admin-path',
        ...
        this.nameField = <any> Ext.create('Admin.view.AutosizeTextField', Ext.apply({
            xtype: 'textfield',
            fieldHeight: 30,
            cls: 'admin-name',
    ...
    preProcessName: function (displayName) {
        return !Ext.isEmpty(displayName) ?
            displayName.replace('/[\s+\./]/ig', '-').replace(/-{2,}/g, '-').replace(/^-|-$/g, '').toLowerCase() : '';
    },
