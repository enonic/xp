...
(function (app) {
    ...
    var ToggleDisplayModeAction = (function (_super) {
        __extends(ToggleDisplayModeAction, _super);
        function ToggleDisplayModeAction() {
            _super.call(this, "ToggleDisplayMode");
            this.setEnabled(true);
            this.addExecutionListener(function () {
                console.log('TODO: ToggleDisplayModeAction');
            });
        }

        return ToggleDisplayModeAction;
    })(api_ui.Action);
    app.ToggleDisplayModeAction = ToggleDisplayModeAction;
