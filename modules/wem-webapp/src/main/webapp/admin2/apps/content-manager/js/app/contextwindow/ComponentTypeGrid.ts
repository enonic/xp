module app_contextwindow {
    export class ComponentTypeGrid extends api_grid.Grid {
            ...
            return [
                {
                    ...
                    formatter: (row, cell, value, columnDef, dataContext) => {
                        return '<div class="comp" data-context-window-draggable="true" data-live-edit-key="' + value.key + '" data-live-edit-name="' + value.name +'" data-live-edit-type="' + value.type +'">' +
                               '<h5>' + value.name + '</h5>' +
