...
(function (global) {
    ...
    global.LiveEditMutationSummary = MutationSummary;
    global.LiveEditMutationSummary.NodeMap = NodeMap; // exposed for use in TreeMirror.
    global.LiveEditMutationSummary.parseElementFilter = parseElementFilter; // exposed for testing.
})(window);
