...
<!-- Libs -->
<script type="text/javascript" charset="UTF-8" src="../../admin2/live-edit/lib/mutation_summary.js"></script>
...
<script type="text/javascript" charset="UTF-8" src="../../admin2/live-edit/js/jquery.noconflict.js"></script>
