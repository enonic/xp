...
<div class="container">
  ...
  <div id="main" data-live-edit-type="region" data-live-edit-key="80" data-live-edit-name="Main">
    <!-- Product show -->
    <%@ include file="../../admin/live-edit/data/mock-component-10022.html" %>
    ...
    <div class="row-fluid" data-live-edit-type="layout" data-live-edit-key="010101" data-live-edit-name="Layout 70-30">
      ...
      <div class="span8" data-live-edit-type="region">
        <!-- Description -->
        <%@ include file="../../admin/live-edit/data/mock-component-10024.html" %>

        <!-- Gallery -->
        <%@ include file="../../admin/live-edit/data/mock-component-10023.html" %>
      ...
      <div class="span4" data-live-edit-type="region">
        ...
        <!-- Banner -->
        <%@ include file="../../admin/live-edit/data/mock-component-10027.html" %>
      </div>
    </div>
