...
(function (global) {
    ...
    MutationProjection.prototype = {
        ...
        processMutations: function (mutations) {
            ...
            if (!this.childListChanges && !this.attributesChanges) {
                return;
            } // No childList or attributes mutations occurred.
    ...
    // tan@enonic.com: Add the object to the AdminLiveEdit NS in order to avoid potential JS NS collision
    var liveEditNS = global.AdminLiveEdit;
    liveEditNS.MutationSummary = MutationSummary;
    liveEditNS.MutationSummary.NodeMap = NodeMap; // exposed for use in TreeMirror.
    liveEditNS.MutationSummary.parseElementFilter = parseElementFilter; // exposed for testing.
})(this);
