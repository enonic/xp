...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../admin/_app/main/css/main.css">

  <style type="text/css">
    #admin-home-main-container a {
      color: #fff;
    }

    #admin-home-main-container h3,
    ...
    #admin-home-branding {
      ...
      top: 15px;
      left: 20px;
      background: transparent url(../admin/resources/images/wem-enonic-logo.png) 0 0 no-repeat;
      height: 24px;
    }
    ...
    #admin-home-app-selector-search-input-container {
      margin-bottom: 10px;
    }
...
<div id="admin-home-main-container" style="background-image: url(../admin/resources/images/710948main_typhoon_bopha_1600_1600-1200.jpg)">
