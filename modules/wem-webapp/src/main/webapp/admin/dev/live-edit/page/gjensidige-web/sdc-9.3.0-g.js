...
// Version: 9.3.0
// Created: 110415 - support at arena dot no
function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.fpcdom = document.domain.substring(document.domain.indexOf("."));
	
	// this.dcsid
	if ((document.domain.indexOf("qa") != -1) || (document.domain.indexOf("qawww") != -1) || (document.domain.indexOf("pilot") != -1) ) {
		this.dcsid="dcslvhpep10000shg20wox22l_1f8m"; // qa
	} else if (document.domain.indexOf("gjensidige.no") != -1) {
		this.dcsid="dcsz0ijjb00000woga9xo132l_9y9k"; // internett
		this.fpcdom=".gjensidige.no";
	} else if (document.domain.indexOf("gjensidige.com") != -1 ) {
		this.dcsid="dcs34bqq5kiqu025kiuuqz943_7s4w"; // gjensidige.com
		this.fpcdom=".gjensidige.com";
	} else if ((document.domain.indexOf("intra") != -1 || document.domain.indexOf("konsern") != -1) && document.location.pathname.indexOf('/vis') == 0 ) {	
		this.dcsid="dcsz0ijjb00000woga9xo132l_9y9k"; // vis 
	} else if ((document.domain.indexOf("intra") != -1 || document.domain.indexOf("konsern") != -1) && document.location.pathname.indexOf('/konsern') == 0 ) {	
		this.dcsid="dcsdp7voekiqu0i1g1dadlhuj_9u9l"; // intranet
	} else {
		this.dcsid="dcsiscvpx00000spyll65wnzf_1f2d"; // test
	}
	this.domain="sdc.arena.no";
	this.timezone=1;
	this.onsitedoms="";
	this.downloadtypes="xls,doc,pdf,txt,csv,zip,ini,exe,pps,ppt,bat,mov,avi,wma,wmv,mp3,dot,docx,xlsx,ppsx,pptx,sdv";
...
WebTrends.prototype.dcsTag=function(){
	...
	if ( window.tracethis != undefined ) {
		tracethis(DCS,DCSext,WT);	
	} 
}
