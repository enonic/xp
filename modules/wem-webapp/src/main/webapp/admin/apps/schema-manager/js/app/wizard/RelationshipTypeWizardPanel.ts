module app_wizard {
    ...
    <api_schema_relationshiptype.RelationshipType> {

        public static NEW_WIZARD_HEADER = "New Relationship Type";

private static
    DEFAULT_CHEMA_ICON_URL
:
    string = api_util.getRestUri('schema/image/RelationshipType:_');

private
    formIcon
:
    api_app_wizard.FormIcon;

private
    relationShipTypeWizardHeader
:
    api_app_wizard.WizardHeaderWithName;
    ...
    constructor()
{
    ...
    setPersistedItem(relationshipType
:
    api_schema_relationshiptype.RelationshipType
)
{
...
:
    api_rest.JsonResponse < api_schema_relationshiptype.GetRelationshipTypeConfigResult >
) =>
    {
