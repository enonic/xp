module app_wizard {
    ...
    <api_schema_content.ContentType> {
...
:
    string = api_util.getRestUri('schema/image/ContentType:structured');
...
:
    api_rest.JsonResponse < api_schema_content.GetContentTypeConfigResult >
) =>
    {
