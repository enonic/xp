module app_new {
    ...
    export class ContentTypes {
        ...
        getByName(contentTypeName: api_schema_content.ContentTypeName): api_schema_content.ContentTypeSummary {
            var contentType: api_schema_content.ContentTypeSummary;
