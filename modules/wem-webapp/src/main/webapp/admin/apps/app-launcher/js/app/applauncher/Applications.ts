module app_launcher {
    ...
    export class Applications {
        ...
        private static applications:Application[] = [
            new Application('Content Manager', api_util.getAbsoluteUri('admin/apps/content-manager/index.html'),
                Applications.ICONS_PATH + 'database.png',
                Applications.DESCR1),
            new Application('Relationships', '', Applications.ICONS_PATH + 'share.png', Applications.DESCR2),
            new Application('Space Admin', api_util.getAbsoluteUri('admin/apps/space-manager/index.html'),
                Applications.ICONS_PATH + 'earth.png',
                Applications.DESCR3),
            new Application('Schema Manager', api_util.getAbsoluteUri('admin/apps/schema-manager/index.html'),
