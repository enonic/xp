// This file was auto-generated on 2013-01-16 13:08:00 CET
...
Templates.contentStudio = {
    ...
    previewIcon:
		'<img src="data:image/gif;base64,R0lGODlhAQABAID/AMDAwAAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" class="{iconCls}" alt="{name}"' + 
		     'title="{name}"/>',
