// This file was auto-generated on 2012-11-02 06:42:17 VET
...
Templates.contentManager = {
    ...
    previewSelectionLarge: '<tpl for=".">' +
                           ...
                           '<div class="left">' +
                           '<img src="data:image/gif;base64,R0lGODlhAQABAID/AMDAwAAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" class="{data.iconCls}" alt="{data.name}"/>' +
                           '</div>' +
                           '<div class="center">' +
                           '<h2>{data.name}</h2>' +
                           '<p>{data.type}</p>' +
    ...
    previewSelectionSmall: '<tpl for=".">' +
                           ...
                           '<div class="admin-selected-item-box left">' +
                           '<img src="data:image/gif;base64,R0lGODlhAQABAID/AMDAwAAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" alt="{data.name}" class="{data.iconCls}"/>' +
                           '</div>' +
