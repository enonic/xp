// This file was auto-generated on 2012-05-31 11:51:05 CEST
...
Templates.account = {
    ...
    deleteManyUsers:
		'<div class="cms-delete-user-confirmation-message">' + 
		    ...
		    '<div class="cms-left" style="margin-top:5px">Are you sure you want to delete the selected {selectionLength} items?</div>' + 
		'</div>',

    gridPanelNameRenderer:
		'<div style="float:left;padding-top: 3px"><img src="{0}" alt="" class="cms-grid-thumbnail"></div>' + 
		'<div style="float:left; padding: 3px 0 0 5px">' + 
		    '<div class="cms-grid-title">{1}</div>' + 
    ...
    groupPreviewMemberships:
		'<tpl for="members">' + 
		    '<div class="clearfix cms-member-preview-el x-boxselect-item">' + 
		        '<div class="cms-left">' + 
		            '<span class="{[values.type==="user" && !values.builtIn ? "icon-user" : values.type==="role" || values.builtIn ? "icon-role" : "icon-group"]} cms-list-item"></span>' + 
		        '</div>' + 
		        '<div class="cms-left">' + 
		            '<span>' + 
    ...
    userPreviewMemberships:
		'<fieldset class="x-fieldset x-fieldset-default cms-memberships-container">' + 
    ...
    userPreviewPhoto:
		'<div class="cms-user-photo west cms-left">' + 
		...
		'<tpl for=".">' + 
		    '<div class="cms-userstore clearfix">' + 
		        ...
		        '<div class="cms-userstore-block cms-left">' + 
		            '<div class="cms-left" style="padding-right: 15px;">' + 
...
Templates.common = {
    ...
    wizardPanelSteps:
		'<div class="cms-wizard-navigation-container">' + 
...
Templates.contentManager = {
    ...
    deleteMultiple:
		'<div class="cms-delete-user-confirmation-message">' + 
		    '<div class="icon-question-mark-32 cms-left" style="width:32px; height:32px; margin-right: 10px"><!-- --></div>' + 
		    '<div class="cms-left" style="margin-top:5px">Are you sure you want to delete {selectionLength} item(s)?</div>' + 
		'</div>',

    deleteSingle:
		'<div>' + 
		    '<div class="cms-content-info clearfix">' + 
		        '<div class="cms-content-photo west cms-left">' + 
		            '<div class="photo-placeholder">' + 
		                '<tpl if="type == \'site\'">' + 
    ...
    gridPanelNameRenderer:
		...
		'<div style="float:left; padding: 0 0 0 5px">' + 
		    '<div class="cms-grid-title" style="line-height: 32px">{1}</div>' + 
		'</div>',
    ...
    previewSelectionLarge:
		'<tpl for=".">' + 
		    '<div id="selected-item-box-{data.key}" class="cms-selected-item-box large x-btn-default-large clearfix">' + 
		        '<div class="left">' + 
    ...
    previewSelectionSmall:
		'<tpl for=".">' + 
		    '<div id="selected-item-box-{data.key}" class="cms-selected-item-box small x-btn-default-small clearfix">' + 
		        '<div class="cms-selected-item-box left">' + 
		            '<tpl if="data.type===\'contentType\'"><img src="resources/images/icons/24x24/cubes_blue.png"' + 
		                                                     'alt="{data.name}"/></tpl>' + 
		            '<tpl if="data.type===\'site\'"><img src="resources/images/icons/24x24/earth2.png" alt="{data.name}"/></tpl>' + 
...
Templates.datadesigner = {
    ...
    gridPanelRenderer:
		...
		'<div style="float:left; padding: 5px 0 0 5px">' + 
		    '<div class="cms-grid-title">{1}</div>' + 
		    '<div class="cms-grid-description">Extends {2}</div>' + 
		'</div>',
...
Templates.userstore = {
    ...
    gridPanelNameRenderer:
		...
		'<div style="float:left; padding: 0 0 0 5px">' + 
		    '<div class="cms-grid-title">{1}</div>' + 
		    '<div class="cms-grid-description">{2}</div>' + 
		'</div>',
		...
		'<div>' + 
		    '<div class="cms-user-info clearfix">' + 
		        '<div class="cms-user-photo west cms-left">' + 
		            ...
		            '</div>' + 
		        '</div>' + 
		        '<div class="cms-left" style="line-height: 32px">' + 
		            '<h2>{name}</h2>' + 
		        '</div>' + 
		    '</div>' + 
		'</div>'
