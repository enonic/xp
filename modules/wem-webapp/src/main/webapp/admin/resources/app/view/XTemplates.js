// This file was auto-generated on 2012-08-13 10:45:29 CEST
    ...
    selectedUserLarge:
		'<tpl for="users">' + 
		    '<div id="selected-item-box-{key}" class="admin-selected-item-box large x-btn-default-large clearfix">' + 
		        '<div class="left">' + 
		            '<tpl if="type===\'user\'"><img alt="User" src="rest/account/user/{key}/photo?size=32" alt="{displayName}"/></tpl>' + 
		...
		'<tpl for="users">' + 
		    '<div id="selected-item-box-{key}" class="admin-selected-item-box small x-btn-default-small clearfix">' + 
		        '<div class="admin-selected-item-box left">' + 
		            '<tpl if="type===\'user\'"><img alt="User" src="rest/account/user/{key}/photo?size=20" alt="{displayName}"/></tpl>' + 
    ...
    userPreviewPhoto:
		'<div class="admin-user-photo west admin-left">' + 
		    '<div class="photo-placeholder">' + 
		        ...
		        '<tpl if="type===\'role\' && builtIn===true && name!==\'anonymous\'"><img src="resources/images/icons/128x128/masks.png"' + 
		                                                                             'alt="{displayName}"/></tpl>' + 
		        '<tpl if="type===\'user\' && (!builtIn)"><img src="rest/account/user/{key}/photo" alt="{displayName}"/></tpl>' + 
		...
		'<div>' + 
		    '<div class="admin-user-info clearfix">' + 
		        '<div class="admin-user-photo west admin-left">' + 
		            '<div class="photo-placeholder">' + 
		                '<tpl if="name===\'admin\' && builtIn===true"><img src="resources/images/icons/128x128/superhero.png" alt="{name}"/></tpl>' + 
		                '<tpl if="name===\'anonymous\' && builtIn===true"><img src="resources/images/icons/128x128/ghost.png" alt="{displayName}"/>' + 
		                '</tpl>' + 
		                '<tpl if="type===\'role\' && builtIn===true && name!==\'anonymous\'"><img src="resources/images/icons/128x128/masks.png"' + 
		                                                                                     'alt="{displayName}"/></tpl>' + 
		                '<tpl if="type===\'user\' && (!builtIn)"><img src="/admin/rest/account/user/{key}/photo" alt="{displayName}"/></tpl>' + 
		                '<tpl if="type===\'group\'"><img src="resources/images/icons/128x128/group.png" alt="{displayName}"/></tpl>' + 
		            '</div>' + 
		        '</div>' + 
		        '<div class="admin-left">' + 
