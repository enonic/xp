// This file was auto-generated on 2012-12-17 16:48:02 CET
...
Templates.account = {
    ...
    gridPanelNameRenderer:
		'<img src="{0}" alt="{1}" class="admin-grid-thumbnail"/>' + 
		'<div class="admin-grid-name-renderer">' + 
		    '<h6>{1}</h6>' + 
		    '<div class="admin-grid-name-renderer-path">{3}\\{2}</div>' + 
		'</div>',
...
Templates.contentManager = {
    ...
    previewPhoto:
		'<img src="data:image/gif;base64,R0lGODlhAQABAID/AMDAwAAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" alt="{name}" class="{iconCls}"/>',
...
Templates.contentStudio = {
    ...
    gridPanelRenderer:
		'<div style="float:left;padding-top: 3px"><img src="{0}" alt="" class="admin-tree-thumbnail"/></div>' + 
