// This file was auto-generated on 2012-08-07 09:04:22 VET
...
Templates.account = {
    ...
    userWizardHeader: '<div class="admin-wizard-header">' +
...
Templates.datadesigner = {
    ...
    previewHeader: '<h1>{displayName}</h1><div>{name}</div>',
