    ...
    openPreviewAccountTabs: function( selection, callback )
    {
        ...
        for ( var i = 0; i < selection.length; i++ ) {
            ...
            if ( selected.type === 'user' ) {
                ...
                var index = tabPane.items.indexOfKey( 'tab-edit-user-' + selected.key );
                if ( index >= 0 ) {
                ...
                //check if preview tab is open and close it
                var index = tabPane.items.indexOfKey( 'tab-edit-group-' + selected.key );
                if ( index >= 0 ) {
                    tabPane.remove( index );
                }
                tabPane.addTab( tabItem, index >= 0 ? index : undefined, requestConfig );
    ...
    openEditAccountTabs: function( selection, callback )
    {
        ...
        for ( var i = 0; i < selection.length; i++ ) {
            ...
            if ( selected.type === 'user' ) {
                ...
                //check if preview tab is open and close it
                var index = tabPane.items.indexOfKey( 'tab-preview-user-' + selected.key );
                if ( index >= 0 ) {
                    tabPane.remove( index );
                }
                tabPane.addTab( tabItem, index >= 0 ? index : undefined, requestConfig );
                ...
                //check if preview tab is open and close it
                var index = tabPane.items.indexOfKey( 'tab-preview-group-' + selected.key );
                if ( index >= 0 ) {
                    tabPane.remove( index );
                }
                tabPane.addTab( tabItem, index >= 0 ? index : undefined, requestConfig );
