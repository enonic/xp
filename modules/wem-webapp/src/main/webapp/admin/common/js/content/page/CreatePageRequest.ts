module api_content_page {
    ...
    export class CreatePageRequest extends PageResourceRequest<api_content_json.ContentJson> {
        ...
        setPageTemplateKey(pageTemplateKey: api_content_page.PageTemplateKey): CreatePageRequest {
            this.pageTemplateKey = pageTemplateKey;
            return this;
        }

        setConfig(config: api_data.Data[]): CreatePageRequest {
            this.config = config;
            return this;
        }
