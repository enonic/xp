    ...
    extends RenderBaseHandlerTest
{
        ...
        throws Exception
    {
        ...
        requestBuilder.endpointPath( null );
    }
        ...
        throws Exception
    {
        ...
        setContentPath( ContentPath.from( "/site/somepath/content" ) );
        ...
        throws Exception
    {
        ...
        setContentPath( ContentPath.from( "/site/somepath/shortcut" ) );
        ...
        throws Exception
    {
        ...
        setContentPath( ContentPath.from( "/id" ) );
        setMode( RenderMode.EDIT );
