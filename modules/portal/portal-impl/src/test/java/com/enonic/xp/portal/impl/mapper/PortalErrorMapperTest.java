...
public class PortalErrorMapperTest
{
    ...
    public void setup()
    {
        ...
        this.error = new PortalError();
        this.error.setStatus( HttpStatus.NOT_FOUND );
        this.error.setMessage( "Message: Not found." );
        this.error.setException( new NotFoundException( "Not found." )
        {
        } );
        this.error.setRequest( portalRequest );
    }
