...
import com.enonic.xp.portal.impl.api.DynamicUniversalApiHandlerRegistryImpl;
...
public class SlashApiHandlerTest
{
    ...
    private DynamicUniversalApiHandlerRegistryImpl universalApiHandlerRegistry;
        ...
        throws IOException
    {
        ...
        universalApiHandlerRegistry = new DynamicUniversalApiHandlerRegistryImpl();
