...
public class SlashApiHandlerTest
{
    ...
    void testSiteMountApiDoesNotDefinedIdApis()
    {
        ...
        final SiteApiMountDescriptors siteApiMountDescriptors =
            SiteApiMountDescriptors.from( SiteApiMountDescriptor.create().apiKey( "api-key-1" ).build(),
                                          SiteApiMountDescriptor.create().apiKey( "api-key-2" ).build() );
    ...
    @Test
    void testSiteMountApiDefinedIdApisWithAnyContextPath()
        throws Exception
    {
        request.setContentPath( ContentPath.from( "/mysite" ) );
        request.setEndpointPath( "/_/com.enonic.app.myapp/api-key-1" );
        request.setRawPath( "/site/project/master/mysite/content/path/_/com.enonic.app.myapp/api-key-1" );
        request.setRepositoryId( RepositoryId.from( "com.enonic.cms.project" ) );
        request.setBranch( Branch.from( "master" ) );
        ...
        final SiteApiMountDescriptors siteApiMountDescriptors =
            SiteApiMountDescriptors.from( SiteApiMountDescriptor.create().apiKey( "api-key-1" ).contextPath( ApiContextPath.ANY ).build(),
                                          SiteApiMountDescriptor.create().apiKey( "api-key-2" ).build() );
