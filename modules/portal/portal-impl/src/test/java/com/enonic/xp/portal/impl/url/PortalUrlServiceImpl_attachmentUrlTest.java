    ...
    extends AbstractPortalUrlServiceImplTest
{
    ...
    public void createUrl_withoutNameAndLabel()
    {
        ...
        assertEquals( "/site/draft/a/b/mycontent/_/attachment/inline/123456:binaryHash2/a2.jpg?a=3", url );
    }
    ...
    public void createUrl_withDownload()
    {
        ...
        final String url = this.service.attachmentUrl( params );
        assertEquals( "/site/draft/a/b/mycontent/_/attachment/download/123456:binaryHash2/a2.jpg", url );
    }
    ...
    public void createUrl_withName()
    {
        ...
        final String url = this.service.attachmentUrl( params );
        assertEquals( "/site/draft/a/b/mycontent/_/attachment/inline/123456:binaryHash1/a1.jpg", url );
    }
    ...
    public void createUrl_withId()
    {
        ...
        final String url = this.service.attachmentUrl( params );
        assertEquals( "/site/draft/context/path/_/attachment/inline/123456:binaryHash1/a1.jpg", url );
    }
    ...
    public void createUrl_absolute()
    {
        ...
        final String url = this.service.attachmentUrl( params );
        assertEquals( "http://localhost/site/draft/a/b/mycontent/_/attachment/inline/123456:binaryHash2/a2.jpg?a=3", url );
    }
