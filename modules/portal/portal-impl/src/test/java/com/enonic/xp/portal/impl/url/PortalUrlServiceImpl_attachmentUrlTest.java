...
class PortalUrlServiceImpl_attachmentUrlTest
{
    ...
    void setUp()
    {
        ...
        this.portalUrlGeneratorService = new PortalUrlGeneratorServiceImpl( webappService, mock( SiteService.class ), mock( StyleDescriptorService.class ), HmacTestHelper.createHmacService() );
