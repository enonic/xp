...
public class MediaServiceMappingHandler
    extends EndpointHandler
{
    private final MappingHandlerHelper mappingHandlerHelper;

    @Activate
    public MediaServiceMappingHandler( @Reference final ProjectService projectService, @Reference final ResourceService resourceService,
    ...
    {
        super( EnumSet.of( HttpMethod.GET, HttpMethod.HEAD, HttpMethod.OPTIONS ), "media" );
