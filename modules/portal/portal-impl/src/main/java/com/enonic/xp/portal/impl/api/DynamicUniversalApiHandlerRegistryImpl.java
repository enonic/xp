...
import com.enonic.xp.portal.universalapi.DynamicUniversalApiHandler;
import com.enonic.xp.portal.universalapi.DynamicUniversalApiHandlerRegistry;
import com.enonic.xp.portal.universalapi.UniversalApiHandler;
import com.enonic.xp.security.PrincipalKey;
import com.enonic.xp.security.PrincipalKeys;

@Component(service = DynamicUniversalApiHandlerRegistry.class)
public class DynamicUniversalApiHandlerRegistryImpl
    implements DynamicUniversalApiHandlerRegistry
{
    private final ConcurrentMap<DescriptorKey, DynamicUniversalApiHandler> dynamicApiHandlers = new ConcurrentHashMap<>();

    @Activate
    public DynamicUniversalApiHandlerRegistryImpl()
    {
