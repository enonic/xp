module api.content.page.part {
    ...
    export class PartDescriptorCache extends ModuleBasedCache<PartDescriptorModuleCache,PartDescriptor,DescriptorKey> {
        ...
        static get(): PartDescriptorCache {
            ...
            if (!topWindow.api.content.page.part.PartDescriptorCache.instance) {
                topWindow.api.content.page.part.PartDescriptorCache.instance = new PartDescriptorCache();
            }
            return topWindow.api.content.page.part.PartDescriptorCache.instance;
        }
