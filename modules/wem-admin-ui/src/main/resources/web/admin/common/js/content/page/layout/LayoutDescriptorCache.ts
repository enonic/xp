module api.content.page.layout {
    ...
    export class LayoutDescriptorCache extends ModuleBasedCache<LayoutDescriptorModuleCache,LayoutDescriptor,DescriptorKey> {
        ...
        static get(): LayoutDescriptorCache {
            ...
            if (!topWindow.api.content.page.layout.LayoutDescriptorCache.instance) {
                topWindow.api.content.page.layout.LayoutDescriptorCache.instance = new LayoutDescriptorCache();
            }
            return topWindow.api.content.page.layout.LayoutDescriptorCache.instance;
        }
