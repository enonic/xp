describe("api.data2.PropertySetTest", function () {

    var Property = api.data2.Property;
    var PropertySet = api.data2.PropertySet;
    var PropertyTree = api.data2.PropertyTree;
    var PropertyChangedEvent = api.data2.PropertyChangedEvent;
    var PropertyChangedEventType = api.data2.PropertyChangedEventType;
    var ValueTypes = api.data2.ValueTypes;
    var Value = api.data2.Value;
    var PropertyPath = api.data2.PropertyPath;
