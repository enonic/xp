...
@Component
public class ScriptAsyncServiceImpl
    implements ScriptAsyncService
{
    private static final Logger LOG = LoggerFactory.getLogger( ScriptAsyncServiceImpl.class );

    private final BundleTracker<SimpleExecutor> bundleTracker;

    @Activate
    public ScriptAsyncServiceImpl( final BundleContext context )
    {
