...
public class DateTest
{
    ...
    {
        Data.Date date = newDate().name( "myDate" ).value( new DateMidnight( 2013, 1, 1 ) ).build();
    ...
    {
        Data.Date date = newDate().name( "myDate" ).value( "2013-01-01" ).build();
        assertEquals( new DateMidnight( 2013, 1, 1 ), date.getDate() );
    }
    ...
    {
        Data.Date date = newDate().name( "myDate" ).value( "2013-34-43" ).build();
        assertEquals( new DateMidnight( 2013, 1, 1 ), date.getDate() );
    }
}
