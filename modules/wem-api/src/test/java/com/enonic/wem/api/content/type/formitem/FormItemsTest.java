...
public class FormItemsTest
{
    ...
    {
        FormItems formItems = new FormItems();
        formItems.addFormItem( newInput().name( "eyeColour" ).type( InputTypes.TEXT_LINE ).build() );
        formItems.addFormItem( newInput().name( "hairColour" ).type( InputTypes.TEXT_LINE ).build() );
    ...
    {
        FormItems formItems = new FormItems();
        formItems.addFormItem( newInput().name( "name" ).type( InputTypes.TEXT_LINE ).build() );
