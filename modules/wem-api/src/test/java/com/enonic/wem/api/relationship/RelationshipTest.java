...
public class RelationshipTest
{
    ...
    public void build()
    {
        ...
        relationBuilder.type( RelationshipTypeName.from( "system-0.0.0:like" ) );
        ...
        assertEquals( "system-0.0.0:like", relationship.getType().toString() );
    ...
    public void getKey_having_relationship_with_mangingData()
    {
        ...
        // verify
        assertEquals( "system-0.0.0:like", relationship.getKey().getType().toString() );
