...
public class Content_usageTest
{
    ...
    public void dataSet_setProperty()
    {
        ...
        dataSet.setProperty( "myDate", Value.newDateMidnight( new DateMidnight( 2013, 1, 13 ) ) );
    ...
    public void dataSet_setProperty_with_DataPath_containing_DataSet()
    {
        ...
        dataSet.setProperty( "mySet.myDate", Value.newDateMidnight( new DateMidnight( 2013, 1, 13 ) ) );
    ...
    public void dataSet_add_Data_using_newProperty()
    {
        ...
        dataSet.add( Property.newDateMidnight( "myDate", new org.joda.time.DateMidnight( 2013, 1, 13 ) ) );
    ...
    public void dataSet_add_Data_using_newPropertyType()
    {
        ...
        dataSet.add( Property.newLong( "myNum", 123L ) );
        dataSet.add( Property.newDouble( "myDec", 123.123 ) );
        dataSet.add( Property.newDateMidnight( "myDate", new DateMidnight( 2013, 1, 13 ) ) );
        dataSet.add( Property.newHtmlPart( "myHtml", "<p>abc</p>" ) );
    ...
    public void dataSet_addProperty()
    {
        ...
        dataSet.addProperty( "myDate", Value.newDateMidnight( new DateMidnight( 2013, 1, 13 ) ) );
    ...
    public void dataSet_addProperty_with_DataPath_containing_DataSet()
    {
        ...
        contentData.addProperty( "mySet.myDate", Value.newDateMidnight( new DateMidnight( 2013, 1, 13 ) ) );
    ...
    public void invoice_newProperty()
    {
        ...
        ContentData contentData = new ContentData();
        contentData.add( Property.newDateMidnight( "invoiceDate", invoice.invoiceDate.toDateMidnight() ) );
    ...
    public void invoice_setData_with_Value_Type()
    {
        ...
        ContentData contentData = new ContentData();
        contentData.setProperty( "invoiceDate", Value.newDateMidnight( invoice.invoiceDate.toDateMidnight() ) );
    ...
    private Value resolveValue( final Object value )
    {
        ...
        {
            return Value.newDouble( (Double) value );
        }
        else
        {
            return null;
    ...
    private Data myNewProperty( final String name, final Object value )
    {
        if ( value instanceof Double )
        {
            return Property.newDouble( name, (Double) value );
        }
        else
        {
            return null;
