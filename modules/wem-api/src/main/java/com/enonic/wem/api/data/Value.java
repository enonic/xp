...
public abstract class Value
{
     ...
     */
    public com.enonic.wem.api.data.PropertySet asData()
    ...
    public com.enonic.wem.api.util.GeoPoint asGeoPoint()
    {
        if ( object == null )
        {
            return null;
     ...
     * Attempts to return value as Reference, using best effort converting if value is not of type Reference.
     */
    public com.enonic.wem.api.util.BinaryReference asBinaryReference()
    {
        if ( object == null )
        {
            return null;
    ...
    public static Value newGeoPoint( final com.enonic.wem.api.util.GeoPoint value )
    {
    ...
    public static Value newBinary( final com.enonic.wem.api.util.BinaryReference value )
    {
    ...
    public static Value newData( final com.enonic.wem.api.data.PropertySet value )
    {
    ...
    static class PropertySet
        extends Value
    {
        PropertySet( final com.enonic.wem.api.data.PropertySet value )
        {
    ...
    static class GeoPoint
        extends Value
    {
        GeoPoint( final com.enonic.wem.api.util.GeoPoint value )
        {
    ...
    static class BinaryReference
        extends Value
    {
        BinaryReference( final com.enonic.wem.api.util.BinaryReference value )
        {
