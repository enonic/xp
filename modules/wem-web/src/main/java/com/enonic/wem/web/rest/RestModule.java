...
import com.enonic.wem.web.rest.resource.content.schema.SchemaImageResource;
...
import com.enonic.wem.web.rest.rpc.content.relationship.CreateRelationshipRpcHandler;
import com.enonic.wem.web.rest.rpc.content.relationship.GetRelationshipRpcHandler;
import com.enonic.wem.web.rest.rpc.content.relationship.UpdateRelationshipPropertiesRpcHandler;
import com.enonic.wem.web.rest.rpc.content.schema.GetSchemaTreeRpcHandler;
import com.enonic.wem.web.rest.rpc.content.schema.ListSchemasRpcHandler;
import com.enonic.wem.web.rest.rpc.content.schema.content.CreateOrUpdateContentTypeRpcHandler;
import com.enonic.wem.web.rest.rpc.content.schema.content.DeleteContentTypeRpcHandler;
import com.enonic.wem.web.rest.rpc.content.schema.content.GetContentTypeRpcHandler;
import com.enonic.wem.web.rest.rpc.content.schema.content.GetContentTypeTreeRpcHandler;
import com.enonic.wem.web.rest.rpc.content.schema.content.ListContentTypesRpcHandler;
import com.enonic.wem.web.rest.rpc.content.schema.content.ValidateContentTypeRpcHandler;
import com.enonic.wem.web.rest.rpc.content.schema.mixin.CreateOrUpdateMixinRpcHandler;
import com.enonic.wem.web.rest.rpc.content.schema.mixin.DeleteMixinRpcHandler;
import com.enonic.wem.web.rest.rpc.content.schema.mixin.GetMixinRpcHandler;
import com.enonic.wem.web.rest.rpc.content.schema.mixin.ListMixinsRpcHandler;
import com.enonic.wem.web.rest.rpc.content.schema.relationship.CreateOrUpdateRelationshipTypeRpcHandler;
import com.enonic.wem.web.rest.rpc.content.schema.relationship.DeleteRelationshipTypeRpcHandler;
import com.enonic.wem.web.rest.rpc.content.schema.relationship.GetRelationshipTypeRpcHandler;
import com.enonic.wem.web.rest.rpc.content.schema.relationship.ListRelationshipTypeRpcHandler;
