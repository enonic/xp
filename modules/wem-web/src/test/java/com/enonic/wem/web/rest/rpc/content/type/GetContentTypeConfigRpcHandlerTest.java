...
public class GetContentTypeConfigRpcHandlerTest
    extends AbstractRpcHandlerTest
{
    ...
    protected JsonRpcHandler createHandler()
        throws Exception
    {
        final GetContentTypeConfigRpcHandler handler = new GetContentTypeConfigRpcHandler();
    ...
    @Test
    public void testRequestGetContentTypeConfig_existing()
        throws Exception
    {
        ...
        testSuccess( "getContentTypeConfig_param.json", "getContentTypeConfig_result.json" );
    }

    @Test
    public void testRequestGetContentTypeConfig_not_found()
        throws Exception
    {
        ...
        testSuccess( "getContentTypeConfig_param.json", resultJson );
    }
}