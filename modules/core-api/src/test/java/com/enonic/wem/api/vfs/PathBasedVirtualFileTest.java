    ...
    extends AbstractVirtualFileTest
{
    ...
    {
        final VirtualFile file1 = VirtualFiles.from( this.rootDir ).resolve( "dir1" );
        ...
        final VirtualFile file3 = VirtualFiles.from( this.rootDir ).resolve( "dir1/file1.txt" );
    ...
    public void testFile()
        throws Exception
    {
        final VirtualFile file = VirtualFiles.from( this.rootDir ).resolve( "dir1/file1.txt" );
        assertTrue( file.exists() );
    ...
    {
        final VirtualFile file = VirtualFiles.from( this.rootDir ).resolve( "dir2" );
    ...
    {
        final VirtualFile file = VirtualFiles.from( this.rootDir ).resolve( "notFound" );
