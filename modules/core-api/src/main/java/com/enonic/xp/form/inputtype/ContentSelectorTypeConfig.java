...
@Beta
public final class ContentSelectorTypeConfig
    implements InputTypeConfig
{
    ...
    ContentSelectorTypeConfig( final Builder builder )
    {
    ...
    public static class Builder
    {
        ...
        public ContentSelectorTypeConfig build()
        {
            return new ContentSelectorTypeConfig( this );
        }
    }
