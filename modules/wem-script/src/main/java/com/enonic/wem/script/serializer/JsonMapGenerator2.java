...
public final class JsonMapGenerator2
    extends MapGeneratorBase2
{
    ...
    @Override
    protected void putInObject( final Object object, final String key, final Object value )
    {
        ( (ObjectNode) object ).set( key, toValue( value ) );
    }
