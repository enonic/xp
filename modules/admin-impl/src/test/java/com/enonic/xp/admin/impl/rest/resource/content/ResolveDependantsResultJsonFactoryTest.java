...
public class ResolveDependantsResultJsonFactoryTest
{
    ...
    public void testGeneratedJsonWithChildren()
    {
        ...
        final ResolveDependantsResultJson result = createDependantsResultJson( resolvedDependencies, resolved, compareResults );
    ...
    private ResolveDependantsResultJson createDependantsResultJson( final ResolvePublishDependenciesResult resolvedDependencies,
                                                                    final Contents resolved, final CompareContentResults compareResults )
    {
