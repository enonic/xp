    ...
    extends AbstractNodeTest
{
    ...
    void getChildren()
    {
        ...
        final Node node1_1 =
            createNode( CreateNodeParams.create().setNodeId( NodeId.from( "node1_1" ) ).parent( root.path() ).name( "node1_1" ).build() );
    ...
    {
        final Node node =
            createNode( CreateNodeParams.create().setNodeId( NodeId.from( "node" ) ).parent( NodePath.ROOT ).name( "node" ).build() );

        final Node node1_1 =
            createNode( CreateNodeParams.create().setNodeId( NodeId.from( "node1_1" ) ).parent( node.path() ).name( "node1_1" ).build() );
    ...
    void size()
    {
        ...
        FindNodesByParentResult children =
            findByParent( FindNodesByParentParams.create().parentPath( createdNode.path() ).size( 9 ).build() );
    ...
    void from()
    {
        ...
        FindNodesByParentResult children =
            findByParent( FindNodesByParentParams.create().parentPath( createdNode.path() ).size( 10 ).from( 0 ).build() );
    ...
    void get_by_parent_one_child()
    {
        ...
        final FindNodesByParentResult result = findByParent( FindNodesByParentParams.create().parentPath( createdNode.path() ).build() );
    ...
    void get_children_order()
    {
        ...
        assertThat( result.getNodeIds() ).containsExactly( childNode_a_2.id(), childNode_b_3.id(), childNode_c_1.id() );

        // Override by specify childOrder-parameter by order-field
        final FindNodesByParentResult resultByOrder = findByParent(
            FindNodesByParentParams.create().parentPath( createdNode.path() ).childOrder( ChildOrder.from( "order ASC" ) ).build() );

        assertThat( resultByOrder.getNodeIds() ).containsExactly( childNode_c_1.id(), childNode_a_2.id(), childNode_b_3.id() );
    }
    ...
    void child_order_use_root_node()
    {
        ...
        assertThat( result.getNodeIds() ).containsExactly( node2.id(), node3.id(), node1.id() );
    }
