    ...
    extends AbstractNodeTest
{
    ...
    void testReferencePerformance()
    {
        ...
        final ResolveSyncWorkResult resolvedNodes = ResolveSyncWorkCommand.create().nodeId( rootNode.id() ).target( WS_OTHER ).repositoryStorageAdmin( this.repositoryStorageAdmin )
