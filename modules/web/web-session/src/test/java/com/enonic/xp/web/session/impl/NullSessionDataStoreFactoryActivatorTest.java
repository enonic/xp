...
class NullSessionDataStoreFactoryActivatorTest
{
    ...
    {
        when( bundleContext.registerService( same( SessionDataStoreFactory.class ), (SessionDataStoreFactory) notNull(), isNull() ) ).
            thenReturn( sessionDataStoreFactoryServiceRegistration );
        when( bundleContext.registerService( same( SessionCacheFactory.class ), (SessionCacheFactory) notNull(), isNull() ) ).
        ...
        verify( bundleContext ).registerService( same( SessionDataStoreFactory.class ), (SessionDataStoreFactory) notNull(), isNull() );
        verify( bundleContext ).registerService( same( SessionCacheFactory.class ), (SessionCacheFactory) notNull(), isNull() );
