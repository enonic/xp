...
public class HazelcastSessionDataStoreFactoryActivatorActivator
    extends AbstractSessionDataStoreFactoryActivator
{
    private static final Logger LOG = LoggerFactory.getLogger( HazelcastSessionDataStoreFactoryActivatorActivator.class );
    ...
    @Activate
    public HazelcastSessionDataStoreFactoryActivatorActivator( final BundleContext bundleContext,
