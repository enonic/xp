...
public class AbstractSessionDataStoreFactoryActivator
{
    ...
    protected final void registerServices( final SessionDataStoreFactory sessionDataStoreFactory, SessionCacheFactory sessionCacheFactory )
    {
        sessionDataStoreFactoryReg =
            bundleContext.registerService( SessionDataStoreFactory.class, sessionDataStoreFactory, new Hashtable<>() );
        sessionCacheReg = bundleContext.registerService( SessionCacheFactory.class, sessionCacheFactory, new Hashtable<>() );
