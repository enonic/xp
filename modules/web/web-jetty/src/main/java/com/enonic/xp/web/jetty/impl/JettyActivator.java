...
public final class JettyActivator
{
    ...
    private void publishXpServletContext()
    {
        ...
        {
            xpServletContextReg = bundleContext.registerService( ServletContext.class, xpServletContext, new Hashtable<>(
        ...
        throws Exception
    {
        ...
        this.serverServiceRegistration = bundleContext.registerService( Server.class, this.server, new Hashtable<>() );
