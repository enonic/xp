module api.content {
    ...
    export class WidgetDescriptorKey implements api.Equitable {
        ...
        public static fromString(str: string): WidgetDescriptorKey {
            ...
            return new WidgetDescriptorKey(api.module.ApplicationKey.fromString(applicationKey), name);
        }

        constructor(applicationKey: api.module.ApplicationKey, name: string) {
