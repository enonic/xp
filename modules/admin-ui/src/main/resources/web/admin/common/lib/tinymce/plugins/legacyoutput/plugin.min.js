    ...
    a.on("AddEditor", function (a) {
        ...
        b.on("init", function () {
            ...
            return b.$.each(d.split(" "), function (b, c) {
                ...
                type: "listbox", text: "Font Sizes", tooltip: "Font Sizes", values: a, fixedWidth: !0, onPostRender: function () {
                    var a = this;
