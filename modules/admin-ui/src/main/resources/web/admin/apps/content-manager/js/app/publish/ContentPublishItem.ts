module app.publish {
    ...
    export class ContentPublishItem implements api.Equitable {
        ...
        private idOfContentThatTriggeredPublishForMe: string;
        ...
        constructor(builder: ContentPublishItemBuilder) {
            ...
            this.id = builder.id;
            this.idOfContentThatTriggeredPublishForMe = builder.reasonId;
        ...
        getIdOfContentThatTriggeredPublishForMe(): string {
            return this.idOfContentThatTriggeredPublishForMe;
        }
        ...
        equals(o: api.Equitable): boolean {
            ...
            if (!api.ObjectHelper.stringEquals(this.idOfContentThatTriggeredPublishForMe, other.idOfContentThatTriggeredPublishForMe)) {
                return false;
            }
    ...
    export class ContentPublishItemBuilder {
        ...
        constructor(source?: ContentPublishItem) {
            if (source) {
                ...
                this.idOfContentThatTriggeredPublishForMe = source.getIdOfContentThatTriggeredPublishForMe();
                this.compareStatus = source.getCompareStatus();
                this.name = source.getName();
                this.type = source.getType();
                this.valid = source.isValid();
                this.reasonId = source.getIdOfContentThatTriggeredPublishForMe();
            }
        }
