...
import com.enonic.wem.core.content.schema.type.form.inputtype.InputTypeConfigJsonSerializer;
    ...
    extends AbstractJsonSerializer<Input>
{
    ...
    private final com.enonic.wem.core.content.schema.type.form.inputtype.InputTypeJsonSerializer inputTypeSerializer;
    ...
    {
        super( objectMapper );
        inputTypeSerializer = new com.enonic.wem.core.content.schema.type.form.inputtype.InputTypeJsonSerializer( objectMapper );
