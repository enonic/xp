    ...
    implements DataType
{
        ...
        throws InconvertibleException
    {
        if ( data.getValue() != null )
        {
            ...
            {
                if ( value instanceof com.enonic.wem.core.content.data.DataSet )
                {
                    final com.enonic.wem.core.content.data.DataSet valueAsDataSet = (com.enonic.wem.core.content.data.DataSet) value;
        ...
        throws InvalidValueTypeException
    {
        ...
        {
            final com.enonic.wem.core.content.data.DataSet dataSet = data.getDataSet();
            for ( TypedPath typedPath : typedPaths.values() )
            {
