...
@JsonSubTypes({@JsonSubTypes.Type(value = EntityPatternIndexConfigJson.class, name = "Pattern"),
                  @JsonSubTypes.Type(value = EntityPropertyIndexConfigJson.class, name = "Property")})
