...
public class NodeStorageDocumentFactory
{
    ...
    public static NodeStorageDocument create( final Node node )
    {
    ...
    public static NodeStorageDocument update( final Node node )
    {
        final String serializedNode = NodeJsonSerializer.toString( node );
