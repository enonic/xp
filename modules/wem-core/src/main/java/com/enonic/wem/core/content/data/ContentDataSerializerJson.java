...
public class ContentDataSerializerJson
{
    ...
    public static String toJson( ContentData contentData )
    {
        try
        {
            ...
            EntriesSerializerJson.generate( contentData.getEntries(), g );
            g.close();
            sw.close();
            return sw.toString();
        }
    ...
    public ContentData parse( final String json, final ConfigItems configItems )
    {
        try
        {
            ...
            Entries entries = EntriesSerializerJson.parse( contentDataNode, configItems );
            ...
            contentData.setEntries( entries );
