    ...
    extends ContentService
{
        ...
        throws Exception
    {
        ...
        try
        {
            final Node nodeToDelete = new GetNodeByPathService( this.session, nodePath ).execute();
            ...
            final Node deletedNode = new DeleteNodeByPathService( this.session, this.indexService, nodePath ).execute();
