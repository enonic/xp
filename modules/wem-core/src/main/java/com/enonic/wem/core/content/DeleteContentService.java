    ...
    extends ContentService
{
    ...
    public DeleteContentService( final CommandContext context, final DeleteContent command, final NodeService nodeService )
    {
        super( context );
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            if ( new ChildContentIdsResolver( this.context, this.nodeService ).resolve( contentToDelete ).hasChildren() )
            {
