Feature: Horizontal Inheritance, used by a ContentType
  ...
  Scenario: Two ContentTypes using same subType
    ...
    And a FormItemSubType named mySubType in module myModule with input myName
    And a ContentType named cty1
    And a ContentType named cty2
    And adding SubTypeReference named myName referencing FormItemSubType myModule:mySubType to ContentType cty1
    And adding SubTypeReference named myName referencing FormItemSubType myModule:mySubType to ContentType cty2
