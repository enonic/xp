...
public class ConfigItemJsonParserTest
{
        ...
        throws IOException
    {
        ...
        // exercise
        ConfigItem configItem = ConfigItemJsonParser.parse( objectMapper.readValue( jp, JsonNode.class ) );
    ...
    private String subTypeToJson( SubType field )
        throws IOException
    {
        SubTypeJsonGenerator.DEFAULT.generate( field, g );
        g.close();
        return sw.toString();
    }
    ...
    private String fieldToJson( Field field )
        throws IOException
    {
        FieldJsonGenerator.DEFAULT.generate( field, g );
        g.close();
        return sw.toString();
    }
}
