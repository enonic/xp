...
public class ContentAttachmentNodeTranslatorTest
{
        ...
        throws Exception
    {
        ...
        final com.enonic.wem.api.node.Attachments attachments = contentAttachmentNodeTranslator.toNodeAttachments( contentAttachments );

        assertEquals( 1, attachments.getSize() );

        final com.enonic.wem.api.node.Attachment attachment = attachments.get( 0 );
    ...
    {
        final com.enonic.wem.api.node.Attachments attachments = contentAttachmentNodeTranslator.toNodeAttachments( null );
    ...
    {
        final com.enonic.wem.api.node.Attachments attachments = contentAttachmentNodeTranslator.toNodeAttachments( Attachments.empty() );

        assertEquals( com.enonic.wem.api.node.Attachments.empty(), attachments );
    }
