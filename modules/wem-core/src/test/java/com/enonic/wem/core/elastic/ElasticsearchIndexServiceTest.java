...

{
    ...
    public void testInitializeIndex_index_not_exists()
        throws Exception
    {
        final ElasticsearchService elasticsearchIndexService = Mockito.mock( ElasticsearchService.class );
        ...
        indexService.setElasticsearchService( elasticsearchIndexService );
