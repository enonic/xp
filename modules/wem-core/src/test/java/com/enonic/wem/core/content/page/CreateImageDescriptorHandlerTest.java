...
public class CreateImageDescriptorHandlerTest
    extends AbstractCommandHandlerTest
{

    private CreateImageDescriptorHandler handler;
        ...
        throws Exception
    {
        ...
        handler = new CreateImageDescriptorHandler();
