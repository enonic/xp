    ...
    extends AbstractCommandHandlerTest
{
        ...
        throws Exception
    {
        ...
        existingContentData.add( Property.newProperty().name( "myData" ).type( PropertyTypes.TEXT ).value( "aaa" ).build() );
        ...
        unchangedContentData.add( Property.newProperty().name( "myData" ).type( PropertyTypes.TEXT ).value( "aaa" ).build() );
        ...
        throws Exception
    {
        ...
        changedContentData.add( Property.newProperty().name( "myData" ).type( PropertyTypes.TEXT ).value( "bbb" ).build() );
