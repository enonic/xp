    ...
    extends ScriptTestSupport
{
        ...
        throws Exception
    {
        ...
        when( portalUrlService.assetUrl( any( AssetUrlParams.class ) ) ).thenAnswer( invocation -> {
        ...
        when( portalUrlService.attachmentUrl( any( AttachmentUrlParams.class ) ) ).thenAnswer( invocation -> {
        ...
        when( portalUrlService.componentUrl( any( ComponentUrlParams.class ) ) ).thenAnswer( invocation -> {
        ...
        when( portalUrlService.imageUrl( any( ImageUrlParams.class ) ) ).thenAnswer( invocation -> {
        ...
        when( portalUrlService.pageUrl( any( PageUrlParams.class ) ) ).thenAnswer( invocation -> {
        ...
        when( portalUrlService.serviceUrl( any( ServiceUrlParams.class ) ) ).thenAnswer( invocation -> {
