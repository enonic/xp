    ...
    implements ScriptBean
{
    ...
    {
        final UpdateDynamicMacroParams params = UpdateDynamicMacroParams.create().key( MacroKey.from( key ) ).resource( resource ).build();
        return new MacroDescriptorMapper( dynamicSchemaServiceSupplier.get().updateMacro( params ) );
    }
