    ...
    implements ScriptBean
{
    ...
    {
        final CreateDynamicMacroParams params = CreateDynamicMacroParams.create().key( MacroKey.from( key ) ).resource( resource ).build();
        return new MacroDescriptorMapper( dynamicSchemaServiceSupplier.get().createMacro( params ) );
    }
