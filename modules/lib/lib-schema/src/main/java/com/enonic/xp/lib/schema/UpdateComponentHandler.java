...
public final class UpdateComponentHandler
    implements ScriptBean
{
    ...
    public Object execute()
    {
        ...
        {
            case "PART" -> schemaServiceSupplier.get().updatePart( params );
            case "LAYOUT" -> schemaServiceSupplier.get().updateLayout( params );
            case "PAGE" -> schemaServiceSupplier.get().updatePage( params );
