...
public final class CreateDynamicCmsHandler
    implements ScriptBean
{
    ...
    public Object execute()
    {
        final CreateDynamicCmsParams params =
            CreateDynamicCmsParams.create().key( ApplicationKey.from( application ) ).resource( resource ).build();

        final DynamicSchemaResult<CmsDescriptor> result = schemaServiceSupplier.get().createCms( params );
