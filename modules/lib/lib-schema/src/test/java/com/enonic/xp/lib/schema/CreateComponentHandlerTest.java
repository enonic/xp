...
class CreateComponentHandlerTest
    extends BaseSchemaHandlerTest
{
    @Test
    void testPart()
    {
        when( schemaService.createPart( isA( CreateComponentParams.class ) ) ).thenAnswer( params -> {
            final CreateComponentParams componentParams = params.getArgument( 0, CreateComponentParams.class );
    ...
    void testLayout()
    {
        when( schemaService.createLayout( isA( CreateComponentParams.class ) ) ).thenAnswer( params -> {
            final CreateComponentParams componentParams = params.getArgument( 0, CreateComponentParams.class );
    ...
    void testPage()
    {
        when( schemaService.createPage( isA( CreateComponentParams.class ) ) ).thenAnswer( params -> {
            final CreateComponentParams componentParams = params.getArgument( 0, CreateComponentParams.class );
    ...
    {
        runFunction( "/test/CreateComponentHandlerTest.js", "createInvalidComponent" );
    }
}