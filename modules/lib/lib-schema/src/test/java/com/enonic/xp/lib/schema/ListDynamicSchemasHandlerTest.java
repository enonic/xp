    ...
    extends BaseSchemaHandlerTest
{
    ...
    {
        when( dynamicSchemaService.listContentTypes( isA( ApplicationKey.class ) ) ).thenAnswer( params -> {
    ...
    {
        when( dynamicSchemaService.listFormFragments( isA( ApplicationKey.class ) ) ).thenAnswer( params -> {
            final ApplicationKey applicationKey = params.getArgument( 0, ApplicationKey.class );
    ...
    void listMixins()
    {
        when( dynamicSchemaService.listMixins( isA( ApplicationKey.class ) ) ).thenAnswer( params -> {
            final ApplicationKey applicationKey = params.getArgument( 0, ApplicationKey.class );
