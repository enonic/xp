    ...
    extends BaseSchemaHandlerTest
{
    ...
    {
        when( dynamicSchemaService.updateContentType( isA( UpdateDynamicContentSchemaParams.class ) ) ).thenAnswer( params -> {
    ...
    {
        when( dynamicSchemaService.updateFormFragment( isA( UpdateDynamicContentSchemaParams.class ) ) ).thenAnswer( params -> {
            final UpdateDynamicContentSchemaParams schemaParams = params.getArgument( 0, UpdateDynamicContentSchemaParams.class );
    ...
    void testMixin()
    {
        when( dynamicSchemaService.updateMixin( isA( UpdateDynamicContentSchemaParams.class ) ) ).thenAnswer( params -> {
            final UpdateDynamicContentSchemaParams schemaParams = params.getArgument( 0, UpdateDynamicContentSchemaParams.class );
