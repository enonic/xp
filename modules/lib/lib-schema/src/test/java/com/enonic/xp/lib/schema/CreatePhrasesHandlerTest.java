...
class CreatePhrasesHandlerTest
    extends BaseSchemaHandlerTest
{
    @Test
    void testCreatePhrases()
    {
        when( schemaService.createPhrases( isA( CreatePhrasesParams.class ) ) ).thenAnswer( invocation -> {
            final CreatePhrasesParams params = invocation.getArgument( 0, CreatePhrasesParams.class );
