    ...
    extends BaseSchemaHandlerTest
{
    ...
    void testGetPhrases()
    {
        when( dynamicSchemaService.getPhrases( isA( GetDynamicPhrasesParams.class ) ) ).thenAnswer( invocation -> {
    ...
    void testNotFound()
    {
        when( dynamicSchemaService.getPhrases( isA( GetDynamicPhrasesParams.class ) ) ).thenReturn( null );

        runFunction( "/test/GetDynamicPhrasesHandlerTest.js", "getNotFound" );
    }
}
