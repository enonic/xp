...
final class QueryAggregationParams
{
    ...
    private AggregationQuery aggregationQueryFromParams( final String name, final Map<String, Object> aggregationQueryMap )
    {
        ...
        {
            final Map<String, Object> statsParamsMap = (Map<String, Object>) aggregationQueryMap.get( "stats" );
            final StatsAggregationQuery.Builder statsRangeAggregationQuery = statsAggregationFromParams( name, statsParamsMap );
