...
public final class TestDataFixtures
{
                                                        ...
                                                        final PropertyTree imageConfig )
    {
        ...
        final Content imageContent =
            Content.create().name( "someimage" ).displayName( imageDisplayName ).parentPath( ContentPath.ROOT ).build();
    ...
    private static FragmentComponent createFragmentComponent( final String fragmentId, final String fragmentDisplayName )
    {
        ...
        final Content fragmentContent =
            Content.create().name( "somefragment" ).displayName( fragmentDisplayName ).parentPath( ContentPath.ROOT ).build();
