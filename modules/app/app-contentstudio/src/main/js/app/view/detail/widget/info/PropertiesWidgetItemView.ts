...
export class PropertiesWidgetItemView extends WidgetItemView {
    ...
    private layoutApplication(application?: Application) {
        ...
        const strings: Field[] = [
            ...
            this.pageTemplate ? new FieldLink().setTooltip(this.isPageTemplateAutogenerated() ? 'Automatic' : null)
                                  .setContent(this.isPageTemplateEditable() ? this.pageTemplate : null)
                                  .setName('Page Template')
                                  .setValue(this.getPageTemplateName()) : null
        ];
