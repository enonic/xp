...
function createStep1() {
    var html = '<div class="xp-tour-step step-1">' +
               ...
               '    <img src="' + CONFIG.assetsUri + '/admin/images/app-icon.svg">' +
               '    <div class="text">' +
...
function createStep2() {
    var html = '<div class="xp-tour-step step-2">' +
               ...
               '    <img src="' + CONFIG.assetsUri + '/admin/images/launcher.svg">' +
               '    <div class="text">' +
...
function createStep3() {
    var html = '<div class="xp-tour-step step-3">' +
               ...
               '    <img src="' + CONFIG.assetsUri + '/admin/images/market.svg">' +
               '    <div class="text">' +
...
function createStep4() {
    var html = '<div class="xp-tour-step step-4">' +
               ...
               '    <img src="' + CONFIG.assetsUri + '/admin/images/studio.svg">' +
               '    <div class="text">' +
