...
:execute
"%JAVA_EXE%" %JAVA_OPTS% -Dxp.install="%XP_INSTALL%" -Dfile.encoding=UTF8 -Dnashorn.args="--no-deprecation-warning" %XP_OPTS% -Dmapper.allow_dots_in_name=true -classpath "%XP_INSTALL%\lib\*" com.enonic.xp.launcher.LauncherMain %ARGS%
endlocal
