...
:execute
"%JAVA_EXE%" %JAVA_OPTS% -Dxp.install="%XP_INSTALL%" -Dxp.bundled.es="%XP_BUNDLED_ES%" -Dfile.encoding=UTF8 -Dnashorn.args="--no-deprecation-warning" %XP_OPTS% -Dmapper.allow_dots_in_name=true --add-opens java.base/java.net=ALL-UNNAMED --add-opens java.xml/com.sun.org.apache.xerces.internal.util=ALL-UNNAMED -classpath "%XP_INSTALL%\lib\*" com.enonic.xp.launcher.LauncherMain %ARGS%
endlocal
