...
class SchemaApiHandlerTest
{
    ...
    private DynamicSchemaResult<BaseSchema<?>> contentSchemaResult()
    {
        final BaseSchema schema = mock( BaseSchema.class );
        when( schema.getName() ).thenReturn( ContentTypeName.from( APP, "article" ) );
        return new DynamicSchemaResult<>( schema, mockResource() );
    }

    @Test
    void listSchemas()
    {
        final DynamicSchemaResult<BaseSchema<?>> result = contentSchemaResult();
        when( schemaService.listContentSchemas( any() ) ).thenReturn( List.of( result ) );
        ...
        final ArgumentCaptor<ListDynamicContentSchemasParams> captor = ArgumentCaptor.forClass( ListDynamicContentSchemasParams.class );
        verify( schemaService ).listContentSchemas( captor.capture() );
    ...
    {
        final DynamicSchemaResult<BaseSchema<?>> result = contentSchemaResult();
        when( schemaService.getContentSchema( any() ) ).thenReturn( result );
    ...
    {
        final DynamicSchemaResult<BaseSchema<?>> result = contentSchemaResult();
        when( schemaService.createContentSchema( any() ) ).thenReturn( result );
        ...
        final ArgumentCaptor<CreateDynamicContentSchemaParams> captor = ArgumentCaptor.forClass( CreateDynamicContentSchemaParams.class );
        verify( schemaService ).createContentSchema( captor.capture() );
    ...
    {
        when( schemaService.createContentSchema( any() ) ).thenThrow(
    ...
    {
        when( schemaService.updateContentSchema( any() ) ).thenThrow( new NodeNotFoundException( "node not found" ) );
    ...
    void deleteSchema()
    {
        when( schemaService.deleteContentSchema( any() ) ).thenReturn( true );
    ...
    private DynamicSchemaResult<ComponentDescriptor> componentResult( final String name )
    {
        final ComponentDescriptor descriptor = mock( ComponentDescriptor.class );
        when( descriptor.getKey() ).thenReturn( DescriptorKey.from( APP, name ) );
        return new DynamicSchemaResult<>( descriptor, mockResource() );
    }

    @Test
    void getComponent()
    {
        final DynamicSchemaResult<ComponentDescriptor> result = componentResult( "mypart" );
        when( schemaService.getComponent( any() ) ).thenReturn( result );
    ...
    {
        final DynamicSchemaResult<ComponentDescriptor> result = componentResult( "mylayout" );
        when( schemaService.createComponent( any() ) ).thenReturn( result );
        ...
        final ArgumentCaptor<CreateDynamicComponentParams> captor = ArgumentCaptor.forClass( CreateDynamicComponentParams.class );
        verify( schemaService ).createComponent( captor.capture() );
        assertEquals( DescriptorKey.from( APP, "mylayout" ), captor.getValue().getKey() );
        assertEquals( DynamicComponentType.LAYOUT, captor.getValue().getType() );
    ...
    private DynamicSchemaResult<MacroDescriptor> macroResult()
    {
    ...
    void getMacro()
    {
        final DynamicSchemaResult<MacroDescriptor> result = macroResult();
    ...
    void createMacro()
    {
        ...
        final ArgumentCaptor<CreateDynamicMacroParams> captor = ArgumentCaptor.forClass( CreateDynamicMacroParams.class );
    ...
    void createStyles()
    {
        ...
        when( schemaService.createStyles( any() ) ).thenReturn( new DynamicSchemaResult<>( null, resource ) );
        ...
        final ArgumentCaptor<CreateDynamicStylesParams> captor = ArgumentCaptor.forClass( CreateDynamicStylesParams.class );
    ...
    {
        final Resource resource = mockResource();
        when( schemaService.updateStyles( any() ) ).thenReturn( new DynamicSchemaResult<>( null, resource ) );

        final WebResponse response = handler.handle( request( HttpMethod.PUT, "/styles/myapp", "{\"resource\":\"kind: Styles\"}" ) );

        assertEquals( HttpStatus.OK, response.getStatus() );

        final ArgumentCaptor<UpdateDynamicStylesParams> captor = ArgumentCaptor.forClass( UpdateDynamicStylesParams.class );
    ...
    {
        final Resource resource = mockResource();
        when( schemaService.getCmsDescriptor( APP ) ).thenReturn( new DynamicSchemaResult<>( null, resource ) );
    ...
    void createPhrases()
    {
        ...
        final ArgumentCaptor<CreateDynamicPhrasesParams> captor = ArgumentCaptor.forClass( CreateDynamicPhrasesParams.class );
