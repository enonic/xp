...
{
    public static StorageDocument create( final NodeVersionDocument nodeVersion, final RepositoryId repositoryId )
    {
        ...
        return StorageDocument.create().
            id( new NodeVersionDocumentId( nodeVersion.getNodeId(), nodeVersion.getNodeVersionId() ).toString() ).
