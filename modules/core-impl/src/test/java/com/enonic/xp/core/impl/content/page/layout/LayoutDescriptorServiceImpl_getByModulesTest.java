    ...
    extends AbstractLayoutDescriptorServiceTest
{
        ...
        throws Exception
    {
        ...
        mockResourcePaths( module, "app/layouts/foomodule-layout-descr/layout.xml" );
        ...
        throws Exception
    {
        ...
        mockResourcePaths( modules.getModule( ModuleKey.from( "foomodule" ) ), "app/layouts/foomodule-layout-descr/layout.xml" );
        mockResourcePaths( modules.getModule( ModuleKey.from( "barmodule" ) ), "app/layouts/barmodule-layout-descr/layout.xml" );
