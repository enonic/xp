...
public class LocaleServiceImplTest
{
        ...
        throws Exception
    {
        ...
        writeFile( modulesDir, "mymodule/cms/i18n/phrases_en_US_1.properties", "d = phrases_en_US_1.properties" );
        writeFile( modulesDir, "mymodule/cms/i18n/phrases_en_US.properties", "b = phrases_en_US.properties" );
        writeFile( modulesDir, "mymodule/cms/i18n/phrases_en.properties", "a = phrases_en.properties" );
        writeFile( modulesDir, "mymodule/cms/i18n/phrases.properties", "c = phrases.properties" );
