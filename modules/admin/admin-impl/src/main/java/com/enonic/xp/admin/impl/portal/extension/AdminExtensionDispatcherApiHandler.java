    ...
    implements UniversalApiHandler
{
    ...
    @Activate
    public AdminExtensionDispatcherApiHandler( @Reference final GetListAllowedAdminExtensionsHandler listWidgetsHandler,
    ...
    {
        this.listExtensionsHandler = listWidgetsHandler;
