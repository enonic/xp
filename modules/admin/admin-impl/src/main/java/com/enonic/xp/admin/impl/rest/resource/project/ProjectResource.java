    ...
    implements JaxRsComponent
{
        ...
        throws Exception
    {
        ...
        projectService.modifyReadAccess( project.getName(), readAccess );

        return new ProjectJson( project, projectPermissions, readAccess );
    }
        ...
        throws Exception
    {
        ...
        final ProjectPermissions modifiedProjectPermissions =
            this.projectService.modifyPermissions( modifiedProject.getName(), getPermissionsFromForm( form ) );

        final ProjectReadAccess modifiedReadAccess =
            this.projectService.modifyReadAccess( modifiedProject.getName(), getReadAccessFromForm( form ) );

        return doCreateJson( modifiedProject, modifiedProjectPermissions, modifiedReadAccess );
    }
    ...
    private ProjectJson doCreateJson( final Project project )
    {
        ...
        ProjectReadAccess readAccess = null;
        ...
        if ( !ProjectConstants.DEFAULT_PROJECT_NAME.equals( projectName ) )
        {
            ...
            readAccess = this.projectService.getReadAccess( projectName );
        }

        return doCreateJson( project, projectPermissions, readAccess );
    }
