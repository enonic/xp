...
public class GetAdminExtensionIconHandler
{
    ...
    public WebResponse handle( final WebRequest webRequest )
    {
        ...
        final AdminExtensionDescriptor widgetDescriptor = this.descriptorService.getByKey( descriptorKey );

        final Icon icon = extensionIconResolver.resolve( widgetDescriptor );
