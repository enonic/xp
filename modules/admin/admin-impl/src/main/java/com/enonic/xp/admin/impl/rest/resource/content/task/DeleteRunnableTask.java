    ...
    extends AbstractRunnableTask
{
    ...
    private long countContentsToDelete( final ContentPaths contentsToDeleteList )
    {
        ...
        long result = 0;
        result += contentsToDeleteList.getSize();

        final long childrenToDeleteNumber = countChildrenToDelete( contentsToDeleteList );

        result += childrenToDeleteNumber;
        ...
        if ( params.isDeleteOnline() )
        {
            ...
            final long contentsToDeleteInMaster =
            ...
            result += contentsToDeleteInMaster + childrenToDeleteInMaster;
        }
