    ...
    extends BaseHandlerTest
{
        ...
        throws Exception
    {
        ...
        this.request.setEndpointPath( "/_/adminapp/demo/myadminapp" );
    }
    ...
    public void testMatch()
    {
        ...
        this.request.setEndpointPath( "/adminapp/demo/myadminapp" );
        assertEquals( false, this.handler.canHandle( this.request ) );
    ...
    public void testNotValidUrlPattern()
        throws Exception
    {
        this.request.setEndpointPath( "/_/adminapp/" );
    ...
    public void executeFailsWithWrongMode()
        throws Exception
    {
        this.request.setEndpointPath( "/_/adminapp/demo/test" );
