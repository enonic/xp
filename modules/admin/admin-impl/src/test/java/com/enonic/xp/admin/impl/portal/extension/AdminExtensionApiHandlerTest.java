...
class AdminExtensionApiHandlerTest
{
    ...
    void testHandle()
    {
        ...
        final AdminExtensionDescriptor descriptor =
            AdminExtensionDescriptor.create().key( descriptorKey ).addInterface( "myInterface" ).build();
        ...
        when( webRequest.getMethod() ).thenReturn( HttpMethod.GET );
        when( webRequest.getEndpointPath() ).thenReturn( "/_/admin:extension/app/extensionName" );
        when( webRequest.getRawPath() ).thenReturn( "/admin/myapp/toolName/_/admin:extension/app/extensionName" );
    ...
    void testGenericWidgetAvailableInAdminToolWhenWidgetNotInInterfaces()
    {
        ...
        final AdminExtensionDescriptor descriptor =
            AdminExtensionDescriptor.create().key( descriptorKey ).addInterface( "generic" ).build();
    ...
    void testWidgetOnInvalidAdminToolUrl()
    {
        ...
        when( webRequest.getMethod() ).thenReturn( HttpMethod.GET );
        when( webRequest.getEndpointPath() ).thenReturn( "/_/admin:extension/app/extensionName" );
        when( webRequest.getRawPath() ).thenReturn( "/admin/app/_/admin:extension/app/extensionName" );
