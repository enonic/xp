...
CKEDITOR.lang['pl'] = {
    ...
    "bidi": {"ltr": "Kierunek tekstu od lewej strony do prawej", "rtl": "Kierunek tekstu od prawej strony do lewej"},
    ...
    "colordialog": {"clear": "Wyczyść", "highlight": "Zaznacz", "options": "Opcje koloru", "selected": "Wybrany", "title": "Wybierz kolor"},
    "templates": {
        "button": "Szablony",
    ...
    "font": {
        "fontSize": {"label": "Rozmiar", "voiceLabel": "Rozmiar czcionki", "panelTitle": "Rozmiar"},
        "label": "Czcionka",
        "panelTitle": "Czcionka",
        "voiceLabel": "Czcionka"
    },
    "forms": {
        ...
        "hidden": {"title": "Właściwości pola ukrytego", "name": "Nazwa", "value": "Wartość"},
        "select": {
    ...
    "smiley": {"options": "Opcje emotikonów", "title": "Wstaw emotikona", "toolbar": "Emotikony"},
    "justify": {"block": "Wyjustuj", "center": "Wyśrodkuj", "left": "Wyrównaj do lewej", "right": "Wyrównaj do prawej"},
    ...
    "specialchar": {"options": "Opcje znaków specjalnych", "title": "Wybierz znak specjalny", "toolbar": "Wstaw znak specjalny"},
    "scayt": {
