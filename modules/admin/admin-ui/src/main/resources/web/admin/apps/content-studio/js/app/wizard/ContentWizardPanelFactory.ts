...
export class ContentWizardPanelFactory {
    ...
    private newContentWizardPanelForNew(): wemQ.Promise<ContentWizardPanel> {

        var deferred = wemQ.defer<ContentWizardPanel>();

        var wizardParams = new ContentWizardPanelParams().setAppBarTabId(this.appBarTabId).setContentType(
            this.contentType).setParentContent(this.parentContent).setSite(this.siteContent).setDefaultModels(this.defaultModels);
    ...
    private newContentWizardPanelForEdit(): wemQ.Promise<ContentWizardPanel> {

        var deferred = wemQ.defer<ContentWizardPanel>();

        var wizardParams = new ContentWizardPanelParams().setAppBarTabId(this.appBarTabId).setContentType(
            this.contentType).setParentContent(this.parentContent).setPersistedContent(this.contentToEdit).setSite(
            this.siteContent).setDefaultModels(this.defaultModels);
