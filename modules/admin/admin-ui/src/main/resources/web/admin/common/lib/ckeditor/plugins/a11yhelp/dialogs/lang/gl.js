...
CKEDITOR.plugins.setLang("a11yhelp", "gl", {
    ...
    legend: [{
        ...
        items: [{name: "Orde «desfacer»", legend: "Prema ${undo}"}, {name: "Orde «refacer»", legend: "Prema ${redo}"},
            ...
            {name: "Orde «subliñar»", legend: "Prema ${underline}"}, {name: "Orde «ligazón»", legend: "Prema ${link}"},
            ...
            {name: "Pegar como texto simple", legend: "Prema ${pastetext}", legendEdge: "Prema ${pastetext}, seguido de ${paste}"}]
    }],
    tab: "Tabulador",
    pause: "Pausa",
    capslock: "Bloq. Maiús",
