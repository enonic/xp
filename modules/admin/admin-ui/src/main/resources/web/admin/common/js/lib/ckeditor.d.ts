...
declare namespace CKEDITOR {
    ...
    namespace dom {
        ...
        class event {
            ...
            on(eventName: string, listenerFunction: (eventInfo: eventInfo) => void, scopeObj?: Object, listenerData?: Object,
    ...
    namespace plugins {
        ...
        class widget implements CKEDITOR.plugins.widget.definition {
            ...
            constructor(widgetsRepo: CKEDITOR.plugins.widget.repository, id: number, element: CKEDITOR.dom.element,
                        widgetDef: CKEDITOR.plugins.widget.definition, starupData?: Object);
    ...
    class event {
        ...
        once(eventName: string, listenerFunction: (eventInfo: eventInfo) => void, scopeObj?: Object, listenerData?: Object,
             priority?: number): void;
        ...
        namespace dialog {
            class uiElement {
                ...
                constructor(dialog: CKEDITOR.dialog, elementDefinition: CKEDITOR.dialog.definition.uiElement, htmlList: any[],
                            nodeNameArg?: Function | string, stylesArg?: Function | Object, attributesArg?: Function | Object,
                            contentsArg?: Function | string); // Not sure that the htmlList array type is right.
            ...
            class fieldset extends uiElement {
                constructor(dialog: CKEDITOR.dialog, childObjList: any[], childHtmlList: any[], htmlList: any[],
    ...
    namespace dialog {
        ...
        function addIframe(name: string, title: string, minWidth: number, minHeight: number, onContentLoad?: Function,
