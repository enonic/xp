!function () {
    function a(a, b, c, d, e) {
        ...
        function h(a, b, c) {
            var d, e, f, g, h = [], i = 0, j = a, k = b.shift(), l = 0;
            a:for (; ;) {
                if ((m[j.nodeName] || o[j.nodeName]) && i++, 3 === j.nodeType &&
                                                             (!e && j.length + i >= k[1] ? (e = j, g = k[1] - i) : d && h.push(j), !d &&
                                                             j.length + i > k[0] && (d = j, f = k[0] - i), i += j.length), d && e) {
                    if (j = c({
                            startNode: d,
                            startNodeIndex: f,
                            endNode: e,
                            ...
                            match: k[2],
                            matchIndex: l
                        }), i -= e.length - g, d = null, e = null, h = [], k = b.shift(), l++, !k) {
                        break
                    }
                } else {
        ...
        function i(a) {
            ...
            return function (a) {
                ...
                if (f === g) {
                    var i = f;
                    e = i.parentNode, a.startNodeIndex > 0 &&
                                      (c = l.createTextNode(i.data.substring(0, a.startNodeIndex)), e.insertBefore(c, i));
                    var j = b(a.match[0], h);
                    return e.insertBefore(j, i), a.endNodeIndex < i.length &&
                                                 (d = l.createTextNode(i.data.substring(a.endNodeIndex)), e.insertBefore(d,
                                                     i)), i.parentNode.removeChild(i), j
                }
                ...
                return e = f.parentNode, e.insertBefore(c, f), e.insertBefore(k, f), e.removeChild(f), e = g.parentNode, e.insertBefore(r,
                    g), e.insertBefore(d, g), e.removeChild(g), r
            }
        }

        var j, k, l, m, n, o, p = [], q = 0;
    ...
    function b(b) {
        function c() {
            ...
            var d = {}, e = tinymce.ui.Factory.create({
                type: "window",
                layout: "flex",
                pack: "center",
                align: "center",
                ...
                onSubmit: function (b) {
                    var f, h, i, l;
                    return b.preventDefault(), h = e.find("#case").checked(), l = e.find("#words").checked(), i =
                        e.find("#find").value(), i.length
                        ? d.text == i && d.caseState == h && d.wholeWord == l
                                                     ? 0 === g(k + 1).length
                              ? void c()
                              : (j.next(), void a())
                                                     : (f = j.find(i, h, l), f || c(), e.statusbar.items().slice(1).disabled(0 ===
                                                                                                                             f), a(), void(d =
                    {text: i, caseState: h, wholeWord: l}))
                ...
                items: {
                    ...
                    labelGap: 30,
                    spacing: 10,
                    items: [{type: "textbox", name: "find", size: 40, label: "Find", value: b.selection.getNode().src},
        ...
        function e(c) {
            var d, e;
            return e = b.dom.create("span", {"data-mce-bogus": 1}), e.className = "mce-match-marker", d = b.getBody(), j.done(!1), a(c, d,
                e, !1, b.schema)
        }
        ...
        j.init = function (a) {
            a.addMenuItem("searchreplace", {
                ...
                separator: "before",
                context: "edit"
            }), a.addButton("searchreplace", {tooltip: "Find and replace", shortcut: "Meta+F", onclick: c}), a.addCommand("SearchReplace",
                c), a.shortcuts.add("Meta+F", "", c)
            ...
            for (c = c !== !1, m = b.getBody(), l = tinymce.toArray(m.getElementsByTagName("span")), h = 0; h < l.length; h++) {
                ...
                if (null !== r && r.length) {
                    if (n = o = parseInt(r, 10), e || n === k) {
                        ...
                        o > k && l[h].setAttribute("data-mce-index", o - 1)
                    }
                }
            }
