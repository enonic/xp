...
CKEDITOR.lang['lt'] = {
    ...
    "bidi": {"ltr": "Tekstas iš kairės į dešinę", "rtl": "Tekstas iš dešinės į kairę"},
    ...
    "font": {
        "fontSize": {"label": "Šrifto dydis", "voiceLabel": "Šrifto dydis", "panelTitle": "Šrifto dydis"},
        "label": "Šriftas",
        "panelTitle": "Šriftas",
        "voiceLabel": "Šriftas"
    },
    "forms": {
        ...
        "form": {"title": "Formos savybės", "menu": "Formos savybės", "action": "Veiksmas", "method": "Metodas", "encoding": "Kodavimas"},
        "hidden": {"title": "Nerodomo lauko savybės", "name": "Vardas", "value": "Reikšmė"},
        "select": {
        ...
        "textarea": {"title": "Teksto srities savybės", "cols": "Ilgis", "rows": "Plotis"},
        "textfield": {
    ...
    "smiley": {"options": "Šypsenėlių nustatymai", "title": "Įterpti veidelį", "toolbar": "Veideliai"},
    "justify": {"block": "Lygiuoti abi puses", "center": "Centruoti", "left": "Lygiuoti kairę", "right": "Lygiuoti dešinę"},
    ...
    "pagebreak": {"alt": "Puslapio skirtukas", "toolbar": "Įterpti puslapių skirtuką"},
    "pastetext": {
