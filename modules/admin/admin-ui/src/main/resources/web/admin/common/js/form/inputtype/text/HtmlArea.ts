        ...
        private initEditor(id: string, property: Property, textAreaWrapper: Element): void {
            ...
            tinymce.init({
                ...
                formats: {
                    ...
                    alignjustify: [
                        {selector: 'img', collapsed: false, attributes: {halign: "justified"}},
