...
export class SelectionPublishItemBuilder<M extends ContentPublishItem> {
    ...
    build(): SelectionPublishItem<M> {
        ...
        this.browseItem = new BrowseItem<M>(this.content).setId(this.content.getId()).setDisplayName(this.content.getDisplayName()).setPath(
            this.content.getPath().toString()).setIconUrl(this.content.getIconUrl());
