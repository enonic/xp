        ...
        qq.uiPrivateApi = {
            ...
            _maybeUpdateThumbnail: function (fileId) {
                ...
                if (fileStatus !== qq.status.DELETED &&
                    (thumbnailUrl ||
                     this._options.thumbnails.placeholders.waitUntilResponse || !qq.supportedFeatures.imagePreviews)) {
    ...
    qq.Templating = function (spec) {
        ...
        // of the templating module or after preview generation has failed.
            ...
            useCachedPreview = function (targetThumbnailId, cachedThumbnailId) {
                ...
                log(qq.format("ID {} is the same file as ID {}.  Will use generated thumbnail from ID {} instead.", targetThumbnailId,
                    cachedThumbnailId, cachedThumbnailId));

                // Generation of the related thumbnail may still be in progress, so, wait until it is done.
                previewGeneration[cachedThumbnailId].then(function () {
                        generatedThumbnails++;
                        previewGeneration[targetThumbnailId].success();
                        log(qq.format("Now using previously generated thumbnail created for ID {} on ID {}.", cachedThumbnailId,
                            targetThumbnailId));
        ...
        qq.extend(this, {
            ...
            parse: function () {
                ...
                getApp1Offset().then(function (app1Offset) {
                    log(qq.format("Moving forward with EXIF header parsing for '{}'",
                        fileOrBlob.name === undefined ? "blob" : fileOrBlob.name));
    ...
    qq.extend(qq.Scaler.prototype, {
        ...
        _generateScaledImage: function (spec, sourceFile) {
            ...
            imageGenerator.generate(sourceFile, canvas,
                {maxSize: maxSize, orient: orient, customResizeFunction: customResizeFunction}).then(function () {
