module app.browse {
    ...
    export class ApplicationBrowseActions implements TreeGridActions<Application> {
        ...
        updateActionsEnabledState(applicationBrowseItems: BrowseItem<Application>[]): wemQ.Promise<BrowseItem<Application>[]> {
            ...
            this.START_APPLICATION.setEnabled(anyStopped && externalSelected);
            this.STOP_APPLICATION.setEnabled(anyStarted && externalSelected);
            this.UNINSTALL_APPLICATION.setEnabled(anySelected && externalSelected);
