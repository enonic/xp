...
CKEDITOR.lang['cs'] = {
    ...
    "font": {
        "fontSize": {"label": "Velikost", "voiceLabel": "Velikost písma", "panelTitle": "Velikost"},
        "label": "Písmo",
        "panelTitle": "Písmo",
        "voiceLabel": "Písmo"
    },
    "forms": {
        ...
        "hidden": {"title": "Vlastnosti skrytého pole", "name": "Název", "value": "Hodnota"},
        "select": {
        ...
        "textarea": {"title": "Vlastnosti textové oblasti", "cols": "Sloupců", "rows": "Řádků"},
        "textfield": {
    ...
    "smiley": {"options": "Nastavení smajlíků", "title": "Vkládání smajlíků", "toolbar": "Smajlíci"},
    "justify": {"block": "Zarovnat do bloku", "center": "Zarovnat na střed", "left": "Zarovnat vlevo", "right": "Zarovnat vpravo"},
    ...
    "specialchar": {"options": "Nastavení speciálních znaků", "title": "Výběr speciálního znaku", "toolbar": "Vložit speciální znaky"},
    "scayt": {
    ...
    "table": {
        ...
        "row": {"menu": "Řádek", "insertBefore": "Vložit řádek před", "insertAfter": "Vložit řádek za", "deleteRow": "Smazat řádky"},
        "rows": "Řádky",
        "summary": "Souhrn",
