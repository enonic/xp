...
CKEDITOR.lang['fr'] = {
    ...
    "bidi": {"ltr": "Direction du texte de la gauche vers la droite", "rtl": "Direction du texte de la droite vers la gauche"},
    ...
    "forms": {
        ...
        "hidden": {"title": "Propriétés du champ invisible", "name": "Nom", "value": "Valeur"},
        "select": {
    ...
    "smiley": {"options": "Options des frimousses", "title": "Insérer une frimousse", "toolbar": "Frimousse"},
    ...
    "pagebreak": {"alt": "Saut de page", "toolbar": "Insérer un saut de page pour l'impression"},
    "pastetext": {
