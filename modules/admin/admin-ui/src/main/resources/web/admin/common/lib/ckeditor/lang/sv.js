...
CKEDITOR.lang['sv'] = {
    ...
    "bidi": {"ltr": "Text riktning från vänster till höger", "rtl": "Text riktning från höger till vänster"},
    ...
    "colordialog": {"clear": "Rensa", "highlight": "Markera", "options": "Färgalternativ", "selected": "Vald färg", "title": "Välj färg"},
    "templates": {
        "button": "Sidmallar",
    ...
    "forms": {
        ...
        "textarea": {"title": "Egenskaper för textruta", "cols": "Kolumner", "rows": "Rader"},
        "textfield": {
    ...
    "smiley": {"options": "Smileyinställningar", "title": "Infoga smiley", "toolbar": "Smiley"},
    "justify": {"block": "Justera till marginaler", "center": "Centrera", "left": "Vänsterjustera", "right": "Högerjustera"},
    ...
    "specialchar": {"options": "Alternativ för utökade tecken", "title": "Välj utökat tecken", "toolbar": "Klistra in utökat tecken"},
    "scayt": {
        "btn_about": "Om SCAYT",
    ...
    "table": {
        ...
        "row": {"menu": "Rad", "insertBefore": "Lägg till rad före", "insertAfter": "Lägg till rad efter", "deleteRow": "Radera rad"},
        "rows": "Rader",
