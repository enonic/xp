...
CKEDITOR.lang['lv'] = {
    ...
    "bidi": {"ltr": "Teksta virziens no kreisās uz labo", "rtl": "Teksta virziens no labās uz kreiso"},
    ...
    "font": {
        "fontSize": {"label": "Izmērs", "voiceLabel": "Fonta izmeŗs", "panelTitle": "Izmērs"},
        "label": "Šrifts",
        "panelTitle": "Šrifts",
        "voiceLabel": "Fonts"
    },
    "forms": {
        ...
        "form": {"title": "Formas īpašības", "menu": "Formas īpašības", "action": "Darbība", "method": "Metode", "encoding": "Kodējums"},
        "hidden": {"title": "Paslēptās teksta rindas īpašības", "name": "Nosaukums", "value": "Vērtība"},
        "select": {
        ...
        "textarea": {"title": "Teksta laukuma īpašības", "cols": "Kolonnas", "rows": "Rindas"},
        "textfield": {
    ...
    "smiley": {"options": "Smaidiņu uzstādījumi", "title": "Ievietot smaidiņu", "toolbar": "Smaidiņi"},
    "justify": {
    ...
    "pagebreak": {"alt": "Lapas pārnesums", "toolbar": "Ievietot lapas pārtraukumu drukai"},
    "pastetext": {
    ...
    "specialchar": {"options": "Speciālo simbolu uzstādījumi", "title": "Ievietot īpašu simbolu", "toolbar": "Ievietot speciālo simbolu"},
    "scayt": {
        "btn_about": "Par SCAYT",
    ...
    "table": {
        ...
        "row": {"menu": "Rinda", "insertBefore": "Ievietot rindu pirms", "insertAfter": "Ievietot rindu pēc", "deleteRow": "Dzēst rindas"},
        "rows": "Rindas",
        "summary": "Anotācija",
