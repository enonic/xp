...
CKEDITOR.lang['el'] = {
    ...
    "font": {
        "fontSize": {"label": "Μέγεθος", "voiceLabel": "Μέγεθος Γραμματοσειράς", "panelTitle": "Μέγεθος Γραμματοσειράς"},
        "label": "Γραμματοσειρά",
    ...
    "justify": {"block": "Πλήρης Στοίχιση", "center": "Στο Κέντρο", "left": "Στοίχιση Αριστερά", "right": "Στοίχιση Δεξιά"},
    ...
    "list": {"bulletedlist": "Εισαγωγή/Απομάκρυνση Λίστας Κουκκίδων", "numberedlist": "Εισαγωγή/Απομάκρυνση Αριθμημένης Λίστας"},
    "liststyle": {
