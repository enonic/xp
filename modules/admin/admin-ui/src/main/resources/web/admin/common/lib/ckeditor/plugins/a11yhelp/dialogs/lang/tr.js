...
CKEDITOR.plugins.setLang("a11yhelp", "tr", {
    ...
    legend: [{
        ...
        name: "Komutlar",
        items: [{name: "Komutu geri al", legend: "$(undo)'ya basın"}, {name: "Komutu geri al", legend: "${redo} basın"},
            {name: " Kalın komut", legend: "${bold} basın"}, {name: " İtalik komutu", legend: "${italic} basın"},
            {name: " Alttan çizgi komutu", legend: "${underline} basın"}, {name: " Bağlantı komutu", legend: "${link} basın"},
            ...
            {name: "Düz Metin Olarak Yapıştır", legend: "${pastetext} basın", legendEdge: "Önce ${pastetext} ardından${paste} basın"}]
    }],
    tab: "Sekme tuşu",
    pause: "Durdurma tuşu",
