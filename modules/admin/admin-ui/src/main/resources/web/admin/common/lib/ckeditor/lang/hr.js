...
CKEDITOR.lang['hr'] = {
    ...
    "bidi": {"ltr": "Smjer teksta s lijeva na desno", "rtl": "Smjer teksta s desna na lijevo"},
    ...
    "font": {
        "fontSize": {"label": "Veličina", "voiceLabel": "Veličina slova", "panelTitle": "Veličina"},
        "label": "Font",
    ...
    "smiley": {"options": "Opcije smješka", "title": "Ubaci smješka", "toolbar": "Smješko"},
    "justify": {"block": "Blok poravnanje", "center": "Središnje poravnanje", "left": "Lijevo poravnanje", "right": "Desno poravnanje"},
    ...
    "specialchar": {"options": "Opcije specijalnih znakova", "title": "Odaberite posebni karakter", "toolbar": "Ubaci posebni znak"},
    "scayt": {
        "btn_about": "O SCAYT",
    ...
    "table": {
        ...
        "row": {"menu": "Red", "insertBefore": "Ubaci red prije", "insertAfter": "Ubaci red poslije", "deleteRow": "Izbriši redove"},
        "rows": "Redova",
        "summary": "Sažetak",
