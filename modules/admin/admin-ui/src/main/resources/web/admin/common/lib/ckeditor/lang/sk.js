...
CKEDITOR.lang['sk'] = {
    ...
    "font": {
        "fontSize": {"label": "Veľkosť", "voiceLabel": "Veľkosť písma", "panelTitle": "Veľkosť písma"},
        "label": "Písmo",
    ...
    "forms": {
        ...
        "hidden": {"title": "Vlastnosti skrytého poľa", "name": "Názov (name)", "value": "Hodnota"},
        "select": {
        ...
        "textarea": {"title": "Vlastnosti textovej oblasti (textarea)", "cols": "Stĺpcov", "rows": "Riadkov"},
        "textfield": {
    ...
    "smiley": {"options": "Možnosti smajlíkov", "title": "Vložiť smajlíka", "toolbar": "Smajlíky"},
    "justify": {"block": "Zarovnať do bloku", "center": "Zarovnať na stred", "left": "Zarovnať vľavo", "right": "Zarovnať vpravo"},
    ...
    "pagebreak": {"alt": "Zalomenie strany", "toolbar": "Vložiť oddeľovač stránky pre tlač"},
    "pastetext": {
    ...
    "specialchar": {"options": "Možnosti špeciálneho znaku", "title": "Výber špeciálneho znaku", "toolbar": "Vložiť špeciálny znak"},
    "scayt": {
    ...
    "table": {
        ...
        "row": {"menu": "Riadok", "insertBefore": "Vložiť riadok pred", "insertAfter": "Vložiť riadok po", "deleteRow": "Vymazať riadky"},
        "rows": "Riadky",
        "summary": "Prehľad",
