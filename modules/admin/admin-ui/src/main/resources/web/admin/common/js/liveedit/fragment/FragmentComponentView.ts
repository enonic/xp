module api.liveedit.fragment {
    ...
    export class FragmentComponentViewBuilder extends ContentBackedComponentViewBuilder<FragmentComponent> {
    ...
    export class FragmentComponentView extends ContentBackedComponentView<FragmentComponent> {
