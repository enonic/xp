...
CKEDITOR.lang['he'] = {
    ...
    "colordialog": {"clear": "ניקוי", "highlight": "סימון", "options": "אפשרויות צבע", "selected": "בחירה", "title": "בחירת צבע"},
    "templates": {
        "button": "תבניות",
    ...
    "justify": {"block": "יישור לשוליים", "center": "מרכוז", "left": "יישור לשמאל", "right": "יישור לימין"},
    ...
    "table": {
        ...
        "cellPad": "ריפוד תא",
        "cellSpace": "מרווח תא",
        "column": {"menu": "עמודה", "insertBefore": "הוספת עמודה לפני", "insertAfter": "הוספת עמודה אחרי", "deleteColumn": "מחיקת עמודות"},
        "columns": "עמודות",
