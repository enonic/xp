...
!function (global) {
    var qq = function (a) {
        ...
        return {
            hide: function () {
                ...
                return null != b.opacity && "string" != typeof a.style.opacity && "undefined" != typeof a.filters &&
                       (b.filter = "alpha(opacity=" + Math.round(100 * b.opacity) + ")"), qq.extend(a.style, b), this
                ...
                var d, e = [];
                return c && a.querySelector ? a.querySelector("." + b) : a.querySelectorAll ? a.querySelectorAll("." + b) : (d =
                    a.getElementsByTagName("*"), qq.each(d, function (a, c) {
                ...
                var c;
                return a.hasAttribute ? a.hasAttribute(b) ? null == /^false$/i.exec(a.getAttribute(b)) : !1 : (c = a[b], void 0 === c
                    ? !1
                    : null == /^false$/i.exec(c))
            }
        }
    ...
    !function () {
        ...
        qq.canvasToBlob = function (a, b, c) {
            ...
            return c = a.split(",")[0].indexOf("base64") >= 0 ? atob(a.split(",")[1]) : decodeURI(a.split(",")[1]), e =
                a.split(",")[0].split(":")[1].split(";")[0], b = new ArrayBuffer(c.length), d = new Uint8Array(b), qq.each(c,
                function (a, b) {
                    d[a] = b.charCodeAt(0)
                }), f(b, e)
        }, qq.log = function (a, b) {
            window.console &&
            (b && "info" !== b ? window.console[b] ? window.console[b](a) : window.console.log("<" + b + "> " + a) : window.console.log(a))
            ...
            return "[object Array]" === Object.prototype.toString.call(a) ||
                   a && window.ArrayBuffer && a.buffer && a.buffer.constructor === ArrayBuffer
            ...
            return window.HTMLInputElement && "[object HTMLInputElement]" === Object.prototype.toString.call(a) && a.type && c(a.type)
                ? !0
                : a.tagName && "input" === a.tagName.toLowerCase() && a.type && c(a.type)
                       ? !0
                       : !1
            ...
            return a.type = "file", void 0 !== a.multiple && "undefined" != typeof File && "undefined" != typeof FormData &&
                                    "undefined" != typeof qq.createXhrInstance().upload
            ...
            return !qq.androidStock() && qq.isXhrUploadSupported() &&
            ...
            return !qq.edge() && !qq.ie11() && -1 !== navigator.userAgent.indexOf("Mozilla") && void 0 !== navigator.vendor &&
                   "" === navigator.vendor
        }, qq.windows = function () {
            ...
            return -1 !== navigator.userAgent.indexOf("iPad") || -1 !== navigator.userAgent.indexOf("iPod") ||
            ...
            if (a) {
                if (window.Storage && a.constructor === window.Storage) {
                    for (c = 0; c < a.length &&
                                (d = b(a.key(c), a.getItem(a.key(c))), d !== !1);
                         c++) {
                        ;
                    }
            ...
            var d = [], e = "&", f = function (a, c) {
                ...
                "undefined" !== e && "undefined" !== c && d.push("object" == typeof a
                    ? qq.obj2url(a, e, !0)
                    : "[object Function]" === Object.prototype.toString.call(a)
                                                                     ? encodeURIComponent(e) + "=" + encodeURIComponent(a())
                                                                     : encodeURIComponent(e) + "=" + encodeURIComponent(a))
            };
            return !c && b
                ? (e = /\?/.test(b) ? /\?$/.test(b) ? "" : "&" : "?", d.push(b), d.push(qq.obj2url(a)))
                : "[object Array]" === Object.prototype.toString.call(a) && "undefined" != typeof a
                       ? qq.each(a, function (a, b) {
                f(b, a)
            })
                       : "undefined" != typeof a && null !== a && "object" == typeof a
                      ? qq.each(a, function (a, b) {
                f(b, a)
            })
                      : d.push(encodeURIComponent(b) + "=" + encodeURIComponent(a)), b ? d.join(e) : d.join(e).replace(/^&/,
                "").replace(/%20/g, "+")
        }, qq.obj2FormData = function (a, b, c) {
            return b || (b = new FormData), qq.each(a, function (a, d) {
                a = c ? c + "[" + a + "]" : a, qq.isObject(d) ? qq.obj2FormData(d, b, a) : qq.isFunction(d) ? b.append(a, d()) : b.append(a,
                    d)
            }), b
            ...
            return qq.isInput(a)
                ? a.value.replace(/.*(\/|\\)/, "")
                : qq.isFile(a) && null !== a.fileName && void 0 !== a.fileName
                       ? a.fileName
                       : a.name
    ...
    }(), qq.version = "5.10.0", qq.supportedFeatures = function () {
        "use strict";
        function a() {
            var a, b = !0;
            try {
        ...
        return j = a(), m = j && qq.isXhrUploadSupported(), k = m && !qq.androidStock(), l = m && i(), n = l && b(), o =
            m && qq.isFileChunkingSupported(), p = m && o && h(), q = m && c(), r = j && (void 0 !== window.postMessage || m), t = d(), s =
            e(), u = f(), v = g(), w = m && void 0 !== window.FileReader, x = function () {
        ...
        "use strict";
        qq.extend(this, {
            referenceBlob: a, create: function () {
                return b(a)
            }
        })
        ...
        function b() {
            var a = document.createElement("input");
            return a.setAttribute(qq.UploadButton.BUTTON_ID_ATTR_NAME, d), a.setAttribute("title", g.title), e.setMultiple(g.multiple,
                a), g.folders && qq.supportedFeatures.folderSelection && a.setAttribute("webkitdirectory", ""), g.acceptFiles &&
                                                                                                                a.setAttribute("accept",
                                                                                                                    g.acceptFiles), a.setAttribute("type",
                "file"), a.setAttribute("name", g.name), qq(a).css({
                position: "absolute",
                right: 0,
                top: 0,
                fontFamily: "Arial",
                ...
                cursor: "pointer",
                opacity: 0
            }), !qq.ie7() && qq(a).css({height: "100%"}), g.element.appendChild(a), f.attach(a, "change", function () {
                g.onChange(a)
        ...
        qq.extend(g, a), d = qq.getUniqueId(), qq(g.element).css({
            ...
            getInput: function () {
                ...
                g.ios8BrowserCrashWorkaround && qq.ios8() && (qq.iosChrome() || qq.iosSafariWebView())
        ...
        qq.extend(this, {
            addFile: function (b) {
                ...
                return b.batchId &&
                       (e[d].batchId = b.batchId, void 0 === i[b.batchId] && (i[b.batchId] = []), i[b.batchId].push(d)), b.proxyGroupId &&
                                                                                                                         (e[d].proxyGroupId =
                                                                                                                             b.proxyGroupId, void 0 ===
                                                                                                                                             h[b.proxyGroupId] &&
                                                                                                                         (h[b.proxyGroupId] =
                                                                                                                             []), h[b.proxyGroupId].push(d)), e[d].id =
                    d, f[b.uuid] = d, void 0 === g[c] && (g[c] = []), g[c].push(d), a.onStatusChange(d, null, c), d
            }, retrieve: function (a) {
                return qq.isObject(a) && e.length
                    ? void 0 !== a.id
                           ? b(a.id)
                           : void 0 !== a.uuid
                          ? c(a.uuid)
        ...
        qq.basePublicApi = {
            addBlobs: function (a, b, c) {
                ...
                this._currentBatchId = d, a && (j(), qq.each(a, function (a, b) {
                    qq.isFileOrInput(b)
                        ...
                        : qq.isObject(b)
                              ...
                              ? f(b)
                              : b.canvas && b.name && h(b)
                              : b.tagName && "canvas" === b.tagName.toLowerCase()
                              ? g(b)
                              : k.log(b + " is not a valid file container!  Ignoring!", "warn")
                ...
                return qq.supportedFeatures.pause && this._options.chunking.enabled
                    ? b.status === qq.status.PAUSED
                           ? (this.log(qq.format("Paused file ID {} ({}) will be continued.  Not paused.", a,
                    this.getName(a))), this._uploadFile(a), !0)
                           : (this.log(qq.format("Ignoring continue for file ID {} ({}).  Not paused.", a, this.getName(a)), "error"), !1)
                    : !1
                ...
                {customResizeFunction: e, maxSize: c > 0 ? c : null, scale: c > 0}, !d && qq.supportedFeatures.imagePreviews &&
                                                                                    (f = this.getFile(a)), null == f ? h.failure({
                    container: b,
                    error: "File or URL not found."
                }) : this._imageGenerator.generate(f, b, g).then(function (a) {
                    h.success(a)
                }, function (a, b) {
                    h.failure({container: a, error: b || "Problem generating thumbnail"})
                })) : h.failure({container: b, error: "Missing image generator module"}), h
                ...
                !this._options.debug || b && "info" !== b
                    ? b && "info" !== b && qq.log("[Fine Uploader " + qq.version + "] " + a, b)
                    : qq.log("[Fine Uploader " + qq.version + "] " + a)
                ...
                this.log("Resetting uploader..."), this._handler.reset(), this._storedIds = [], this._autoRetries =
                    [], this._retryTimeouts = [], this._preventRetries = [], this._thumbnailUrls = [], qq.each(this._buttons,
                    function (a, b) {
                        b.reset()
                    }), this._paramsStore.reset(), this._endpointStore.reset(), this._netUploadedOrQueued = 0, this._netUploaded =
                    0, this._uploadData.reset(), this._buttonIdsForFileIds = [], this._pasteHandler &&
                                                                                 this._pasteHandler.reset(), this._options.session.refreshOnReset &&
                ...
                return qq.Scaler.prototype.scaleImage(a, b,
                    {log: qq.bind(c.log, c), getFile: qq.bind(c.getFile, c), uploadData: c._uploadData})
            ...
            _addCannedFile: function (a) {
                ...
                return a.deleteFileEndpoint && this.setDeleteFileEndpoint(a.deleteFileEndpoint, b), a.deleteFileParams &&
                                                                                                    this.setDeleteFileParams(a.deleteFileParams,
                                                                                                        b), a.thumbnailUrl &&
                                                                                                            (this._thumbnailUrls[b] =
                                                                                                                a.thumbnailUrl), this._netUploaded++, this._netUploadedOrQueued++, b
                ...
                return new qq.PasteSupport({
                    ...
                    callbacks: {
                        log: qq.bind(a.log, a), pasteReceived: function (b) {
                ...
                return {
                    set: function (a, b) {
                        ...
                        qq.isObject(c) &&
                        (null === a ? qq.isFunction(b) ? f = b : (f = f || {}, qq.extend(f, b)) : (e[a] = e[a] || {}, qq.extend(e[a], b)))
                    }, remove: function (a) {
                        return delete c[a]
                    }, reset: function () {
                        c = {}, e = {}, d = a
                ...
                return new qq.UploadData({
                    getName: function (b) {
                        ...
                        a._onUploadStatusChange(b, c, d), a._options.callbacks.onStatusChange(b, c, d), a._maybeAllComplete(b,
                            d), a._totalProgress && setTimeout(function () {
                ...
                function b() {
                    return qq.supportedFeatures.ajaxUploading
                        ? d._options.workarounds.iosEmptyVideos && qq.ios() && !qq.ios6() && d._isAllowedExtension(f, ".mov")
                               ? !1
                               : void 0 === a.multiple
                              ? d._options.multiple
                              : a.multiple
                ...
                var c, d = this, e = a.accept || this._options.validation.acceptFiles, f = a.allowedExtensions ||
                                                                                           this._options.validation.allowedExtensions;
                ...
                var c = this, d = {}, e = {
                    ...
                    onProgress: function (a, b, e, f) {
                        0 > e || 0 > f || (d[a]
                            ? (d[a].loaded !== e || d[a].total !== f) &&
                              (c._onProgress(a, b, e, f), c._options.callbacks.onProgress(a, b, e, f))
                            : (c._onProgress(a, b, e, f), c._options.callbacks.onProgress(a, b, e, f)), d[a] = {loaded: e, total: f})
                    },
                    onComplete: function (a, b, e, f) {
                        delete d[a];
                        var g, h = c.getUploads({id: a}).status;
                        h !== qq.status.UPLOAD_SUCCESSFUL && h !== qq.status.UPLOAD_FAILED &&
                        (g = c._onComplete(a, b, e, f), g instanceof qq.Promise ? g.done(function () {
                    ...
                    isQueued: function (a) {
                        ...
                        return b === qq.status.QUEUED || b === qq.status.SUBMITTED || b === qq.status.UPLOAD_RETRYING ||
                               b === qq.status.PAUSED
                    },
                ...
                this._extraButtonSpecs = {}, qq.each(this._options.extraButtons, function (b, c) {
                    ...
                    void 0 === d && (d = a._options.multiple), f.validation && qq.extend(e, c.validation, !0), qq.extend(f,
                        {multiple: d, validation: e}, !0), a._initExtraButton(f)
                })
                ...
                if (d instanceof qq.BlobProxy && (d = d.referenceBlob), d && !qq.isBlob(d)) {
                    ...
                    if ("input" === d.tagName.toLowerCase() &&
                        "file" === d.type.toLowerCase()) {
                ...
                return this._uploadData.retrieve({
                    status: [qq.status.UPLOADING, qq.status.UPLOAD_RETRYING, qq.status.QUEUED, qq.status.SUBMITTING, qq.status.SUBMITTED,
                        qq.status.PAUSED]
                }).length
                ...
                return a.file instanceof qq.BlobProxy
                    ...
                    : {
                    name: this.getUploads({id: a.id}).name,
                    size: this.getUploads({id: a.id}).size
                }
                ...
                if (this._options.camera.ios && qq.ios()) {
                    var a = "image/*;capture=camera", b = this._options.camera.button, c = b
                        ? this._getButtonId(b)
                        : this._defaultButtonId, d = this._options;
                    c && c !== this._defaultButtonId && (d = this._extraButtonSpecs[c]), d.multiple = !1, null === d.validation.acceptFiles
                        ? d.validation.acceptFiles = a
                        : d.validation.acceptFiles += "," + a, qq.each(this._buttons, function (a, b) {
                ...
                return qq.isGenericPromise(c) ? (this.log(a.name + " - waiting for " + a.name + " promise to be fulfilled for " +
                                                          a.identifier), c.then(function (c) {
                    b.log(a.name + " promise success for " + a.identifier), a.onSuccess(c)
                }, function () {
                    a.onFailure ? (b.log(a.name + " promise failure for " + a.identifier), a.onFailure()) : b.log(a.name +
                                                                                                                  " promise failure for " +
                                                                                                                  a.identifier)
                })) : (c !== !1
                    ? a.onSuccess(c)
                    : a.onFailure
                           ? (this.log(a.name + " - return value was 'false' for " + a.identifier +
                                       ".  Invoking failure callback."), a.onFailure())
                           : this.log(a.name + " - return value was 'false' for " + a.identifier + ".  Will not proceed."), c)
            }, _handleNewFile: function (a, b, c) {
                var d = this, e = qq.getUniqueId(), f = -1, g = qq.getFilename(a), h = a.blob || a, i = this._customNewFileHandler
                    ? this._customNewFileHandler
                    : qq.bind(d._handleNewFileGeneric, d);
                !qq.isInput(h) && h.size >= 0 && (f = h.size), i(h, g, e, f, c, b, this._options.request.uuidName, {
                    uploadData: d._uploadData, paramsStore: d._paramsStore, addFileToHandler: function (a, b) {
                ...
                null == d && (d = this._options.paste.defaultName), d += "." + c, this.addFiles({name: d, blob: a})
                ...
                this._formSupport = qq.FormSupport && new qq.FormSupport(this._options.form, qq.bind(this.uploadStoredFiles, this),
                        qq.bind(this.log, this)), this._formSupport && this._formSupport.attachedToForm ? (this._paramsStore =
                    this._createStore(this._options.request.params, this._formSupport.getFormInputsAsObject), this._options.autoUpload =
                    this._formSupport.newAutoUpload, this._formSupport.newEndpoint &&
                                                     (this._options.request.endpoint = this._formSupport.newEndpoint)) : this._paramsStore =
                                                      this._createStore(this._options.request.params)
            }, _isDeletePossible: function () {
                return qq.DeleteFileAjaxRequester && this._options.deleteFile.enabled
                    ? this._options.cors.expected
                           ? qq.supportedFeatures.deleteFileCorsXhr
                          ? !0
                          : qq.supportedFeatures.deleteFileCorsXdr && this._options.cors.allowXdr
                                 ? !0
                                 : !1
                           : !0
                    : !1
                ...
                }), e = h.join(", ").toLowerCase(), d("{file}", this._options.formatFileName(j)), d("{extensions}", e), d("{sizeLimit}",
                    this._formatSize(l.sizeLimit)), d("{minSizeLimit}", this._formatSize(l.minSizeLimit)), f =
                    g.match(/(\{\w+\})/g), null !== f && qq.each(f, function (a, b) {
                    d(b, i[a])
                }), this._options.callbacks.onError(null, j, g, void 0), g
            }, _manualRetry: function (a, b) {
                return this._onBeforeManualRetry(a) ? (this._netUploadedOrQueued++, this._uploadData.setStatus(a,
                    qq.status.UPLOAD_RETRYING), b ? b(a) : this._handler.retry(a), !0) : void 0
            }, _maybeAllComplete: function (a, b) {
                var c = this, d = this._getNotFinished();
                b === qq.status.UPLOAD_SUCCESSFUL ? this._succeededSinceLastAllComplete.push(a) : b === qq.status.UPLOAD_FAILED &&
                                                                                                  this._failedSinceLastAllComplete.push(a), 0 ===
                                                                                                                                            d &&
                                                                                                                                            (this._succeededSinceLastAllComplete.length ||
                                                                                                                                             this._failedSinceLastAllComplete.length) &&
                                                                                                                                            setTimeout(function () {
                                                                                                                                                c._onAllComplete(c._succeededSinceLastAllComplete,
                ...
                if (!c.success) {
                    if (d && 200 !== d.status && !c.error) {
                        this._options.callbacks.onError(a, b,
                            "XHR returned response code " + d.status, d);
                    } else {
                ...
                this._totalProgress &&
                this._totalProgress.onAllComplete(a, b, this._preventRetries), this._options.callbacks.onAllComplete(qq.extend([], a),
                    qq.extend([], b)), this._succeededSinceLastAllComplete = [], this._failedSinceLastAllComplete = []
            }, _onAutoRetry: function (a, b, c, d, e) {
                var f = this;
                return f._preventRetries[a] = c[f._options.retry.preventRetryResponseProperty], f._shouldAutoRetry(a, b, c)
                    ? (f._maybeParseAndSendUploadError.apply(f, arguments), f._options.callbacks.onAutoRetry(a, b,
                    f._autoRetries[a]), f._onBeforeAutoRetry(a, b), f._retryTimeouts[a] = setTimeout(function () {
                    f.log("Retrying " + b + "..."), f._uploadData.setStatus(a, qq.status.UPLOAD_RETRYING), e ? e(a) : f._handler.retry(a)
                }, 1e3 * f._options.retry.autoAttemptDelay), !0)
                    : void 0
                ...
                return this._preventRetries[a]
                    ? (this.log("Retries are forbidden for id " + a, "warn"), !1)
                    : this._handler.isValid(a)
                           ? (b = this.getName(a), this._options.callbacks.onManualRetry(a, b) === !1
                    ? !1
                    : c > 0 && this._netUploadedOrQueued + 1 > c
                                                       ? (this._itemError("retryFailTooManyItems"), !1)
                                                       : (this.log("Retrying upload for '" + b + "' (id: " + a + ")..."), !0))
                           : (this.log("'" + a + "' is not a valid file ID", "error"), !1)
                ...
                return c.success ? (c.thumbnailUrl &&
                                    (this._thumbnailUrls[a] = c.thumbnailUrl), this._netUploaded++, this._uploadData.setStatus(a,
                    qq.status.UPLOAD_SUCCESSFUL)) : (this._netUploadedOrQueued--, this._uploadData.setStatus(a,
                    qq.status.UPLOAD_FAILED), c[this._options.retry.preventRetryResponseProperty] === !0 &&
                                              (this._preventRetries[a] = !0)), this._maybeParseAndSendUploadError(a, b, c, d), c.success
                    ? !0
                    : !1
                ...
                c
                    ? (this._uploadData.setStatus(a, qq.status.DELETE_FAILED), this.log("Delete request for '" + d + "' has failed.",
                    "error"), void 0 === b.withCredentials
                    ? this._options.callbacks.onError(a, d, "Delete request failed", b)
                    : this._options.callbacks.onError(a, d, "Delete request failed with response code " + b.status, b))
                    : (this._netUploadedOrQueued--, this._netUploaded--, this._handler.expunge(a), this._uploadData.setStatus(a,
                    qq.status.DELETED), this.log("Delete request for '" + d + "' has succeeded."))
                ...
                this._onSubmit.apply(this, arguments), this._uploadData.setStatus(a, qq.status.SUBMITTED), this._onSubmitted.apply(this,
                    arguments), this._options.autoUpload
                    ? (this._options.callbacks.onSubmitted.apply(this, arguments), this._uploadFile(a))
                    : (this._storeForLater(a), this._options.callbacks.onSubmitted.apply(this, arguments))
            }, _onSubmitDelete: function (a, b, c) {
                var d, e = this.getUuid(a);
                return b && (d = qq.bind(b, this, a, e, c)), this._isDeletePossible()
                    ...
                    : (this.log("Delete request ignored for ID " + a + ", delete feature is disabled or request not possible " +
                                "due to CORS on a user agent that does not support pre-flighting.", "warn"), !1)
                ...
                }) : this._itemError("noFilesError") : (this._onValidateBatchCallbackFailure(b), f =
                    this._options.messages.tooManyItemsError.replace(/\{netItems\}/g, h).replace(/\{itemLimit\}/g, g), this._batchError(f))
                ...
                this._disposeSupport.attach(window, "beforeunload", function (b) {
                    return a.getInProgress() ? (b = b || window.event, b.returnValue =
                        a._options.messages.onLeave, a._options.messages.onLeave) : void 0
                })
            }, _refreshSessionData: function () {
                var a = this, b = this._options.session;
                qq.Session && null != this._options.session.endpoint && (this._session || (qq.extend(b, this._options.cors), b.log =
                    qq.bind(this.log, this), b.addFileRecord = qq.bind(this._addCannedFile, this), this._session =
                    new qq.Session(b)), setTimeout(function () {
                ...
                var b = this._uploadData.retrieve({id: a});
                return !this._preventRetries[a] && this._options.retry.enableAuto && b.status !== qq.status.PAUSED &&
                       (void 0 === this._autoRetries[a] && (this._autoRetries[a] = 0), this._autoRetries[a] <
                                                                                       this._options.retry.maxAutoAttempts)
                    ? (this._autoRetries[a] += 1, !0)
                    : !1
            }, _storeForLater: function (a) {
                this._storedIds.push(a)
            }, _trackButton: function (a) {
                var b;
                b = qq.supportedFeatures.ajaxUploading
                    ? this._handler.getFile(a).qqButtonId
                    : this._getButtonId(this._handler.getInput(a)), b && (this._buttonIdsForFileIds[a] = b)
            }, _updateFormSupportAndParams: function (a) {
                this._options.form.element = a, this._formSupport = qq.FormSupport && new qq.FormSupport(this._options.form,
                        qq.bind(this.uploadStoredFiles, this), qq.bind(this.log, this)), this._formSupport &&
                                                                                         this._formSupport.attachedToForm &&
                                                                                         (this._paramsStore.addReadOnly(null,
                                                                                             this._formSupport.getFormInputsAsObject), this._options.autoUpload =
                                                                                             this._formSupport.newAutoUpload, this._formSupport.newEndpoint &&
                ...
                for (var a, b, c = this; this._storedIds.length;) {
                    a = this._storedIds.shift(), this._uploadFile(a);
                }
                b = this.getUploads({status: qq.status.SUBMITTING}).length, b && (qq.log("Still waiting for " + b +
                                                                                         " files to clear submit queue. Will re-parse stored IDs array shortly."), setTimeout(function () {
                ...
                }), qq.isFileOrInput(d) && !this._isAllowedExtension(h.allowedExtensions, e)
                    ? (this._itemError("typeError", e, d), i.failure())
                    : 0 === f
                        ? (this._itemError("emptyError", e, d), i.failure())
                        : f > 0 && h.sizeLimit && f > h.sizeLimit
                          ? (this._itemError("sizeError", e, d), i.failure())
                          : f > 0 && f < h.minSizeLimit
                              ? (this._itemError("minSizeError", e, d), i.failure())
                              : (qq.ImageValidation && qq.supportedFeatures.imagePreviews && qq.isFile(d) ? new qq.ImageValidation(d,
                    qq.bind(c.log, c)).validate(h.image).then(i.success, function (a) {
        ...
        qq.FineUploaderBasic = function (a) {
            ...
            this._options = {
                ...
                validation: {
                    ...
                    acceptFiles: null,
                    image: {maxHeight: 0, maxWidth: 0, minHeight: 0, minWidth: 0}
                },
                callbacks: {
                    onSubmit: function () {
                ...
                resume: {enabled: !1, recordsExpireIn: 7, paramNames: {resuming: "qqresume"}},
                ...
                deleteFile: {enabled: !1, method: "DELETE", endpoint: "/server/upload", customHeaders: {}, params: {}},
                cors: {expected: !1, sendCredentials: !1, allowXdr: !1},
                blobs: {defaultName: "misc_data"},
                paste: {targetElement: null, defaultName: "pasted_image"},
                camera: {ios: !1, button: null},
                extraButtons: [],
                session: {endpoint: null, params: {}, customHeaders: {}, refreshOnReset: !0},
                form: {element: "qq-form", autoUpload: !1, interceptSubmit: !0},
                scaling: {
                    customResizer: null,
                    sendOriginal: !0,
                    orient: !0,
                ...
                workarounds: {iosEmptyVideos: !0, ios8SafariUploads: !0, ios8BrowserCrash: !1}
            }, qq.extend(this._options, a, !0), this._buttons = [], this._extraButtonSpecs = {}, this._buttonIdsForFileIds =
                [], this._wrapCallbacks(), this._disposeSupport = new qq.DisposeSupport, this._storedIds = [], this._autoRetries =
                [], this._retryTimeouts = [], this._preventRetries = [], this._thumbnailUrls = [], this._netUploadedOrQueued =
                0, this._netUploaded = 0, this._uploadData =
                this._createUploadDataTracker(), this._initFormSupportAndParams(), this._customHeadersStore =
                this._createStore(this._options.request.customHeaders), this._deleteFileCustomHeadersStore =
                this._createStore(this._options.deleteFile.customHeaders), this._deleteFileParamsStore =
                this._createStore(this._options.deleteFile.params), this._endpointStore =
                this._createStore(this._options.request.endpoint), this._deleteFileEndpointStore =
                this._createStore(this._options.deleteFile.endpoint), this._handler = this._createUploadHandler(), this._deleteHandler =
                qq.DeleteFileAjaxRequester && this._createDeleteHandler(), this._options.button && (this._defaultButtonId =
                this._createUploadButton({
                    element: this._options.button,
                    title: this._options.text.fileInputTitle
                }).getButtonId()), this._generateExtraButtonSpecs(), this._handleCameraAccess(), this._options.paste.targetElement &&
                                                                                                 (qq.PasteSupport
                                                                                                     ? this._pasteHandler =
                                                                                                      this._createPasteHandler()
                                                                                                     : this.log("Paste support module not found",
                                                                                                     "error")), this._preventLeaveInProgress(), this._imageGenerator =
                qq.ImageGenerator &&
                new qq.ImageGenerator(qq.bind(this.log, this)), this._refreshSessionData(), this._succeededSinceLastAllComplete =
                [], this._failedSinceLastAllComplete = [], this._scaler =
                qq.Scaler && new qq.Scaler(this._options.scaling, qq.bind(this.log, this)) || {}, this._scaler.enabled &&
                                                                                                  (this._customNewFileHandler =
                                                                                                      qq.bind(this._scaler.handleNewFile,
                                                                                                          this._scaler)), qq.TotalProgress &&
                                                                                                                          qq.supportedFeatures.progressBar &&
                                                                                                                          (this._totalProgress =
                                                                                                                              new qq.TotalProgress(qq.bind(this._onTotalProgress,
                                                                                                                                  this),
                                                                                                                                  function (a) {
        ...
        function e() {
            ...
            return (window.XMLHttpRequest || window.ActiveXObject) &&
                   (a = qq.createXhrInstance(), void 0 === a.withCredentials && (a = new XDomainRequest, a.onload = function () {
                   }, a.onerror = function () {
        ...
        function h(a, b) {
            ...
            g(a), h ? s(e + " request for " + a + " has failed", "error") : d(c) || q(c.status) || (h = !0, s(e + " request for " + a +
                                                                                                              " has failed - response code " +
                                                                                                              c.status,
                "error")), w.onComplete(a, c, h)
        }
        ...
        function j(a, b) {
            ...
            return w.onSend(a), c = k(a, h, v[a].additionalQueryParams), d(e) ? (e.onload = n(a), e.onerror = o(a)) : e.onreadystatechange =
                l(a), m(a), e.open(g, c, !0), w.cors.expected && w.cors.sendCredentials && !d(e) &&
                                              (e.withCredentials = !0), p(a), s("Sending " + g + " request for " + a), j
                ? e.send(j)
                : t || !h
                                                                                                                           ? e.send()
                                                                                                                           : h &&
                                                                                                                             w.contentType &&
                                                                                                                             w.contentType.toLowerCase().indexOf("application/x-www-form-urlencoded") >=
                                                                                                                             0
                      ? e.send(qq.obj2url(h, ""))
                      : h && w.contentType && w.contentType.toLowerCase().indexOf("application/json") >= 0
                                                                                                                                 ? e.send(JSON.stringify(h))
                                                                                                                                 : e.send(h), e
        }

        function k(a, b, c) {
            var d = w.endpointStore.get(a), e = v[a].addToPath;
            return void 0 != e && (d += "/" + e), t && b && (d = qq.obj2url(b, d)), c && (d = qq.obj2url(c, d)), d
        }
        ...
        function p(a) {
            ...
            d(e) || (w.acceptHeader && e.setRequestHeader("Accept", w.acceptHeader), w.allowXRequestedWithAndCacheControl &&
                                                                                     (w.cors.expected && b() && !c(g) ||
                                                                                      (e.setRequestHeader("X-Requested-With",
                                                                                          "XMLHttpRequest"), e.setRequestHeader("Cache-Control",
                                                                                          "no-cache"))), !w.contentType ||
            "POST" !== i && "PUT" !== i || e.setRequestHeader("Content-Type", w.contentType), qq.extend(j,
                qq.isFunction(g) ? g(a) : g), qq.extend(j, h), qq.each(j, function (a, b) {
        ...
        function r(a, b, c, d, e, f, g) {
            v[a] = {addToPath: c, additionalParams: d, additionalQueryParams: e, additionalHeaders: f, payload: g};
            var h = u.push(a);
            return h <= w.maxConnections ? j(a, b) : void 0
        }
        ...
        if (qq.extend(w, a), s = w.log, qq.indexOf(w.validMethods, w.method) < 0) {
            throw new Error("'" + w.method +
                            "' is not a supported method for this type of request!");
        }
            ...
            initTransport: function (a) {
                ...
                return {
                    withPath: function (a) {
                        ...
                        return f && qq.indexOf(["GET", "DELETE"], w.method) >= 0 && (c.qqtimestamp = (new Date).getTime()), r(a, h, b, c, g,
                            d, e)
                    }
                }
            }, canceled: function (a) {
        ...
        var c, d, e, f = this, g = !1, h = !1, i = {
            paramsStore: {},
            maxConnections: 3,
            chunking: {enabled: !1, multiple: {enabled: !1}},
            log: function () {
            },
            onProgress: function () {
            },
            ...
            getIdsInBatch: function () {
                ...
                e._getFileState(a).attemptingResume = !1, delete e._getFileState(a).temp.chunkProgress[b], e._getFileState(a).loaded +=
                    f.size, i.onUploadChunkSuccess(a, e._getChunkDataForCallback(f), c, d)
            }, finalize: function (a) {
                ...
                d("All chunks have been uploaded for " + a + " - finalizing...."), e.finalizeChunks(a).then(function (f, g) {
                    ...
                    d("Problem finalizing chunks for file ID " + a + " - " + f.error, "error"), f.reset && j.reset(a), i.onAutoRetry(a, c,
                        f, e) || m.cleanup(a, f, e)
                })
                ...
                d("Server or callback has ordered chunking effort to be restarted on next attempt for item ID " + a,
                    "error"), e._maybeDeletePersistedChunkData(a), e.reevaluateChunking(a), e._getFileState(a).loaded = 0
            }, sendNext: function (a) {
                var b = i.getSize(a), c = i.getName(a), f = j.nextPart(a), g = e._getChunkData(a,
                    f), l = e._getFileState(a).attemptingResume, n = e._getFileState(a).chunking.inProgress || [];
                null == e._getFileState(a).loaded && (e._getFileState(a).loaded = 0), l && i.onResume(a, c, g) === !1 &&
                                                                                      (j.reset(a), f = j.nextPart(a), g =
                                                                                          e._getChunkData(a, f), l = !1), null == f &&
                                                                                                                          0 === n.length
                    ? j.finalize(a)
                    : (d(qq.format("Sending chunked upload request for item {}.{}, bytes {}-{} of {}.", a, f, g.start + 1, g.end,
                    b)), i.onUploadChunk(a, c, e._getChunkDataForCallback(g)), n.push(f), e._getFileState(a).chunking.inProgress = n, h &&
                                                                                                                                      k.open(a,
                                                                                                                                          f), h &&
                                                                                                                                              k.available() &&
                                                                                                                                              e._getFileState(a).chunking.remaining.length &&
                                                                                                                                              j.sendNext(a), e.uploadChunk(a,
                    f, l).then(function (b, c) {
                    ...
                    d(qq.format("Chunk {} for file {} uploaded successfully.", f, a)), j.done(a, f, h, c), i >= 0 && g.splice(i,
                        1), e._maybePersistChunkedState(a), j.hasMoreParts(a) || 0 !== g.length
                        ? j.hasMoreParts(a)
                                                                ? j.sendNext(a)
                                                                : d(qq.format("File ID {} has no more chunks to send and these chunk indexes are still marked as in-progress: {}",
                        a, JSON.stringify(g)))
                        : j.finalize(a)
                }, function (b, g) {
                    d("Chunked upload request failed for " + a + ", chunk " + f), e.clearCachedChunk(a, f);
                    var l, n = m.normalizeResponse(b, !1);
                    n.reset ? j.reset(a) : (l = qq.indexOf(e._getFileState(a).chunking.inProgress, f), l >= 0 &&
                                                                                                       (e._getFileState(a).chunking.inProgress.splice(l,
                                                                                                           1), e._getFileState(a).chunking.remaining.unshift(f))), e._getFileState(a).temp.ignoreFailure ||
                                                                                                                                                                   (h &&
                                                                                                                                                                    (e._getFileState(a).temp.ignoreFailure =
                                                                                                                                                                        !0, d(qq.format("Going to attempt to abort these chunks: {}. These are currently in-progress: {}.",
                                                                                                                                                                        JSON.stringify(Object.keys(e._getXhrs(a))),
                                                                                                                                                                        JSON.stringify(e._getFileState(a).chunking.inProgress))), qq.each(e._getXhrs(a),
                                                                                                                                                                        function (b,
                                                                                                                                                                                  c) {
                                                                                                                                                                            d(qq.format("Attempting to abort file {}.{}. XHR readyState {}. ",
                                                                                                                                                                                a,
                                                                                                                                                                                b,
                                                                                                                                                                                c.readyState)), c.abort(), c._cancelled =
                                                                                                                                                                                !0
                                                                                                                                                                        }), e.moveInProgressToRemaining(a), k.free(a,
                                                                                                                                                                        !0)), i.onAutoRetry(a,
                                                                                                                                                                       c,
                                                                                                                                                                       n,
                                                                                                                                                                       g) ||
            ...
            _open: [], _openChunks: {}, _waiting: [], available: function () {
                ...
                delete k._openChunks[a], m.getProxyOrBlob(a)instanceof qq.BlobProxy && (d("Generated blob upload has ended for " + a +
                                                                                          ", disposing generated blob."), delete e._getFileState(a).file), g >=
                                                                                                                                                           0
                    ? k._waiting.splice(g, 1)
                    : f && h >= 0 && (k._open.splice(h, 1), c = k._waiting.shift(), c >= 0 && (k._open.push(c), m.start(c)))
            ...
            cancel: function (a) {
                ...
                return b && !e.getFile(a) && b instanceof qq.BlobProxy
                    ? (i.onUploadPrep(a), d("Attempting to generate a blob on-demand for " + a), b.create().then(function (b) {
                    d("Generated an on-demand blob for " + a), e.updateBlob(a, b), i.setSize(a,
                        b.size), e.reevaluateChunking(a), m.maybeSendDeferredFiles(a)
                }, function (b) {
                    var e = {};
                    b && (e.error = b), d(qq.format("Failed to generate blob for ID {}.  Error message: {}.", a, b),
                        "error"), i.onComplete(a, i.getName(a), qq.extend(e, c), null), m.maybeSendDeferredFiles(a), k.free(a)
                }), !1)
                    : m.maybeSendDeferredFiles(a)
        ...
        }), qq.extend(i, a), d = i.log, g = i.chunking.enabled && qq.supportedFeatures.chunking, h = g && i.chunking.concurrent.enabled, c =
            function () {
                var a = {};
        ...
        function e(a, b) {
            ...
            j[f] = b, k[e] = qq(a).attach("load", function () {
                g.getInput(e) &&
                (p("Received iframe load event for CORS upload request (iframe name " + d + ")"), l[d] = setTimeout(function () {
                ...
                f && j[f] ? (p("Handling response for iframe name " + d), clearTimeout(l[d]), delete l[d], g._detachLoadEvent(d), b =
                    j[f], delete j[f], q.stopReceivingMessages(d), b(e)) : f || p("'" + a + "' does not contain a UUID - ignoring.")
            })
        }
        ...
        qq.extend(this, new qq.UploadHandler(a)), qq.override(this, function (a) {
            ...
            getInput: function (a) {
                ...
                var b = a.method, c = a.endpoint, d = a.params, e = a.paramsInBody, f = a.targetName, g = qq.toElement("<form method='" +
                                                                                                                       b +
                                                                                                                       "' enctype='multipart/form-data'></form>"), h = c;
                return e ? qq.obj2Inputs(d, g) : h = qq.obj2url(d, c), g.setAttribute("action", h), g.setAttribute("target",
                    f), g.style.display = "none", document.body.appendChild(g), g
        ...
        var c = this, d = a.options.namespace, e = a.proxy, f = a.options.chunking, g = a.options.resume, h = f &&
                                                                                                              a.options.chunking.enabled &&
                                                                                                              qq.supportedFeatures.chunking, i = g &&
                                                                                                                                                 a.options.resume.enabled &&
                                                                                                                                                 h &&
                                                                                                                                                 qq.supportedFeatures.resume, j = e.getName, k = e.getSize, l = e.getUuid, m = e.getEndpoint, n = e.getDataByUuid, o = e.onUuidChanged, p = e.onProgress, q = e.log;
        qq.extend(this, new qq.UploadHandler(a)), qq.override(this, function (a) {
            return {
                add: function (b, d) {
            ...
            clearCachedChunk: function (a, b) {
                ...
                e && (q(qq.format("Moving these chunks from in-progress {}, to remaining.", JSON.stringify(e))), e.reverse(), qq.each(e,
                    function (a, b) {
                        f.unshift(b)
                    }), e.length = 0)
            }, pause: function (a) {
                return c.isValid(a) ? (q(qq.format("Aborting XHR upload for {} '{}' due to pause instruction.", a,
                    j(a))), c._getFileState(a).paused = !0, b(a), !0) : void 0
                ...
                if (f && c.isValid(a)) {
                    ...
                    if (delete e.chunking, e.chunking = {}, b = c._getTotalChunks(a), b > 1 || f.mandatory) {
                        for (e.chunking.enabled = !0, e.chunking.parts = b, e.chunking.remaining = [], d = 0; b > d;
                             d++) {
                            e.chunking.remaining.push(d);
                        }
                        c._initTempState(a)
                    } else {
                        e.chunking.enabled = !1
                    }
                }
                ...
                var d = f.partSize, e = k(a), g = c.getFile(a), h = d * b, i = h + d >= e ? e : h +
                                                                                                d, j = c._getTotalChunks(a), l = this._getFileState(a).temp.cachedChunks, m = l[b] ||
                                                                                                                                                                              qq.sliceBlob(g,
                                                                                                                                                                                  h,
                                                                                                                                                                                  i);
                ...
                var b;
                return i && c.isResumable(a) && (b = c._getLocalStorageId(a), b && localStorage.getItem(b))
                    ? (localStorage.removeItem(b), !0)
                    : !1
            }, _maybePrepareForResume: function (a) {
                var b, d, e = c._getFileState(a);
                i && void 0 === e.key && (b = c._getLocalStorageId(a), d = localStorage.getItem(b), d && (d = JSON.parse(d), n(d.uuid)
                    ? c._markNotResumable(a)
                    : (q(qq.format("Identified file with ID {} and name of {} as resumable.", a, j(a))), o(a, d.uuid), e.key =
                    d.key, e.chunking = d.chunking, e.loaded = d.loaded, e.attemptingResume = !0, c.moveInProgressToRemaining(a))))
            }, _maybePersistChunkedState: function (a) {
                var b, d, e = c._getFileState(a);
                if (i && c.isResumable(a)) {
                    b = c._getLocalStorageId(a), d =
                    {name: j(a), size: k(a), uuid: l(a), key: e.key, chunking: e.chunking, loaded: e.loaded, lastUpdated: Date.now()};
                    try {
                ...
                var e = c._getXhr(a, b), f = j(a), g = {
                    simple: function (b, c) {
                        ...
                        var h = c._getFileState(a).temp.chunkProgress, i = c._getFileState(a).loaded, j = e, l = g, m = k(a), n = j - (l -
                                                                                                                                  d), o = i;
                ...
                c._iterateResumeRecords(function (b, c) {
                    ...
                    d.setDate(d.getDate() + a), d.getTime() <= Date.now() &&
                                                (q("Removing expired resume record with key " + b), localStorage.removeItem(b))
                })
        ...
        qq.extend(b, a), qq.extend(this, {
            receiveMessage: function (a, b) {
                ...
                window.postMessage ? c[a] = qq(window).attach("message", d) : log("iframe message passing not supported in this browser!",
                    "error")
        ...
        qq.uiPublicApi = {
            addInitialFiles: function () {
                ...
                return this._templating.isHiddenForever(a) ? void 0 : this._templating.getFileContainer(a)
            }, reset: function () {
                this._parent.prototype.reset.apply(this, arguments), this._templating.reset(), !this._options.button &&
                                                                                               this._templating.getButton() &&
                                                                                               (this._defaultButtonId =
                                                                                                   this._createUploadButton({
                                                                                                       element: this._templating.getButton(),
                                                                                                       title: this._options.text.fileInputTitle
                                                                                                   }).getButtonId()), this._dnd &&
                                                                                                                      (this._dnd.dispose(), this._dnd =
                                                                                                                          this._setupDragAndDrop()), this._totalFilesInBatch =
            ...
            _getButton: function (a) {
                ...
                this._fileButtonsClickHandler =
                    qq.FileButtonsClickHandler && this._bindFileButtonsClickEvent(), this._focusinEventSupported =
                    !qq.firefox(), this._isEditFilenameEnabled() &&
                                   (this._filenameClickHandler = this._bindFilenameClickEvent(), this._filenameInputFocusInHandler =
                                       this._bindFilenameInputFocusInEvent(), this._filenameInputFocusHandler =
                ...
                return new qq.FileButtonsClickHandler({
                    templating: this._templating, log: function (b, c) {
                        a.log(b, c)
                ...
                return this._templating.isEditFilenamePossible() && !this._options.autoUpload && qq.FilenameClickHandler &&
                       qq.FilenameInputFocusHandler && qq.FilenameInputFocusHandler
            }, _filenameEditHandler: function () {
                var a = this, b = this._templating;
                return {
                    templating: b, log: function (b, c) {
                        a.log(b, c)
                        ...
                        c
                            ? (d.addClass("qq-editing"), b.hideFilename(a), b.hideEditIcon(a))
                            : (d.removeClass("qq-editing"), b.showFilename(a), b.showEditIcon(a)), e.addClass("qq-temp").removeClass("qq-temp")
                    }
                }
            }, _onUploadStatusChange: function (a, b, c) {
                this._parent.prototype._onUploadStatusChange.apply(this, arguments), this._isEditFilenameEnabled() &&
                                                                                     this._templating.getFileContainer(a) &&
                                                                                     c !== qq.status.SUBMITTED &&
                                                                                     (this._templating.markFilenameEditable(a), this._templating.hideEditIcon(a)), c ===
                                                                                                                                                                   qq.status.UPLOAD_RETRYING
                    ? (this._templating.hideRetry(a), this._templating.setStatusText(a), qq(this._templating.getFileContainer(a)).removeClass(this._classes.retrying))
                    : c === qq.status.UPLOAD_FAILED && this._templating.hidePause(a)
                ...
                c && c.qqPath && this._options.dragAndDrop.reportDirectoryPaths &&
                this._paramsStore.addReadOnly(a, {qqpath: c.qqPath}), this._parent.prototype._onSubmit.apply(this,
                    arguments), this._addToList(a, b)
            }, _onSubmitted: function (a) {
                this._isEditFilenameEnabled() &&
                (this._templating.markFilenameEditable(a), this._templating.showEditIcon(a), this._focusinEventSupported ||
                                                                                             this._filenameInputFocusHandler.addHandler(this._templating.getEditInput(a)))
            }, _onProgress: function (a, b, c, d) {
                this._parent.prototype._onProgress.apply(this, arguments), this._templating.updateProgress(a, c, d), 100 ===
                                                                                                                     Math.round(100 *
                                                                                                                                (c / d))
                    ? (this._templating.hideCancel(a), this._templating.hidePause(a), this._templating.hideProgress(a), this._templating.setStatusText(a,
                    this._options.text.waitingForResponse), this._displayFileSize(a))
                ...
                function d(b) {
                    g && (f.setStatusText(a), qq(g).removeClass(h._classes.retrying), f.hideProgress(a), h.getUploads({id: a}).status !==
                                                                                                         qq.status.UPLOAD_FAILED &&
                    f.hideCancel(a), f.hideSpinner(a), b.success
                        ? h._markFileAsSuccessful(a)
                        : (qq(g).addClass(h._classes.fail), f.showCancel(a), f.isRetryPossible() && !h._preventRetries[a] &&
                    (qq(g).addClass(h._classes.retryable), f.showRetry(a)), h._controlFailureTextDisplay(a, b)))
                }

                var e = this._parent.prototype._onComplete.apply(this,
                    arguments), f = this._templating, g = f.getFileContainer(a), h = this;
                ...
                b.showDeleteButton(a), qq(b.getFileContainer(a)).addClass(this._classes.success), this._maybeUpdateThumbnail(a)
                ...
                this._parent.prototype._onUploadChunk.apply(this, arguments), b.partIndex > 0 && this._handler.isResumable(a) &&
                                                                              this._templating.allowPause(a)
            }, _onCancel: function (a) {
                this._parent.prototype._onCancel.apply(this, arguments), this._removeFileItem(a), 0 === this._getNotFinished() &&
                                                                                                  this._templating.resetTotalProgress()
            }, _onBeforeAutoRetry: function (a) {
                var b, c, d;
                this._parent.prototype._onBeforeAutoRetry.apply(this,
                    arguments), this._showCancelLink(a), this._options.retry.showAutoRetryNote &&
                                                         (b = this._autoRetries[a], c = this._options.retry.maxAutoAttempts, d =
                                                             this._options.retry.autoRetryNote.replace(/\{retryNum\}/g, b), d =
                                                             d.replace(/\{maxAuto\}/g, c), this._templating.setStatusText(a,
                                                             d), qq(this._templating.getFileContainer(a)).addClass(this._classes.retrying))
            }, _onBeforeManualRetry: function (a) {
                return this._parent.prototype._onBeforeManualRetry.apply(this, arguments)
                    ? (this._templating.resetProgress(a), qq(this._templating.getFileContainer(a)).removeClass(this._classes.fail), this._templating.setStatusText(a), this._templating.showSpinner(a), this._showCancelLink(a), !0)
                    : (qq(this._templating.getFileContainer(a)).addClass(this._classes.retryable), this._templating.showRetry(a), !1)
                ...
                this._options.deleteFile.forceConfirm ? this._showDeleteConfirm.apply(this, arguments) : this._sendDeleteRequest.apply(this,
                    arguments)
            }, _onDeleteComplete: function (a, b, c) {
                this._parent.prototype._onDeleteComplete.apply(this, arguments), this._templating.hideSpinner(a), c
                    ? (this._templating.setStatusText(a, this._options.deleteFile.deletingFailedText), this._templating.showDeleteButton(a))
                    : this._removeFileItem(a)
            }, _sendDeleteRequest: function (a) {
                this._templating.hideDeleteButton(a), this._templating.showSpinner(a), this._templating.setStatusText(a,
                    this._options.deleteFile.deletingStatusText), this._deleteHandler.sendDelete.apply(this, arguments)
            }, _showDeleteConfirm: function (a) {
                var b, c = this.getName(a), d = this._options.deleteFile.confirmMessage.replace(/\{filename\}/g,
                    c), e = (this.getUuid(a), arguments), f = this;
                ...
                (this._totalFilesInBatch > 1 && this._filesInBatchAddedToUi > 0 && (f = this._filesInBatchAddedToUi - 1), d =
                {index: f}), c || (this._options.disableCancelForFormUploads && !qq.supportedFeatures.ajaxUploading &&
                                   this._templating.disableCancel(), this._options.multiple || (e =
                    this.getUploads({id: a}), this._handledProxyGroup = this._handledProxyGroup || e.proxyGroupId, e.proxyGroupId ===
                                                                                                                   this._handledProxyGroup &&
                                                                                                                   e.proxyGroupId ||
                             (this._handler.cancelAll(), this._clearList(), this._handledProxyGroup = null))), c
                    ? (this._templating.addFileToCache(a, this._options.formatFileName(b), d, g), this._templating.updateThumbnail(a,
                    this._thumbnailUrls[a], !0, this._options.thumbnails.customResizer))
                    : (this._templating.addFile(a, this._options.formatFileName(b), d, g), this._templating.generatePreview(a,
                    this.getFile(a), this._options.thumbnails.customResizer)), this._filesInBatchAddedToUi += 1, (c ||
                ...
                var c, d, e;
                c = this._options.failedUploadTextDisplay.mode, d = this._options.failedUploadTextDisplay.responseProperty, "custom" === c
                    ? (e = b[d], e || (e = this._options.text.failUpload), this._templating.setStatusText(a,
                    e), this._options.failedUploadTextDisplay.enableTooltip && this._showTooltip(a, e))
                    : "default" === c
                                                                                                                                ? this._templating.setStatusText(a,
                    this._options.text.failUpload)
                                                                                                                                : "none" !==
                                                                                                                                  c &&
                ...
                this._totalFilesInBatch = a.length, this._filesInBatchAddedToUi =
                    0, this._parent.prototype._prepareItemsForUpload.apply(this, arguments)
            }, _maybeUpdateThumbnail: function (a) {
                var b = this._thumbnailUrls[a], c = this.getUploads({id: a}).status;
                c === qq.status.DELETED ||
                !b && !this._options.thumbnails.placeholders.waitUntilResponse && qq.supportedFeatures.imagePreviews ||
                this._templating.updateThumbnail(a, b, this._options.thumbnails.customResizer)
            }, _addCannedFile: function () {
                var a = this._parent.prototype._addCannedFile.apply(this, arguments);
                return this._addToList(a, this.getName(a),
                    !0), this._templating.hideSpinner(a), this._templating.hideCancel(a), this._markFileAsSuccessful(a), a
            }, _setSize: function (a, b) {
        ...
        this._parent = b ? qq[b].FineUploaderBasic : qq.FineUploaderBasic, this._parent.apply(this, arguments), qq.extend(this._options, {
            ...
            button: null,
            listElement: null,
            dragAndDrop: {extraDropzones: [], reportDirectoryPaths: !1},
            text: {
            ...
            failedUploadTextDisplay: {mode: "default", responseProperty: "error", enableTooltip: !0},
            messages: {
                tooManyFilesError: "You may only drop one file",
                unsupportedBrowser: "Unrecoverable error - this browser does not permit file uploading of any kind."
            },
            retry: {showAutoRetryNote: !0, autoRetryNote: "Retrying {retryNum}/{maxAuto}..."},
            deleteFile: {
                forceConfirm: !1,
            ...
            display: {fileSizeOnSubmit: !1, prependFiles: !1},
            paste: {promptForName: !1, namePromptMessage: "Please name this image"},
            thumbnails: {
                customResizer: null,
                maxCount: 0,
                placeholders: {waitUntilResponse: !1, notAvailablePath: null, waitingPath: null},
                timeBetweenThumbs: 750
            },
            scaling: {hideScaled: !1},
            ...
            classes: {hide: this._options.classes.hide, editable: this._options.classes.editable},
            limits: {maxThumbs: this._options.thumbnails.maxCount, timeBetweenThumbs: this._options.thumbnails.timeBetweenThumbs},
            placeholders: {
        ...
        }), this._options.workarounds.ios8SafariUploads && qq.ios800() && qq.iosSafari()
            ? this._templating.renderFailure(this._options.messages.unsupportedBrowserIos8Safari)
            : !qq.supportedFeatures.uploading || this._options.cors.expected && !qq.supportedFeatures.uploadCors
                ? this._templating.renderFailure(this._options.messages.unsupportedBrowser)
                : (this._wrapCallbacks(), this._templating.render(), this._classes = this._options.classes, !this._options.button &&
                                                                                                            this._templating.getButton() &&
                                                                                                            (this._defaultButtonId =
                                                                                                                this._createUploadButton({
                                                                                                                    element: this._templating.getButton(),
                                                                                                                    title: this._options.text.fileInputTitle
                                                                                                                }).getButtonId()), this._setupClickAndEditEventHandlers(), qq.DragAndDrop &&
                                                                                                                                                                           qq.supportedFeatures.fileDrop &&
                                                                                                                                                                           (this._dnd =
                                                                                                                                                                               this._setupDragAndDrop()), this._options.paste.targetElement &&
                                                                                                                                                                                                          this._options.paste.promptForName &&
                                                                                                                                                                                                          (qq.PasteSupport
                                                                                                                                                                                                              ? this._setupPastePrompt()
                                                                                                                                                                                                              : this.log("Paste support module not found.",
                                                                                                                                                                                                              "error")), this._totalFilesInBatch =
            0, this._filesInBatchAddedToUi = 0)
    }, qq.extend(qq.FineUploader.prototype, qq.basePublicApi), qq.extend(qq.FineUploader.prototype,
        qq.basePrivateApi), qq.extend(qq.FineUploader.prototype, qq.uiPublicApi), qq.extend(qq.FineUploader.prototype,
        qq.uiPrivateApi), qq.Templating = function (a) {
        "use strict";
        var b, c, d, e, f, g, h, i, j = "qq-file-id", k = "qq-file-id-", l = "qq-max-size", m = "qq-server-scale", n = "qq-hide-dropzone", o = "qq-drop-area-text", p = "qq-in-progress", q = "qq-hidden-forever", r = {
            content: document.createDocumentFragment(),
            map: {}
        }, s = !1, t = 0, u = !1, v = [], w = -1, x = {
            log: null,
            limits: {maxThumbs: 0, timeBetweenThumbs: 750},
            templateIdOrEl: "qq-template",
            containerEl: null,
            fileContainerEl: null,
            button: null,
            imageGenerator: null,
            classes: {hide: "qq-hide", editable: "qq-editable"},
            placeholders: {waitUntilUpdate: !1, thumbnailNotAvailable: null, waitingForThumbnail: null},
            text: {paused: "Paused"}
        }, y = {
        ...
        }, z = {}, A = new qq.Promise, B = new qq.Promise, C = function () {
            var a = x.placeholders.thumbnailNotAvailable, c = x.placeholders.waitingForThumbnail, d = {maxSize: w, scale: i};
            h && (a ? x.imageGenerator.generate(a, new Image, d).then(function (a) {
                A.success(a)
            }, function () {
                A.failure(), b("Problem loading 'not available' placeholder image at " + a, "error")
            }) : A.failure(), c ? x.imageGenerator.generate(c, new Image, d).then(function (a) {
                B.success(a)
            }, function () {
                B.failure(), b("Problem loading 'waiting for thumbnail' placeholder image at " + c, "error")
            }) : B.failure())
        }, D = function (a) {
            var b = new qq.Promise;
            return B.then(function (c) {
                W(c, a), a.src ? b.success() : (a.src = c.src, a.onload = function () {
                    a.onload = null, bb(a), b.success()
                })
            }, function () {
                V(a), b.success()
            }), b
            ...
            var e = U(a);
            return b("Generating new thumbnail for " + a), c.qqThumbnailId = a, x.imageGenerator.generate(c, e, d).then(function () {
                t++, bb(e), z[a].success()
            }, function () {
                z[a].failure(), x.placeholders.waitUntilUpdate || X(a, e)
            })
        }, F = function () {
            if (v.length) {
                u = !0;
            ...
            return T(M(a), y.cancel)
        }, H = function (a) {
            return T(M(a), y.continueButton)
        }, I = function (a) {
            return T(f, y[a + "Dialog"])
        }, J = function (a) {
            return T(M(a), y.deleteButton)
        }, K = function () {
            return T(f, y.dropProcessing)
        }, L = function (a) {
            return T(M(a), y.editNameIcon)
        }, M = function (a) {
            return r.map[a] || qq(g).getFirstByClass(k + a)
        }, N = function (a) {
            return T(M(a), y.file)
        }, O = function (a) {
            return T(M(a), y.pause)
        }, P = function (a) {
            return null == a ? T(f, y.totalProgressBarContainer) || T(f, y.totalProgressBar) : T(M(a), y.progressBarContainer) ||
                                                                                               T(M(a), y.progressBar)
        }, Q = function (a) {
            return T(M(a), y.retry)
        }, R = function (a) {
            return T(M(a), y.size)
        }, S = function (a) {
            return T(M(a), y.spinner)
        }, T = function (a, b) {
            return a && qq(a).getFirstByClass(b)
        }, U = function (a) {
            return h && T(M(a), y.thumbnail)
        }, V = function (a) {
            a && qq(a).addClass(x.classes.hide)
        }, W = function (a, b) {
            var c = a.style.maxWidth, d = a.style.maxHeight;
            d && c && !b.style.maxWidth && !b.style.maxHeight && qq(b).css({maxWidth: c, maxHeight: d})
        }, X = function (a, b) {
            var c = z[a] || (new qq.Promise).failure(), d = new qq.Promise;
            return A.then(function (a) {
                c.then(function () {
                    d.success()
                }, function () {
                    W(a, b), b.onload = function () {
            ...
            if (b("Parsing template"), null == x.templateIdOrEl) {
                throw new Error("You MUST specify either a template element or ID!");
            }
            if (qq.isString(x.templateIdOrEl)) {
                if (a = document.getElementById(x.templateIdOrEl), null ===
                                                                   a) {
                    throw new Error(qq.format("Cannot find template script at ID '{}'!",
                        x.templateIdOrEl));
                }
                e = a.innerHTML
            } else {
                if (void 0 ===
                    x.templateIdOrEl.innerHTML) {
                    throw new Error("You have specified an invalid value for the template option!  It must be an ID or an Element.");
                }
                e = x.templateIdOrEl.innerHTML
            }
            if (e = qq.trimStr(e), g = document.createElement("div"), g.appendChild(qq.toElement(e)), t =
                    qq(g).getFirstByClass(y.uploader), x.button &&
                                                       (k = qq(g).getFirstByClass(y.button), k && qq(k).remove()), qq.DragAndDrop &&
                                                                                                                   qq.supportedFeatures.fileDrop ||
                                                                                                                   (r =
                                                                                                                       qq(g).getFirstByClass(y.dropProcessing), r &&
                                                                                                                                                                qq(r).remove()), p =
                    qq(g).getFirstByClass(y.drop), p && !qq.DragAndDrop &&
                                                   (b("DnD module unavailable.", "info"), qq(p).remove()), qq.supportedFeatures.fileDrop
                    ? qq(t).hasAttribute(o) && p && (s = qq(p).getFirstByClass(y.dropText), s && qq(s).remove())
                    : (t.removeAttribute(o), p && qq(p).hasAttribute(n) && qq(p).css({display: "none"})), q =
                    qq(g).getFirstByClass(y.thumbnail), h ? q && (w = parseInt(q.getAttribute(l)), w = w > 0 ? w : null, i =
                    qq(q).hasAttribute(m)) : q && qq(q).remove(), h = h && q, c = qq(g).getByClass(y.editFilenameInput).length > 0, d =
                    qq(g).getByClass(y.retry).length > 0, f = qq(g).getFirstByClass(y.list), null ==
                                                                                             f) {
                throw new Error("Could not find the file list container in the template!");
            }
            return j = f.innerHTML, f.innerHTML = "", g.getElementsByTagName("DIALOG").length &&
                                                      document.createElement("dialog"), b("Template parsing complete"), {
            ...
            var b = a.id, c = a.optFileOrBlob, d = c && c.qqThumbnailId, e = U(b), f = {
            ...
            qq.supportedFeatures.imagePreviews
                ? e
                ? x.limits.maxThumbs && x.limits.maxThumbs <= t
                      ? (X(b, e), F())
                      : D(e).done(function () {
                z[b] = new qq.Promise, z[b].done(function () {
                    setTimeout(F, x.limits.timeBetweenThumbs)
                }), null != d ? cb(b, d) : E(b, c, f)
            })
                : F()
                : e && (D(e), F())
        }, _ = function (a) {
            var b = a.id, c = a.thumbnailUrl, d = a.showWaitingImg, e = U(b), f = {
                customResizeFunction: a.customResizeFunction,
                scale: i,
                maxSize: w
            };
            if (e) {
                if (c) {
                    if (!(x.limits.maxThumbs && x.limits.maxThumbs <= t)) {
                        return d && D(e), x.imageGenerator.generate(c, e, f).then(function () {
                            bb(e), t++, setTimeout(F, x.limits.timeBetweenThumbs)
                        }, function () {
                            X(b, e), setTimeout(F, x.limits.timeBetweenThumbs)
                        });
                    }
                    X(b, e), F()
                } else {
            ...
            var c = P(a), d = null == a ? y.totalProgressBar : y.progressBar;
            c && !qq(c).hasClass(d) && (c = qq(c).getFirstByClass(d)), c &&
                                                                       (qq(c).css({width: b + "%"}), c.setAttribute("aria-valuenow", b))
        }, bb = function (a) {
            a && qq(a).removeClass(x.classes.hide)
        }, cb = function (a, c) {
            var d = U(a), e = U(c);
            b(qq.format("ID {} is the same file as ID {}.  Will use generated thumbnail from ID {} instead.", a, c,
                c)), z[c].then(function () {
                t++, z[a].success(), b(qq.format("Now using previously generated thumbnail created for ID {} on ID {}.", c, a)), d.src =
                    e.src, bb(d)
            }, function () {
                z[a].failure(), x.placeholders.waitUntilUpdate || X(a, d)
            })
        };
        qq.extend(x, a), b = x.log, qq.supportedFeatures.imagePreviews || (x.limits.timeBetweenThumbs = 0, x.limits.maxThumbs = 0), f =
            x.containerEl, h = void 0 !== x.imageGenerator, e = Y(), C(), qq.extend(this, {
            render: function () {
                b("Rendering template in DOM."), t = 0, f.innerHTML = e.template, V(K()), this.hideTotalProgress(), g =
                    x.fileContainerEl || T(f, y.list), b("Template rendering complete")
                ...
                var i, l = qq.toElement(e.fileTemplate), m = T(l, y.file), n = T(f, y.uploader), p = h ? r.content : g;
                h && (r.map[a] = l), qq(l).addClass(k + a), n.removeAttribute(o), m && (qq(m).setText(b), m.setAttribute("title",
                    b)), l.setAttribute(j, a), c ? Z(l, c.index, p) : p.appendChild(l), d
                    ? (l.style.display = "none", qq(l).addClass(q))
                    : (V(P(a)), V(R(a)), V(J(a)), V(Q(a)), V(O(a)), V(H(a)), s && this.hideCancel(a), i = U(a), i && !i.src &&
                                                                                                                B.then(function (a) {
                                                                                                                    i.src =
                                                                                                                        a.src, a.style.maxHeight &&
                                                                                                                               a.style.maxWidth &&
                                                                                                                               qq(i).css({
                ...
                g.appendChild(r.content), r.content = document.createDocumentFragment(), r.map = {}
                ...
                var b = N(a);
                b && qq(b).addClass(x.classes.editable)
                ...
                return qq(a).hasClass(y.file)
            }, getButton: function () {
                return x.button || T(f, y.button)
                ...
                return qq(M(a)).hasClass(q)
            }, hideEditIcon: function (a) {
                var b = L(a);
                b && qq(b).removeClass(x.classes.editable)
            }, isEditIcon: function (a) {
                return qq(a).hasClass(y.editNameIcon, !0)
            }, getEditInput: function (a) {
                return T(M(a), y.editFilenameInput)
            }, isEditInput: function (a) {
                return qq(a).hasClass(y.editFilenameInput, !0)
            }, updateProgress: function (a, b, c) {
                var d, e = P(a);
                e && c > 0 && (d = Math.round(100 * (b / c)), 100 === d ? V(e) : bb(e), ab(a, d))
                ...
                ab(a, 0), this.hideTotalProgress(a)
            }, resetTotalProgress: function () {
                this.resetProgress()
            }, showCancel: function (a) {
                if (!s) {
                    var b = G(a);
                    b && qq(b).removeClass(x.classes.hide)
                }
            }, hideCancel: function (a) {
                V(G(a))
            }, isCancel: function (a) {
                return qq(a).hasClass(y.cancel, !0)
            }, allowPause: function (a) {
                bb(O(a)), V(H(a))
            }, uploadPaused: function (a) {
                this.setStatusText(a, x.text.paused), this.allowContinueButton(a), V(S(a))
            }, hidePause: function (a) {
                V(O(a))
            }, isPause: function (a) {
                return qq(a).hasClass(y.pause, !0)
            }, isContinueButton: function (a) {
                return qq(a).hasClass(y.continueButton, !0)
            }, allowContinueButton: function (a) {
                bb(H(a)), V(O(a))
            }, uploadContinued: function (a) {
                this.setStatusText(a, ""), this.allowPause(a), bb(S(a))
            }, showDeleteButton: function (a) {
                bb(J(a))
            }, hideDeleteButton: function (a) {
                V(J(a))
            }, isDeleteButton: function (a) {
                return qq(a).hasClass(y.deleteButton, !0)
            }, isRetry: function (a) {
                return qq(a).hasClass(y.retry, !0)
            }, updateSize: function (a, b) {
                var c = R(a);
                c && (bb(c), qq(c).setText(b))
            }, setStatusText: function (a, b) {
                var c = T(M(a), y.statusText);
                c && (null == b ? qq(c).clearText() : qq(c).setText(b))
            }, hideSpinner: function (a) {
                qq(M(a)).removeClass(p), V(S(a))
            }, showSpinner: function (a) {
                qq(M(a)).addClass(p), bb(S(a))
            }, generatePreview: function (a, b, c) {
                this.isHiddenForever(a) || (v.push({id: a, customResizeFunction: c, optFileOrBlob: b}), !u && F())
            }, updateThumbnail: function (a, b, c, d) {
                this.isHiddenForever(a) ||
                (v.push({customResizeFunction: d, update: !0, id: a, thumbnailUrl: b, showWaitingImg: c}), !u && F())
            }, hasDialog: function (a) {
                return qq.supportedFeatures.dialogElement && !!I(a)
            }, showDialog: function (a, b, c) {
                var d = I(a), e = T(d, y.dialogMessage), f = d.getElementsByTagName("INPUT")[0], g = T(d, y.dialogCancelButton), h = T(d,
                    y.dialogOkButton), i = new qq.Promise, j = function () {
                ...
                return d.addEventListener("close", j), g.addEventListener("click", k), h && h.addEventListener("click", l), f && (f.value =
                    c), e.textContent = b, d.showModal(), i
            }
        })
        ...
        function c(a, b) {
            var c, d, f;
            try {
                d = b.contentDocument || b.contentWindow.document, f =
                    d.body.innerHTML, h("converting iframe's innerHTML to JSON"), h("innerHTML = " + f), f && f.match(/^<pre/i) && (f =
                    d.body.firstChild.firstChild.nodeValue), c = e._parseJsonResponse(f)
            } catch (g) {
                h("Error when attempting to parse form upload response (" + g.message + ")", "error"), c = {success: !1}
            }
            return c
        }
        ...
        this.uploadFile = function (b) {
            ...
            options: {isCors: a.cors.expected, inputName: a.inputName},
            proxy: {onCancel: a.onCancel, getName: f, getUuid: g, log: h}
        }))
    }, qq.traditional = qq.traditional || {}, qq.traditional.XhrUploadHandler = function (a, b) {
        "use strict";
        var c = this, d = b.getName, e = b.getSize, f = b.getUuid, g = b.log, h = a.forceMultipart || a.paramsInBody, i = function (b, c,
                                                                                                                                    f) {
            var g = e(b), i = d(b);
            c[a.chunking.paramNames.partIndex] = f.part, c[a.chunking.paramNames.partByteOffset] =
                f.start, c[a.chunking.paramNames.chunkSize] = f.size, c[a.chunking.paramNames.totalParts] =
                f.count, c[a.totalFileSizeName] = g, h && (c[a.filenameParam] = i)
            ...
            return g[a.uuidName] = f(b), g[a.filenameParam] = h, g[a.totalFileSizeName] = i, g[a.chunking.paramNames.totalParts] =
                c._getTotalChunks(b), g
        }, m = function (a, b) {
            return qq.indexOf([200, 201, 202, 203, 204], a.status) < 0 || !b.success || b.reset
        }, n = function (a, b) {
            var c;
            return g("xhr - server response received for " + a), g("responseText = " + b.responseText), c = o(!0, b), {
                success: !m(b, c),
                response: c
            }
        }, o = function (a, b) {
            var c = {};
            try {
                g(qq.format("Received response status {} with body: {}", b.status, b.responseText)), c = qq.parseJson(b.responseText)
            } catch (d) {
            ...
            return b[a.uuidName] = f(i), b[a.filenameParam] = m, h && (b[a.totalFileSizeName] = n), a.paramsInBody ||
                                                                                                    (h || (b[a.inputName] = m), l =
                                                                                                        qq.obj2url(b, l)), c.open(k, l,
                !0), a.cors.expected && a.cors.sendCredentials && (c.withCredentials = !0), h ? (a.paramsInBody && qq.obj2FormData(b,
                j), j.append(a.inputName, g), j) : g
        }, r = function (b, d) {
            var e = a.customHeaders.get(b), f = c.getFile(b);
            d.setRequestHeader("Accept", "application/json"), d.setRequestHeader("X-Requested-With",
                "XMLHttpRequest"), d.setRequestHeader("Cache-Control", "no-cache"), h || (d.setRequestHeader("Content-Type",
                "application/octet-stream"), d.setRequestHeader("X-Mime-Type", f.type)), qq.each(e, function (a, b) {
        ...
        qq.extend(this, {
            uploadChunk: function (b, d, f) {
                ...
                return e(b), g = k(b, m), c._registerProgressHandler(b, d, l.size), j = a.paramsStore.get(b), i(b, j, l), f &&
                                                                                                                          (j[a.resume.paramNames.resuming] =
                                                                                                                              !0), h =
                    q(j, m, l.blob, b), r(b, m), m.send(h), g
            }, uploadFile: function (b) {
                var d, e, f, g, h = c.getFile(b);
                return e = c._createXhr(b), c._registerProgressHandler(b), d = k(b, e), f = a.paramsStore.get(b), g = q(f, e, h, b), r(b,
                    e), e.send(g), d
            }
        }), qq.extend(this, new qq.XhrUploadHandler({
            options: qq.extend({namespace: "traditional"}, a),
            proxy: qq.extend({getEndpoint: a.endpointStore.get}, b)
        ...
        "use strict";
        var b, c = "POST", d = {
            cors: {allowXdr: !1, expected: !1, sendCredentials: !1}, endpoint: null, log: function () {
            }
        }, e = {}, f = {
            get: function () {
                return d.endpoint
        ...
        qq.extend(d, a), b = qq.extend(this, new qq.AjaxRequester({
            ...
            complete: function (a, c, f, g) {
                ...
                return d.log("Submitting All Chunks Done request for " + a), e[a] =
                    h, b.initTransport(a).withParams(f).withHeaders(g).send(c), h
            }
        })
        ...
        function b(a, b) {
            ...
            j.callbacks.dropLog("Grabbed " + a.length +
                                " dropped files."), b.dropDisabled(!1), j.callbacks.processingDroppedFilesComplete(c, b.getElement())
        }
        ...
        function e(a, b) {
            ...
            return j.callbacks.processingDroppedFiles(), b.dropDisabled(!0), a.files.length > 1 && !j.allowMultipleItems
                ? (j.callbacks.processingDroppedFilesComplete([]), j.callbacks.dropError("tooManyFilesError",
                ""), b.dropDisabled(!1), e.failure())
                : (n = [], qq.isFolderDropSupported(a) ? qq.each(a.items, function (a, b) {
        ...
        function f(a) {
            var c = new qq.UploadDropZone({
                HIDE_ZONES_EVENT_NAME: k, element: a, onEnter: function (b) {
            ...
            qq.each(a, function (b, c) {
                ...
                a.length && qq.supportedFeatures.fileDrop && o.attach(document, "dragenter", function (b) {
                    !d.dropDisabled() && g(b) && qq.each(a, function (a, b) {
                        b instanceof HTMLElement && qq(b).hasAttribute(l) && qq(b).css({display: "block"})
                    })
                })
        ...
        j =
        {dropZoneElements: [], allowMultipleItems: !0, classes: {dropActive: null}, callbacks: new qq.DragAndDrop.callbacks}, qq.extend(j,
            a, !0), i(), qq.extend(this, {
        ...
        function d(a) {
            ...
            return b = qq.ie() && qq.supportedFeatures.fileDrop ? !0 : "none" !== c.effectAllowed, c && b && (c.files ||
                                                                                                              !d && c.types.contains &&
                                                                                                              c.types.contains("Files"))
        }
        ...
        var c, d = {
            method: "DELETE", uuidParamName: "qquuid", endpointStore: {}, maxConnections: 3, customHeaders: function () {
                return {}
            }, paramsStore: {}, cors: {expected: !1, sendCredentials: !1}, log: function () {
            }, onDelete: function () {
            }, onDeleteComplete: function () {
            }
        };
        qq.extend(d, a), c = qq.extend(this, new qq.AjaxRequester({
            ...
            sendDelete: function (a, b, e) {
                var f = e || {};
                d.log("Submitting delete file request for " + a), "DELETE" === d.method
                    ? c.initTransport(a).withPath(b).withParams(f).send()
                    : (f[d.uuidParamName] = b, c.initTransport(a).withParams(f).send())
            }
        })
    }, function () {
        function a(a) {
            var b, c = a.naturalWidth, d = a.naturalHeight, e = document.createElement("canvas");
            return c * d > 1048576 ? (e.width = e.height = 1, b = e.getContext("2d"), b.drawImage(a, -c + 1, 0), 0 ===
                                                                                                                 b.getImageData(0, 0, 1,
                                                                                                                     1).data[3]) : !1
        }
        ...
        function e(c, e, h, i, j) {
            ...
            return p.save(), i.resize ? f({
                ...
                targetHeight: o,
                targetWidth: n
            }) : (qq.supportedFeatures.unlimitedScaledImageSize || (k = d({origWidth: n, origHeight: o}), k &&
                                                                                                          (qq.log(qq.format("Had to reduce dimensions due to device limitations from {}w / {}h to {}w / {}h",
                                                                                                              n, o, k.newWidth,
                                                                                                              k.newHeight), "warn"), n =
                                                                                                              k.newWidth, o =
                                                                                                              k.newHeight)), g(h, n, o,
                i.orientation), qq.ios() ? function () {
                a(c) && (l /= 2, m /= 2);
                var d, e, f, g = 1024, h = document.createElement("canvas"), i = j ? b(c, l, m) : 1, k = Math.ceil(g * n /
                                                                                                                   l), q = Math.ceil(g * o /
                                                                                                                                     m /
                                                                                                                                     i), r = 0, s = 0;
                for (h.width = h.height = g, d = h.getContext("2d"); m > r;) {
                    for (e = 0, f = 0; l > e;) {
                        d.clearRect(0, 0, g, g), d.drawImage(c, -e, -r), p.drawImage(h, 0, 0, g, g, f, s, k, q), e +=
                            g, f += k;
                    }
                    r += g, s += q
                }
                p.restore(), h = d = null
            }() : p.drawImage(c, 0, 0, n, o), h.qqImageRendered && h.qqImageRendered(), q.success(), q)
        }
        ...
        function h(a, b) {
            ...
            window.Blob && a instanceof Blob && function () {
                var b = new Image, d = window.URL && window.URL.createObjectURL
                    ? window.URL
        ...
        h.prototype.render = function (a, b) {
            b = b || {};
            var d, f = this, g = this.srcImage.naturalWidth, h = this.srcImage.naturalHeight, i = b.width, j = b.height, k = b.maxWidth, l = b.maxHeight, m = !this.blob ||
                                                                                                                                                              "image/jpeg" ===
                                                                                                                                                              this.blob.type, n = a.tagName.toLowerCase();
            return this.imageLoadListeners ? (this.imageLoadListeners.push(function () {
                f.render(a, b)
            }), void 0) : (i && !j ? j = h * i / g << 0 : j && !i ? i = g * j / h << 0 : (i = g, j = h), k && i > k &&
                                                                                                         (i = k, j = h * i / g << 0), l &&
                                                                                                                                      j >
                                                                                                                                      l &&
                                                                                                                                      (j =
                                                                                                                                          ...
                                                                                                                                          h <<
                                                                                                                                          0), d =
            {width: i, height: j}, qq.each(b, function (a, b) {
                d[a] = b
            }), "img" === n ? function () {
                var b = a.src;
            ...
            }() : "canvas" === n && e(this.srcImage, this.blob, a, d, m), "function" == typeof this.onrender && this.onrender(a), void 0)
        }, qq.MegaPixImage = h
        ...
        function g(a) {
            ...
            return e.href = a, b = e.protocol, d = e.port, c = e.hostname, b.toLowerCase() !== window.location.protocol.toLowerCase()
                ? !0
                : c.toLowerCase() !== window.location.hostname.toLowerCase()
                                                                               ? !0
                                                                               : d === window.location.port || qq.ie()
                      ? !1
                      : !0
        }
        ...
        function j(d, e) {
            var f = b(d) || c(d);
            return b(d) ? h(d, e) : c(d) ? i(d, e) : (e.failure(d), a(qq.format("Element container of type {} is not supported!",
                d.tagName), "error")), f
        }

        function k(b, c, d) {
            var e = new qq.Promise, f = new qq.Identify(b, a), g = d.maxSize, h = null == d.orient ? !0 : d.orient, i = function () {
                c.onerror = null, c.onload = null, a("Could not render preview, file may be too large!", "error"), e.failure(c,
            ...
            return f.isPreviewable().then(function (f) {
                ...
                j(c, e) && l.parse().then(function (a) {
                    ...
                    m.render(c, {maxWidth: g, maxHeight: g, orientation: b, mime: f, resize: d.customResizeFunction})
                }, function (b) {
                    a(qq.format("EXIF data could not be parsed ({}).  Assuming orientation = 1.", b)), m.render(c,
        ...
        function l(a, b, c, d, e) {
            ...
            j(h, i), g(a) && (h.crossOrigin = "anonymous"), h.src = a, i.then(function () {
                j(b, c);
                var g = new qq.MegaPixImage(h);
                g.render(b, {maxWidth: d, maxHeight: d, mime: f(a), resize: e})
            }, c.failure)
        }
        ...
        function n(a, f, h) {
            ...
            return k && b(f) ? e() ? g(a) && !d() ? m(a, f, i, n) : l(a, f, i, n) : m(a, f, i, n) : c(f) ? l(a, f, i, n) : j(f, i) &&
                                                                                                                           (f.src = a), i
        }

        qq.extend(this, {
            generate: function (b, c, d) {
                return qq.isString(b)
                    ? (a("Attempting to update thumbnail based on server response."), n(b, c, d || {}))
                    : (a("Attempting to draw client-side image preview."), k(b, c, d || {}))
            }
        })
        ...
        function c(a) {
            for (var b = 0, c = 0; a.length > 0;) {
                b += parseInt(a.substring(0, 2), 16) * Math.pow(2, c), a = a.substring(2, a.length), c +=
                    8;
            }
            return b
        }
        ...
        function d(b, c) {
            ...
            return void 0 === e && (e = 2, f = new qq.Promise), qq.readBlobToHex(a, e, 4).then(function (a) {
                ...
                c
                    ? "1" !== c[1]
                    ? (b = parseInt(a.slice(4, 8), 16), d(e + b + 2, f))
                    : f.success(e)
        ...
        function j(a, b) {
            ...
            return qq.each(b, function (b, g) {
                ...
                return n >= 0 &&
                       (i = l[m].name, j = l[m].bytes, h = g.slice(d, d + 2 * j), f[i] = a ? c(h) : parseInt(h, 16), e.splice(n, 1)), 0 ===
                                                                                                                                      e.length
                    ? !1
                    : void 0
            }), f
        ...
        qq.extend(this, {
            parse: function () {
                ...
                return e().then(function (e) {
                    b(qq.format("Moving forward with EXIF header parsing for '{}'",
                        void 0 === a.name ? "blob" : a.name)), f(e).then(function (a) {
        ...
        qq.extend(this, {
            isPreviewable: function () {
                ...
                return b(qq.format("Attempting to determine if {} can be rendered in this browser",
                    g)), b("First pass: check type attribute of blob object."), this.isPreviewableSync()
                    ? (b("Second pass: check for magic bytes in file header."), qq.readBlobToHex(a, 0, 4).then(function (a) {
                ...
                var c = a.type, d = qq.indexOf(Object.keys(this.PREVIEWABLE_MIME_TYPES), c) >= 0, e = !1, f = void 0 === a.name
                    ? "blob"
                    : a.name;
                return d && (e = "image/tiff" === c ? qq.supportedFeatures.tiffPreviews : !0), !e && b(f +
                                                                                                       " is not previewable in this browser per the blob's type attr"), e
            }
        })
        ...
        function d() {
            ...
            return new qq.Identify(a, b).isPreviewable().then(function () {
                var d = new Image, e = window.URL && window.URL.createObjectURL
                    ? window.URL
                    : window.webkitURL && window.webkitURL.createObjectURL
                                           ? window.webkitURL
                                           : null;
        ...
        function c(a, c, e, f) {
            ...
            c = c && b(a), c && qq.each(a, function (a, b) {
                if (null == b.uuid) {
                    g = !0, d.log(qq.format("Session response item {} did not include a valid UUID - ignoring.", a),
                        "error");
                } else if (null == b.name) {
        ...
        var d = {
            endpoint: null, params: {}, customHeaders: {}, cors: {}, addFileRecord: function () {
            }, log: function () {
            }
        };
        ...
        var c, d = {
            endpoint: null, customHeaders: {}, params: {}, cors: {expected: !1, sendCredentials: !1}, onComplete: function () {
            }, log: function () {
            }
        };
        qq.extend(d, a), c = qq.extend(this, new qq.AjaxRequester({
            acceptHeader: "application/json", validMethods: ["GET"], method: "GET", endpointStore: {
                get: function () {
                    return d.endpoint
                }
            }, customHeaders: d.customHeaders, log: d.log, onComplete: b, cors: d.cors
        })), qq.extend(this, {
        ...
        function e(a, b) {
            return !a.checkValidity || a.checkValidity() ? !0 : (c("Form did not pass validation checks - will not upload.",
                "error"), b(), void 0)
        }
        ...
        qq.extend(this, {
            newEndpoint: null, newAutoUpload: k, attachedToForm: !1, getFormInputsAsObject: function () {
        ...
        "use strict";
        var c = a.customResizer, d = a.sendOriginal, e = a.orient, f = a.defaultType, g = a.defaultQuality /
                                                                                          100, h = a.failureText, i = a.includeExif, j = this._getSortedSizes(a.sizes);
        qq.extend(this, {
            enabled: qq.supportedFeatures.scaling && j.length > 0, getFileRecords: function (a, k, l) {
                var m = this, n = [], o = l.blob ? l.blob : l, p = new qq.Identify(o, b);
                return p.isPreviewableSync() ? (qq.each(j, function (a, d) {
                    var j = m._determineOutputType({defaultType: f, requestedType: d.type, refType: o.type});
                    n.push({
                        uuid: qq.getUniqueId(),
                        name: m._getName(k, {name: d.name, type: j, refType: o.type}),
                ...
                }), n.push({uuid: a, name: k, size: o.size, blob: d ? o : null})) : n.push({uuid: a, name: k, size: o.size, blob: o}), n
            }, handleNewFile: function (a, b, c, d, e, f, g, h) {
                var i = this, j = (a.qqButtonId || a.blob &&
                                                   a.blob.qqButtonId, []), k = null, l = h.addFileToHandler, m = h.uploadData, n = h.paramsStore, o = qq.getUniqueId();
                qq.each(i.getFileRecords(c, b, a), function (a, b) {
                    var c, d = b.size;
                    b.blob instanceof qq.BlobProxy && (d = -1), c =
                        m.addFile({uuid: b.uuid, name: b.name, size: d, batchId: f, proxyGroupId: o}), b.blob instanceof qq.BlobProxy
                        ? j.push(c)
                        : k = c, b.blob ? (l(c, b.blob), e.push({id: c, file: b.blob})) : m.setStatus(c, qq.status.REJECTED)
                }), null !== k && (qq.each(j, function (a, b) {
                    var c = {qqparentuuid: m.retrieve({id: k}).uuid, qqparentsize: m.retrieve({id: k}).size};
                    c[g] = m.retrieve({id: b}).uuid, m.setParentId(b, k), n.addReadOnly(b, c)
                }), j.length && function () {
                    var a = {};
                    a[g] = m.retrieve({id: k}).uuid, n.addReadOnly(k, a)
                }())
            }
        })
        ...
        scaleImage: function (a, b, c) {
            ...
            var d = new qq.Promise, e = c.log, f = c.getFile(a), g = c.uploadData.retrieve({id: a}), h = g && g.name, i = g && g.uuid, j = {
                ...
                sizes: [{name: "", maxSize: b.maxSize}]
            }, k = new qq.Scaler(j, e);
            return qq.Scaler && qq.supportedFeatures.imagePreviews && f ? qq.bind(function () {
                var b = k.getFileRecords(i, h, f)[0];
                b && b.blob instanceof qq.BlobProxy ? b.blob.create().then(d.success, d.failure) : (e(a + " is not a scalable image!",
                    "error"), d.failure())
            }, this)() : (d.failure(), e("Could not generate requested scaled image for " + a + ".  " +
                                         "Scaling is either not possible in this browser, or the file could not be located.", "error")), d
        }, _determineOutputType: function (a) {
            "use strict";
            var b = a.requestedType, c = a.defaultType, d = a.refType;
            return c || b
                ? b
                       ? qq.indexOf(Object.keys(qq.Identify.prototype.PREVIEWABLE_MIME_TYPES), b) >= 0
                      ? "image/tiff" === b
                             ? qq.supportedFeatures.tiffPreviews
                            ? b
                            : c
                             : b
                      : c
            ...
            return b.name && b.name.trim().length && (h = " (" + b.name + ")"), c >= 0 ? (f = a.substr(0, c), e !== d &&
                                                                                                              (g = d.split("/")[1]), f +=
                h + "." + g) : f = a + h, f
            ...
            "use strict";
            var c = this, d = a.customResizeFunction, e = a.log, f = a.maxSize, g = a.orient, h = a.type, i = a.quality, j = a.failedText, k = a.includeExif &&
                                                                                                                                               "image/jpeg" ===
                                                                                                                                               b.type &&
                                                                                                                                               "image/jpeg" ===
                                                                                                                                               h, l = new qq.Promise, m = new qq.ImageGenerator(e), n = document.createElement("canvas");
            return e("Attempting to generate scaled version for " + b.name), m.generate(b, n,
                {maxSize: f, orient: g, customResizeFunction: d}).then(function () {
                ...
                k ? c._insertExifHeader(b, a, e).then(function (b) {
                    ...
                    e("Problem inserting EXIF header into scaled image.  Using scaled image w/out EXIF data.", "error"), d()
                }) : d()
            }, function () {
            ...
            "use strict";
            var b, c, d, e;
            return b = a.split(",")[0].indexOf("base64") >= 0 ? atob(a.split(",")[1]) : decodeURI(a.split(",")[1]), c =
                a.split(",")[0].split(":")[1].split(";")[0], d = new ArrayBuffer(b.length), e = new Uint8Array(d), qq.each(b,
                function (a, b) {
                    e[a] = b.charCodeAt(0)
        ...
        return a.KEY_STR = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", a.encode64 = function (a) {
            ...
            do {
                b = a[j++], c = a[j++], h = a[j++], d = b >> 2, e = (3 & b) << 4 | c >> 4, f = (15 & c) << 2 | h >> 6, i = 63 & h, isNaN(c)
                    ? f = i = 64
                    : isNaN(h) && (i = 64), g =
                    g + this.KEY_STR.charAt(d) + this.KEY_STR.charAt(e) + this.KEY_STR.charAt(f) + this.KEY_STR.charAt(i), b =
                    c = h = "", d =
                    e = f = i = "";
            } while (j < a.length);
            return g
            ...
            var c = a.replace("data:image/jpeg;base64,", ""), d = this.decode64(c), e = d.indexOf(255, 3), f = d.slice(0,
                e), g = d.slice(e), h = f;
            ...
            do {
                d = this.KEY_STR.indexOf(a.charAt(i++)), e = this.KEY_STR.indexOf(a.charAt(i++)), f =
                    this.KEY_STR.indexOf(a.charAt(i++)), h = this.KEY_STR.indexOf(a.charAt(i++)), b = d << 2 | e >> 4, c =
                    (15 & e) << 4 | f >> 2, g = (3 & f) << 6 | h, j.push(b), 64 != f && j.push(c), 64 != h && j.push(g), b = c = g = "", d =
                    e = f = h = "";
            } while (i < a.length);
            return j
        }, a
        ...
        qq.extend(this, {
            onAllComplete: k, onStatusChange: function (a, b, c) {
        ...
        var d = new qq.DisposeSupport, e = {
            eventType: "click", attachTo: null, onHandled: function () {
            }
        };
        qq.extend(this, {
        ...
        function b(a, b) {
            qq.each(e, function (c, e) {
                ...
                return d.templating["is" + g](a) ? (f =
                    d.templating.getFileId(a), qq.preventDefault(b), d.log(qq.format("Detected valid file button click event on file '{}', ID: {}.",
                    d.onGetName(f), f)), e(f), !1) : void 0
            })
        }

        var c = {}, d = {
            templating: null, log: function () {
        ...
        qq.extend(d, a), d.eventType = "click", d.onHandled = b, d.attachTo = d.templating.getFileList(), qq.extend(this,
            new qq.UiEventHandler(d, c))
        ...
        function b(a, b) {
            if (d.templating.isFileName(a) || d.templating.isEditIcon(a)) {
                ...
                f === qq.status.SUBMITTED && (d.log(qq.format("Detected valid filename click event on file '{}', ID: {}.", d.onGetName(e),
                    e)), qq.preventDefault(b), c.handleFilenameEdit(e, a, !0))
            }
        }
        ...
        function c(a) {
            if (d.templating.isEditInput(a)) {
                ...
                e === qq.status.SUBMITTED &&
                (d.log(qq.format("Detected valid filename input focus event on file '{}', ID: {}.", d.onGetName(c),
                    c)), b.handleFilenameEdit(c, a))
            }
        }

        var d = {
            templating: null, onGetUploadStatus: function () {
            }, log: function () {
            }
        };
        ...
        function e(a, b) {
            var c, e = a.value;
            void 0 !== e && qq.trimStr(e).length > 0 &&
            (c = d(b), void 0 !== c && (e = e + "." + c), h.onSetName(b, e)), h.onEditingStatusChange(b, !1)
        }
