...
CKEDITOR.plugins.setLang("a11yhelp", "pt", {
    ...
    legend: [{
        ...
        {
            name: "Comandos",
            items: [{name: "Comando de anular", legend: "Carregar ${undo}"}, {name: "Comando de refazer", legend: "Clique ${redo}"},
                {name: "Comando de negrito", legend: "Pressione ${bold}"}, {name: "Comando de itálico", legend: "Pressione ${italic}"},
