...
export class SortContentTabMenuItems {
    ...
    constructor() {
        ...
        order.addOrderExpr(new FieldOrderExprBuilder().setFieldName(api.query.QueryField.DISPLAY_NAME).setDirection(
        ...
        order = new ChildOrder();
        order.addOrderExpr(new FieldOrderExprBuilder().setFieldName(api.query.QueryField.MODIFIED_TIME).setDirection(
            ChildOrder.ASC_ORDER_DIRECTION_VALUE).build());
        ...
        order = new ChildOrder();
        order.addOrderExpr(new FieldOrderExprBuilder().setFieldName(api.query.QueryField.MANUAL_ORDER_VALUE).setDirection(
            ChildOrder.DESC_ORDER_DIRECTION_VALUE).build());
