...
describe("api.form.FormOptionSet", function () {
    ...
    function createOptionSet(json: FormOptionSetJson): FormOptionSet {
        return new FormOptionSet(json);
    }

    function getOptionSetJsonWithOptions(): FormOptionSetJson {
    ...
    function getOptionSetJson(): FormOptionSetJson {
        return {
            name: 'optionSet',
    ...
    function getOptionsJson(): FormOptionSetOptionJson[] {
        return [
            {
                name: 'option1',
                label: 'Option 1',
